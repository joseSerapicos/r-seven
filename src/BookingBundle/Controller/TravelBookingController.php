...
class TravelBookingController extends BaseBookingController
{
    ...
    protected function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_booking__travel_booking__get'
            ),
            'edit' => array(
                'name' => '_booking__travel_booking__edit'
            ),
            'delete' => array(
                'name' => '_booking__travel_booking__delete'
            ),
            'detail' => array(
                'name' => '_booking__travel_booking__detail'
            )
        );
    ...
    /**
     * @Route("/booking/travel-booking",
     *     name="_booking__travel_booking__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/booking/travel-booking/detail/{id}",
     *     name="_booking__travel_booking__detail",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/travel-booking/get/{id}",
     *     name="_booking__travel_booking__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/travel-booking/edit/{id}",
     *     name="_booking__travel_booking__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/travel-booking/delete/{id}",
     *     name="_booking__travel_booking__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/travel-booking/detail-content",
     *     name="_booking__travel_booking__detail_content")
     *
