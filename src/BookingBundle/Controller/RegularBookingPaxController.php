...
class RegularBookingPaxController extends BaseEntityChildController
{
    ...
    protected function initChild(Request $request, $parents)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_booking__regular_booking_pax__get'
            ),
            'edit' => array(
                'name' => '_booking__regular_booking_pax__edit',
            ),
            'delete' => array(
                'name' => '_booking__regular_booking_pax__delete',
            )
        );
    ...
    /**
     * @Route("/booking/regular-booking-pax/get/{booking}/{id}",
     *     name="_booking__regular_booking_pax__get",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/booking/regular-booking-pax/edit/{booking}/{id}",
     *     name="_booking__regular_booking_pax__edit",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/booking/regular-booking-pax/delete/{booking}/{id}",
     *     name="_booking__regular_booking_pax__delete",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/booking/regular-booking-pax/data/{booking}",
     *     name="_booking__regular_booking_pax__data"
     * )
     *
     * Overrides parent method
     * @param Request $request
    ...
    /**
     * @Route("/booking/regular-booking-pax/conf/{booking}",
     *     name="_booking__regular_booking_pax__conf"
     * )
     *
     * Overrides parent method
     * @param Request $request
