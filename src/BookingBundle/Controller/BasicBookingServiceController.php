...
class BasicBookingServiceController extends BaseBookingServiceController
{
    ...
    protected function initChild(Request $request, $parents)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_booking__basic_booking_service__get'
            ),
            'addStep1' => array(
                'name' => '_booking__basic_booking_service__add_step1',
            ),
            'addStep2' => array(
                'name' => '_booking__basic_booking_service__add_step2',
            ),
            'addStep3' => array(
                'name' => '_booking__basic_booking_service__add_step3',
            ),
            'addStep4' => array(
                'name' => '_booking__basic_booking_service__add_step4',
            ),
            'edit' => array(
                'name' => '_booking__basic_booking_service__edit',
            ),
            'cancel' => array(
                'name' => '_booking__basic_booking_service__cancel',
            ),
            'delete' => array(
                'name' => '_booking__basic_booking_service__delete',
            ),
            'order' => array(
                'name' => '_booking__basic_booking_service__order',
            )
        );
        ...
        $this->templateConf['search']['fields'] = array(
            'icon', 'name', 'reference', 'startDate', 'endDate', 'durationDays',
    ...
    /**
     * @Route("/booking/basic-booking-service/get/{booking}/{id}",
     *     name="_booking__basic_booking_service__get",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking-service/add-step1/{booking}/{id}",
     *     name="_booking__basic_booking_service__add_step1",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking-service/add-step2/{booking}/{id}",
     *     name="_booking__basic_booking_service__add_step2",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking-service/add-step3/{booking}/{id}",
     *     name="_booking__basic_booking_service__add_step3",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking-service/add-step4/{booking}/{id}",
     *     name="_booking__basic_booking_service__add_step4",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking-service/edit/{booking}/{id}",
     *     name="_booking__basic_booking_service__edit",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking-service/cancel/{booking}/{id}",
     *     name="_booking__basic_booking_service__cancel",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking-service/delete/{booking}/{id}",
     *     name="_booking__basic_booking_service__delete",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking-service/order/{booking}/{id}/{type}",
     *     name="_booking__basic_booking_service__order",
    ...
    /**
     * @Route("/booking/basic-booking-service/data/{booking}",
     *     name="_booking__basic_booking_service__data"
     * )
     *
     * Overrides parent method
     * @param Request $request
    ...
    /**
     * @Route("/booking/basic-booking-service/conf/{booking}",
     *     name="_booking__basic_booking_service__conf"
     * )
     *
     * Overrides parent method
     * @param Request $request
