...
class BasicBookingController extends BaseBookingController
{
    /**
    ...
    protected function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_booking__basic_booking__get'
            ),
            'edit' => array(
                'name' => '_booking__basic_booking__edit'
            ),
            'delete' => array(
                'name' => '_booking__basic_booking__delete'
            ),
            'detail' => array(
                'name' => '_booking__basic_booking__detail'
            )
        );
    ...
    /**
     * @Route("/booking/basic-booking",
     *     name="_booking__basic_booking__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/booking/basic-booking/detail/{id}",
     *     name="_booking__basic_booking__detail",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking/get/{id}",
     *     name="_booking__basic_booking__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking/edit/{id}",
     *     name="_booking__basic_booking__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking/delete/{id}",
     *     name="_booking__basic_booking__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/basic-booking/detail-content",
     *     name="_booking__basic_booking__detail_content")
     *
    ...
    /**
     * @Route("/booking/basic-booking/current-accounts-menus",
     *     name="_booking__basic_booking__current_accounts_menus"
     * )
     *
