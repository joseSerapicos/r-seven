...
class RegularBookingController extends BaseBookingController
{
    ...
    protected function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_booking__regular_booking__get'
            ),
            'edit' => array(
                'name' => '_booking__regular_booking__edit'
            ),
            'delete' => array(
                'name' => '_booking__regular_booking__delete'
            ),
            'detail' => array(
                'name' => '_booking__regular_booking__detail'
            )
        );
    ...
    /**
     * @Route("/booking/regular-booking",
     *     name="_booking__regular_booking__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/booking/regular-booking/detail/{id}",
     *     name="_booking__regular_booking__detail",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/regular-booking/get/{id}",
     *     name="_booking__regular_booking__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/regular-booking/edit/{id}",
     *     name="_booking__regular_booking__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/regular-booking/delete/{id}",
     *     name="_booking__regular_booking__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/booking/regular-booking/detail-content",
     *     name="_booking__regular_booking__detail_content")
     *
    ...
    /**
     * @Route("/booking/regular-booking/current-accounts-menus",
     *     name="_booking__regular_booking__current_accounts_menus"
     * )
     *
