...
/**
 * BookingSettingRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class BookingSettingRepository extends BaseEntityRepository
{
    ...
    static function getMetadata()
    {
        ...
        return self::$metadata = self::processMetadata(array(
            ...
            'menu' => array('table' => 'moduleMenu', 'field' => 'name', 'label' => 'Booking Type', 'type' => 'text',
                'acl' => 'read', 'dependency' => 'moduleMenuObj', 'form' => array('type' => 'none')),
