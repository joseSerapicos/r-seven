...
import {Step2ExtModule as TravelBookingServiceAddStep2ExtModule} from '../../../../travel-booking-service/add/ts/src/step2.ext-module';
import {Step3ExtModule as TravelBookingServiceAddStep3ExtModule} from '../../../../travel-booking-service/add/ts/src/step3.ext-module';
let baseBookingServiceAddProvider = {modules: { // Put here modules dependencies
    step2: {module: TravelBookingServiceAddStep2ExtModule, component: 'Step2Component'},
    step3: {module: TravelBookingServiceAddStep3ExtModule, component: 'Step3Component'},
...
import {BookingPaxEditExtModule as TravelBookingDetailBookingPaxEditExtModule} from '../../../../travel-booking/detail/ts/src/booking-pax-edit.ext-module';
import {Step1ExtModule as TravelBookingServiceAddStep1} from '../../../../travel-booking-service/add/ts/src/step1.ext-module';
import {BookingServiceEditExtModule as TravelBookingServiceEditExtModule} from '../../../../travel-booking-service/edit/ts/src/booking-service-edit.ext-module';
import {CurrentAccountsExtModule as TravelBookingDetailCurrentAccountsExtModule} from '../../../../travel-booking/detail/ts/src/current-accounts.ext-module';
baseBookingDetailProvider['modules'] = {
    bookingPaxEdit: {module: TravelBookingDetailBookingPaxEditExtModule, component: 'BookingPaxEditComponent'},
    bookingServiceAddStep1: {module: TravelBookingServiceAddStep1, component: 'Step1Component'},
    bookingServiceEdit: {module: TravelBookingServiceEditExtModule, component: 'BookingServiceEditComponent'},
    currentAccounts: {module: TravelBookingDetailCurrentAccountsExtModule, component: 'CurrentAccountsComponent'}
};
