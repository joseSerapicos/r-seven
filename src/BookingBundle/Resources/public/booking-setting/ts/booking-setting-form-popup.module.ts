...
import {BookingSettingFormPopupComponent} from './booking-setting-form-popup.component';
...
@NgModule({
    ...
    exports: [BookingSettingFormPopupComponent]
})
export class BookingSettingFormPopupModule {}