...
// EntityGroupEntity
Helper.setRuntimeVar('templateUrl', _app.dependency['userGroupUser']['route']['edit']['url']);
import {MainExtensionModule as UserGroupUserModule} from '../../../user-group-user/edit/ts/main.extension-module';
...
@Component({
    selector: '#js_main',
    templateUrl: Helper.getGlobalVar('route') + 'user/user-group/detail-tabs'
})
