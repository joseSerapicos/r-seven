...
/**
 * @ORM\Entity(repositoryClass="UserBundle\Entity\UserCalendarRepository")
...
class UserCalendar extends BaseEntity {
    ...
    /**
     * Set shareUserObj
     * @param \AdminBundle\Entity\User $shareUserObj
     * @return $this
     */
    public function setShareUserObj(\AdminBundle\Entity\User $shareUserObj = null)
    {
     ...
     * @return $this
     */
    public function setUserGroupObj(\UserBundle\Entity\UserGroup $userGroupObj = null)
    {
