...
import {ClientSettingFormPopupComponent} from './client-setting-form-popup.component';
...
@NgModule({
    ...
    exports: [ClientSettingFormPopupComponent]
})
export class ClientSettingFormPopupModule {}