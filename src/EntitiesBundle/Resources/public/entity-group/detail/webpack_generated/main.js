...
/***/ function(module, exports, __webpack_require__) {
	...
	// EntityGroupEntity
	helper_1.Helper.setRuntimeVar('templateUrl', _app.dependency['entityGroupEntity']['route']['edit']['url']);
	...
	MainComponent = __decorate([
	    core_1.Component({
	        selector: '#js_main',
	        templateUrl: helper_1.Helper.getGlobalVar('route') + 'entities/entity-group/detail-tabs'
	    }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	MainComponent = __decorate([
	    core_1.Component({
	        selector: '.js_main',
	        templateUrl: helper_1.Helper.getGlobalVar('route') + 'entities/entity-group-entity/edit/0'
	    }),
	    __param(2, core_1.Inject('Provider')),
	    __param(3, core_1.Inject('DataService')),
	    __param(6, core_1.Inject('Popups')),
