...
import {DataBoxComponent, DataBoxProvider} from '../../../data-box/ts/src/data-box.component';
...
export class CalendarComponent extends DataBoxComponent
{
    ...
    protected onObjectsChangeSubscription: any;
    ...
    constructor(
        ...
        this.onObjectsChangeSubscription = this._dataService.getOnObjectsChangeEmitter()
