...
import {ServiceDiscountPopupComponent} from './service-discount-popup.component';
...
@NgModule({
    ...
    exports: [ServiceDiscountPopupComponent]
})
export class ServiceDiscountPopupModule {}