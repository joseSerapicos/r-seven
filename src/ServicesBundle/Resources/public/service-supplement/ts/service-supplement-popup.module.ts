...
import {ServiceSupplementPopupComponent} from './service-supplement-popup.component';
...
@NgModule({
    ...
    exports: [ServiceSupplementPopupComponent]
})
export class ServiceSupplementPopupModule {}