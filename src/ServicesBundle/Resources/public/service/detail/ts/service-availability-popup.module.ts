...
import {ServiceAvailabilityPopupComponent} from './service-availability-popup.component';
...
@NgModule({
    ...
    exports: [ServiceAvailabilityPopupComponent]
})
export class ServiceAvailabilityPopupModule {}