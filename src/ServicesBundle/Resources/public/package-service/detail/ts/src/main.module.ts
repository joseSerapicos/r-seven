...
import {PriceExtModule as PackageServicePriceExtModule} from '../../../../package-service-price/index/ts/src/price.ext-module';
...
baseServiceProvider['modules'] = {
    price: {module: PackageServicePriceExtModule, component: 'PriceComponent'},
