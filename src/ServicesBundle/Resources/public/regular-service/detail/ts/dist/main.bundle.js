...
var FileComponent = (function (_super) {
    ...
    function FileComponent(viewContainerRef, renderer, provider, dataService, tasksLoaderManagerService, actionsService, modalService, popups, injector, _helperService) {
        var _this = 
        // Call parent
        _super.call(this, viewContainerRef, renderer, provider, dataService, tasksLoaderManagerService, actionsService, modalService, popups, injector) || this;
        _this._helperService = _helperService;
        return _this;
    }
    /**
    ...
    FileComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewContainerRef */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Renderer */], Object, Object, __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_tasks_loader_manager_ts_tasks_loader_manager_service__["a" /* TasksLoaderManagerService */],
            __WEBPACK_IMPORTED_MODULE_1__ts_actions_actions_service__["a" /* ActionsService */],
            __WEBPACK_IMPORTED_MODULE_3__modal_ts_modal_service__["c" /* ModalService */], Object, __WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injector */], Object])
    ], FileComponent);
...
var ImageSlideComponent = (function (_super) {
    ...
    function ImageSlideComponent(viewContainerRef, renderer, provider, dataService, tasksLoaderManagerService, actionsService, modalService, popups, injector, helperService) {
        // Call parent
        return _super.call(this, viewContainerRef, renderer, provider, dataService, tasksLoaderManagerService, actionsService, modalService, popups, injector, helperService) || this;
    }
    /**
     * Get web path
     * @param path
    ...
    ImageSlideComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewContainerRef */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Renderer */], Object, Object, __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_tasks_loader_manager_ts_tasks_loader_manager_service__["a" /* TasksLoaderManagerService */],
            __WEBPACK_IMPORTED_MODULE_1__ts_actions_actions_service__["a" /* ActionsService */],
            __WEBPACK_IMPORTED_MODULE_2__modal_ts_modal_service__["c" /* ModalService */], Object, __WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injector */], Object])
    ], ImageSlideComponent);
...
var ImageComponent = (function (_super) {
    ...
    function ImageComponent(viewContainerRef, renderer, provider, dataService, tasksLoaderManagerService, actionsService, modalService, popups, injector, _helperService) {
        var _this = 
        // Call parent
        _super.call(this, viewContainerRef, renderer, provider, dataService, tasksLoaderManagerService, actionsService, modalService, popups, injector) || this;
        _this._helperService = _helperService;
...
var ObservationComponent = (function (_super) {
    ...
    function ObservationComponent(viewContainerRef, renderer, dataBoxProvider, dataService, tasksLoaderManagerService, actionsService, modalService, popups, injector) {
        // Call parent
        return _super.call(this, viewContainerRef, renderer, dataBoxProvider, dataService, tasksLoaderManagerService, actionsService, modalService, popups, injector) || this;
    }
...
module.exports = "\n<div class=\"ibox\">\n            <div class=\"ibox-title\" *ngIf=\"!getProviderExtraDataAttr('hasMergeHeader')\">\n            <h5>\n                <ng-template [ngIf]=\"getProviderAttr('controls')['expander']\"><js_expander\n                    [isExpanded]=\"_isExpanded || null\"\n                    [label]=\"getProviderAttr('label')\"\n                    (onChange)=\"expanderAction($event)\"></js_expander></ng-template>\n                <ng-template [ngIf]=\"!getProviderAttr('controls')['expander']\">\n                    <span [innerHTML]=\"getProviderAttr('label')\"></span>\n                </ng-template>\n            </h5>\n            <div *ngIf=\"_isExpanded\"\n                 class=\"txt-align-r hide-on-empty\">    <div class=\"actions no-user-select\">\n        <ng-template [ngIf]=\"_actionsService.getActionAttr('search', 'isEnabled')\"><js_search class=\"search\"></js_search></ng-template>\n        <div (click)=\"triggerAction($event)\">\n            <ng-template ngFor let-action [ngForOf]=\"_actionsService.getHeadActions()\">\n                <a *ngIf=\"_actionsService.getActionAttr(action, 'isEnabled')\"\n                   [ngClass]=\"[_actionsService.getActionAttr(action, 'icon')]\"\n                   class=\"-round fa\"\n                   [attr.data-action]=\"action\"></a>\n            </ng-template>\n        </div>\n    </div>\n</div>\n        </div>\n    \n    <div [hidden]=\"!(_isExpanded)\" class=\"ibox-content hide-on-empty\">    <ng-template [ngIf]=\"(_dataService.getProviderAttr('objects') && _dataService.getProviderAttr('objects')[0])\">\n        <div class=\"row\">\n        <div class=\"col-sm-6\"\n             *ngFor=\"let obj of _dataService.getProviderAttr('objects'); let index = index\">\n            <div class=\"panel\"\n                 [class.panel-default]=\"obj['type'] == 'DEFAULT'\"\n                 [class.panel-info]=\"obj['type'] == 'INFO'\"\n                 [class.panel-warning]=\"obj['type'] == 'WARNING'\"\n                 [class.panel-danger]=\"obj['type'] == 'DANGER'\">\n                <div class=\"panel-heading\">\n                    <i class=\"fa\"\n                       [class.panel-default]=\"obj['type'] == 'DEFAULT'\"\n                       [class.fa-info-circle]=\"obj['type'] == 'INFO'\"\n                       [class.fa-warning]=\"obj['type'] == 'WARNING'\"\n                       [class.panel-danger]=\"obj['type'] == 'DANGER'\"></i>&nbsp;{{obj['name']}}\n                </div>\n                <div class=\"panel-body\">\n                    <p>{{obj['description']}}</p>\n                </div>\n                <div class=\"panel-footer txt-align-r\">\n                    <span class=\"txt-align-r actions no-user-select\"\n                          (click)=\"triggerAction($event)\">\n                        <ng-template ngFor let-action [ngForOf]=\"_actionsService.getDetailActions()\">\n                            <a *ngIf=\"_actionsService.getActionAttr(action, 'isEnabled')\"\n                               [ngClass]=\"[_actionsService.getActionAttr(action, 'icon')]\"\n                               class=\"fa\"\n                               [attr.data-action]=\"action\"\n                               [attr.data-value]=\"index\"></a>\n                        </ng-template>\n                    </span>\n                </div>\n            </div>\n        </div>\n    </div>\n    </ng-template><p\n        class=\"text-center\"\n        *ngIf=\"!(_dataService.getProviderAttr('objects') && _dataService.getProviderAttr('objects')[0])\">No results.</p>\n</div>\n        <div class=\"ibox-footer\"\n         *ngIf=\"_dataService.countObjects() > 0\"><js_searchPagination></js_searchPagination></div>\n\n</div>\n\n"
...
var CostWithVatPopupComponent = (function (_super) {
    ...
    CostWithVatPopupComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Renderer */], Object, __WEBPACK_IMPORTED_MODULE_2__ts_form_form_service__["a" /* FormService */], Object, Object])
...
var PriceFormPopupComponent = (function (_super) {
    ...
    PriceFormPopupComponent.prototype.setPriceValue = function (baseField) {
        ...
        }, fieldToSet = ((baseField == 'COST') ? 'SELL' : 'COST'), obj = this._formService.getObject(), isVatIncluded = obj['isVatIncluded'], vatPercentage = parseFloat(obj['vatCode_percentage'] || '0'), user_baseValue = parseFloat(obj[fields[baseField]['user_value']] || '0'), user_valueToSet = 0, // Will be calculated
...
var VideoFormUrlComponent = (function (_super) {
    ...
    VideoFormUrlComponent = __decorate([
        ...
        __param(4, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('DataService')),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Renderer */], Object, __WEBPACK_IMPORTED_MODULE_2__ts_form_form_service__["a" /* FormService */], Object])
...
var VideoComponent = (function (_super) {
    ...
    function VideoComponent(viewContainerRef, renderer, provider, dataService, tasksLoaderManagerService, actionsService, modalService, popups, injector, _helperService) {
        var _this = 
        // Call parent
        _super.call(this, viewContainerRef, renderer, provider, dataService, tasksLoaderManagerService, actionsService, modalService, popups, injector) || this;
        _this._helperService = _helperService;
    ...
    VideoComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewContainerRef */],
            ...
            __WEBPACK_IMPORTED_MODULE_2__ts_actions_actions_service__["a" /* ActionsService */],
            __WEBPACK_IMPORTED_MODULE_1__modal_ts_modal_service__["c" /* ModalService */], Object, __WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injector */], Object])
    ], VideoComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ts_search_search_pagination_module__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/ts/search/search-pagination.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ts_expander_expander_module__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/ts/expander/expander.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__video_component__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/video/ts/src/video.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VideoExtModule = (function () {
    ...
    VideoExtModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["H" /* NgModule */])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_5__video_component__["a" /* VideoComponent */]],
            exports: [__WEBPACK_IMPORTED_MODULE_5__video_component__["a" /* VideoComponent */]]
        })
    ], VideoExtModule);
...
/***/ "../../../../../src/ServicesBundle/Resources/public/regular-service-price/index/ts/src/price.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var PriceComponent = (function (_super) {
    ...
    PriceComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: '.js_controls',
            template: __webpack_require__("../../../../../src/ServicesBundle/Resources/public/regular-service-price/index/ts/templates/price.component.html")
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* Optional */])()), __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('Provider')),
        __param(3, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('HelperService')),
        __param(5, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('DataService')),
...
/***/ "../../../../../src/ServicesBundle/Resources/public/regular-service-price/index/ts/src/price.ext-module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__price_component__ = __webpack_require__("../../../../../src/ServicesBundle/Resources/public/regular-service-price/index/ts/src/price.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
webpackEmptyAsyncContext.id = "../../../../../src/ServicesBundle/Resources/public/regular-service/detail/ts/$$_lazy_route_resource lazy recursive";

/***/ }),

/***/ "../../../../../src/ServicesBundle/Resources/public/regular-service/detail/ts/src/main.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__AppBundle_Resources_public_ts_nav_manager_nav_manager_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/ts/nav-manager/nav-manager.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__base_service_detail_ts_src_main_component__ = __webpack_require__("../../../../../src/ServicesBundle/Resources/public/base-service/detail/ts/src/main.component.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var MainComponent = (function (_super) {
    ...
    MainComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: '.js_app',
            template: __webpack_require__("../../../../../src/ServicesBundle/Resources/public/regular-service/detail/ts/templates/main.component.html")
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* Optional */])()), __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('Provider')),
        __param(3, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('HelperService')),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */],
...
/***/ "../../../../../src/ServicesBundle/Resources/public/regular-service/detail/ts/src/main.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__main_component__ = __webpack_require__("../../../../../src/ServicesBundle/Resources/public/regular-service/detail/ts/src/main.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__regular_service_price_index_ts_src_price_ext_module__ = __webpack_require__("../../../../../src/ServicesBundle/Resources/public/regular-service-price/index/ts/src/price.ext-module.ts");
...
/***/ "../../../../../src/ServicesBundle/Resources/public/regular-service/detail/ts/src/main.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__main_module__ = __webpack_require__("../../../../../src/ServicesBundle/Resources/public/regular-service/detail/ts/src/main.module.ts");
...
var ServiceAllotEditExtModule = (function () {
    ...
    ServiceAllotEditExtModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["H" /* NgModule */])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_common__["a" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* ReactiveFormsModule */],
                __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_ts_form_field_types_field_types_extension_module__["a" /* FieldTypesExtensionModule */],
...
var ServiceDiscountEditComponent = (function (_super) {
    ...
    ServiceDiscountEditComponent = __decorate([
        ...
        __param(5, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('HelperService')),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Renderer */], Object, __WEBPACK_IMPORTED_MODULE_1__AppBundle_Resources_public_ts_form_form_service__["a" /* FormService */], Object, Object])
...
var ServiceFixedCostEditComponent = (function (_super) {
    ...
    ServiceFixedCostEditComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Renderer */], Object, __WEBPACK_IMPORTED_MODULE_2__AppBundle_Resources_public_ts_form_form_service__["a" /* FormService */], Object, Object, Object])
...
module.exports = __webpack_require__("../../../../../src/ServicesBundle/Resources/public/regular-service/detail/ts/src/main.ts");
