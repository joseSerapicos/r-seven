...
class GrouperServiceController extends BaseServiceController
{
    ...
    protected function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_services__grouper_service__get'
            ),
            'edit' => array(
                'name' => '_services__grouper_service__edit'
            ),
            'delete' => array(
                'name' => '_services__grouper_service__delete'
            )
        );
    ...
    /**
     * @Route("/services/grouper-service",
     *     name="_services__grouper_service__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/services/grouper-service/get/{id}",
     *     name="_services__grouper_service__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/services/grouper-service/get-vat-code-percentage/{id}",
     *     name="_services__grouper_service__get_vat_code_percentage"
     * )
     *
    ...
    /**
     * @Route("/services/grouper-service/edit/{id}",
     *     name="_services__grouper_service__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/services/grouper-service/delete/{id}",
     *     name="_services__grouper_service__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/services/grouper-service/conf",
     *     name="_services__grouper_service__conf"
     * )
     *
