...
/***/ function(module, exports, __webpack_require__) {
	...
	var user_calendar_module_1 = __webpack_require__(29);
	platform_browser_dynamic_1.platformBrowserDynamic().bootstrapModule(user_calendar_module_1.UserCalendarModule);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var form_service_1 = __webpack_require__(46);
	var flash_message_service_1 = __webpack_require__(24);
	var dynamic_component_loader_service_1 = __webpack_require__(39);
	var data_service_1 = __webpack_require__(47);
	var actions_service_1 = __webpack_require__(48);
	var calendar_component_1 = __webpack_require__(49);
	// Define templateUrl to component at runtime
	helper_1.Helper.setRuntimeVar('templateUrl', _app.dependency['userCalendar'].route['edit']['url']);
	var form_popup_extension_module_1 = __webpack_require__(164);
	var UserCalendarModule = (function () {
	    function UserCalendarModule() {
	    }
	    return UserCalendarModule;
	}());
	UserCalendarModule = __decorate([
	    core_1.NgModule({
	        imports: [
	        ...
	        providers: [
	            ...
	            { provide: 'DataServiceProvider', useValue: helper_1.Helper.getDataServiceProvider(_app.dependency['userCalendar']) },
	            { provide: 'Provider', useValue: helper_1.Helper.getImageProvider(_app.dependency['userCalendar'], {}) },
	            { provide: 'ActionsServiceProvider', useValue: helper_1.Helper.getActionsServiceProvider(_app.dependency['userCalendar']) },
	            { provide: 'Popups', useValue: {
	                    module: form_popup_extension_module_1.FormPopupExtensionModule,
	                    component: 'FormPopupComponent',
	                    providers: [
	                        form_service_1.FormService,
	                        { provide: 'Provider', useValue: helper_1.Helper.getFormProvider(_app.dependency['userCalendar']) }
	                    ]
	                } }
	        ],
	        bootstrap: [calendar_component_1.CalendarComponent]
	    })
	], UserCalendarModule);
	exports.UserCalendarModule = UserCalendarModule;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions_service_1 = __webpack_require__(48);
	var modal_service_1 = __webpack_require__(38);
	var helper_ts_1 = __webpack_require__(36);
	var data_box_component_1 = __webpack_require__(161);
	var CalendarComponent = (function (_super) {
	    ...
	    function CalendarComponent(viewContainerRef, renderer, provider, dataService, actionsService, modalService, popups, injector) {
	        ...
	        _this._onObjectsRefreshSubscription = _this._dataService.getOnObjectsRefreshEmitter()
	            .subscribe(function (objects) { return _this.refreshCalendar(); });
	...
	CalendarComponent = __decorate([
	    core_1.Component({
	        ...
	        templateUrl: helper_ts_1.Helper.getGlobalVar('route') + 'template/box/calendar'
	    }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var data_box_extension_component_1 = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var data_service_1 = __webpack_require__(47);
	var box_extension_component_1 = __webpack_require__(163);
	// Popup Types
	exports.PopupTypes = {
	    edit: 'edit',
	    add: 'add'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var common_1 = __webpack_require__(22);
	var forms_1 = __webpack_require__(30);
	var form_popup_component_1 = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var helper_1 = __webpack_require__(36);
	var form_popup_extension_component_1 = __webpack_require__(166);
	var form_service_1 = __webpack_require__(46);
	...
	FormPopupComponent = __decorate([
	    ...
	    __param(5, core_1.Optional()), __param(5, core_1.Inject('TimeSelection')),
	    __metadata("design:paramtypes", [core_1.ElementRef,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var form_extension_component_1 = __webpack_require__(167);
