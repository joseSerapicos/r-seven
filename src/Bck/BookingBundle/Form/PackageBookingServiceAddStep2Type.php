...
class PackageBookingServiceAddStep2Type extends BaseType
{
    /**
    ...
    protected function setEntityMetadata()
    {
        ...
        $this->entityMetadata['bookingServiceObj']['typeDetail']['formClass'] = 'Bck\BookingBundle\Form\BookingServiceAddStep2Type';
