...
class RegularBookingServiceAllManualType extends BaseType
{
    /**
    ...
    protected function setEntityMetadata()
    {
        ...
        $this->entityMetadata['bookingServiceObj']['typeDetail']['formClass'] = 'Bck\BookingBundle\Form\BookingServiceAllManualType';
