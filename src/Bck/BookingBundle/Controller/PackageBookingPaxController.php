...
class PackageBookingPaxController extends BaseEntityChildController
{
    ...
    public function init(Request $request, $parents = null)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__booking__package_booking_pax__get'
            ),
            'edit' => array(
                'name' => '_bck__booking__package_booking_pax__edit',
            ),
            'delete' => array(
                'name' => '_bck__booking__package_booking_pax__delete',
            )
        );
    ...
    /**
     * @Route("/bck/booking/package-booking-pax/get/{booking}/{id}",
     *     name="_bck__booking__package_booking_pax__get",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/booking/package-booking-pax/edit/{booking}/{id}",
     *     name="_bck__booking__package_booking_pax__edit",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/booking/package-booking-pax/delete/{booking}/{id}",
     *     name="_bck__booking__package_booking_pax__delete",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/booking/package-booking-pax/data/{booking}",
     *     name="_bck__booking__package_booking_pax__data"
     * )
     *
     * Overrides parent method
     * @param Request $request
    ...
    /**
     * @Route("/bck/booking/package-booking-pax/conf/{booking}/{id}",
     *     name="_bck__booking__package_booking_pax__conf",
     *     defaults={"id" = null}
     * )
     *
     * Overrides parent method
    ...
    public function initForAddService(Request $request, $parents = null)
    {
        ...
        $this->templateConf['route'] = array(
            ...
            'edit' => array(
                'name' => '_bck__booking__package_booking_pax__edit_for_add_service',
            ),
            'delete' => array(
                'name' => '_bck__booking__package_booking_pax__delete',
            )
    ...
    /**
     * @Route("/bck/booking/package-booking-pax/edit-for-add-service/{booking}/{id}",
     *     name="_bck__booking__package_booking_pax__edit_for_add_service",
     *     defaults={"id" = null}
     * )
     *
    ...
    public function editForAddServiceAction(Request $request, $booking, $id)
    {
        ...
        $this->localConf['formTypeClass'] = 'Bck\BookingBundle\Form\PackageBookingPaxForAddServiceType';
        return $this->editLocalChildAction($request, $booking, $id);
    }

    /**
     * @Route("/bck/booking/package-booking-pax/data-for-add-service/{booking}",
     *     name="_bck__booking__package_booking_pax__data_for_add_service"
     * )
     *
     * Overrides parent method
     * @param Request $request
