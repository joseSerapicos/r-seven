...
use Bck\AccountingBundle\Controller\BaseDocumentInvoiceDetailController;
...
class BookingServicePriceController extends BaseEntityChildController
{
    ...
    public function init(Request $request, $parents = null)
    {
        ...
        // Menu
        $this->templateConf['selectedMenu']['route'] = '_bck__booking__booking_service__index';

        // Parent route
        $this->parentConf = array(
            'bookingService' => array('route' => '_bck__booking__booking_service__index')
        );

        // Route
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__booking__booking_service_price__get'
            ),
            'edit' => array(
                'name' => '_bck__booking__booking_service_price__edit',
            ),
            'delete' => array(
                'name' => '_bck__booking__booking_service_price__delete',
            )
        );
    ...
    /**
     * @Route("/bck/booking/booking-service-price/get/{bookingService}/{id}",
     *     name="_bck__booking__booking_service_price__get",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
    /**
     * @Route("/bck/booking/booking-service-price/edit/{bookingService}/{id}",
     *     name="_bck__booking__booking_service_price__edit",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/booking/booking-service-price/delete/{bookingService}/{id}",
     *     name="_bck__booking__booking_service_price__delete",
     *     defaults={"id" = null}
     * )
     *
    ...
    {
        return parent::deleteChildAction($request, array($bookingService), $id);
    }

    /**
     * @Route("/bck/booking/booking-service-price/data/{bookingService}",
     *     name="_bck__booking__booking_service_price__data"
     * )
     *
     * Overrides parent method
     * @param Request $request
    ...
    /**
     * @Route("/bck/booking/booking-service-price/conf/{bookingService}/{id}",
     *     name="_bck__booking__booking_service_price__conf",
     *     defaults={"id" = null}
     * )
     *
     * Overrides parent method
     ...
     * @return mixed
     */
    public function confLocalChildAction(Request $request, $bookingService, $id = null)
    {
        return parent::confChildAction($request, array($bookingService), $id);
    }
    ...
    // TO INTERACTS WITH BckAccountingBundle/DocumentInvoiceDetail
    /////////////////////////////////////////////////////////////////////////////////////////////////////////

    /**
     * THE "init" METHOD NEEDS TO BE DEFINED HERE, BECAUSE THIS CLASS IS INDEPENDENT OF BOOKING TYPE AND INTERACTS
     * WITH BckAccountingBundle/DocumentInvoiceDetail
     *
     * Overrides parent method
     * @param Request $request
     * @param $parents
    ...
    private function initForInvoice(Request $request, $parents, $entityId, $entityContext, $booking = null)
    {
        ...
        $getRouteName = '_bck__booking__booking_service_price__get_for_invoice_'.$entityContext;
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => $getRouteName,
        ...
        // Search
        $entityObj = $this->getRepositoryService($entityContextUC, 'EntitiesBundle', 'Bck')
            ->execute(
                'findOneById',
                array($entityId)
            );
    ...
    /**
     * @Route("/bck/booking/booking-service-price/get-for-invoice-client/{client}/{booking}",
     *     name="_bck__booking__booking_service_price__get_for_invoice_client",
    ...
    /**
     * @Route("/bck/booking/booking-service-price/get-for-invoice-supplier/{supplier}/{booking}",
     *     name="_bck__booking__booking_service_price__get_for_invoice_supplier",
    ...
    /**
     * @Route("/bck/booking/booking-service-price/data-for-invoice-client/{client}/{booking}",
     *     name="_bck__booking__booking_service_price__data_for_invoice_client",
     *     defaults={"client" = null, "booking" = null}
     * )
     *
     * Data for invoice
    ...
    /**
     * @Route("/bck/booking/booking-service-price/data-for-invoice-supplier/{supplier}/{booking}",
     *     name="_bck__booking__booking_service_price__data_for_invoice_supplier",
     *     defaults={"supplier" = null, "booking" = null}
     * )
     *
     * Data for invoice
    ...
    static function getObjectsBySearchForInvoice($controller, $entityContext, $options = array())
    {
        ...
        $objects = $controller->getRepositoryService('BookingServicePrice', 'BookingBundle', 'Bck')
            ->execute(
                'getForInvoice',
        ...
        if (is_array($objectsArr) && (count($objectsArr) > 0)) {
            foreach ($objectsArr as &$obj) {
                ...
                if ($parentNode != $obj['bookingObj']) {
                    ...
                    $bookingObj = $this->getRepositoryService('Booking', 'BookingBundle', 'Bck')
                        ->execute(
                            'findOneById',
                            array($parentNode)
                        );
