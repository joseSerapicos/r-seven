...
/**
 * @ORM\Entity(repositoryClass="Bck\BookingBundle\Entity\BookingRepository")
...
class Booking extends BasePriceResume
{
     ...
     * @return $this
     */
    public function setBookingPaxObj(\Bck\BookingBundle\Entity\BookingPax $bookingPaxObj = null)
    {
