...
/**
 * PackageBookingPaxRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class PackageBookingPaxRepository extends BaseEntityRepository
{
    ...
    static function getMetadata()
    {
        ...
        return self::$metadata = self::processMetadata(array(
            ...
            'bookingPaxObj' => array('label' => '', 'type' => 'object', 'acl' => 'read',
                'typeDetail' => array(
                    'table' => 'bookingPax', 'field' => 'id', 'bundlePrefix' => 'bck', 'bundle' => 'booking', 'type' => 'none',
