...
/**
 * @ORM\Entity(repositoryClass="Bck\BookingBundle\Entity\BookingServicePriceRepository")
...
class BookingServicePrice extends BasePriceWithVat
{
     ...
     * @param \Bck\BookingBundle\Entity\BookingService $bookingServiceObj
     * @return $this
     */
    public function setBookingServiceObj(\Bck\BookingBundle\Entity\BookingService $bookingServiceObj)
    {
     ...
     * @param \Bck\BookingBundle\Entity\BookingServicePrice $groupedBookingServicePriceObj
     * @return $this
     */
    public function setGroupedBookingServicePriceObj(\Bck\BookingBundle\Entity\BookingServicePrice $groupedBookingServicePriceObj = null)
    {
