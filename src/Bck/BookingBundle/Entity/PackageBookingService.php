...
/**
 * @ORM\Entity(repositoryClass="Bck\BookingBundle\Entity\PackageBookingServiceRepository")
 * @ORM\Table(name="packageBookingService")
 */
class PackageBookingService extends BaseEntity
{
    /**
