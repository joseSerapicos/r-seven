...
class EntityGroupController extends BaseEntityController
{
    ...
    public function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__entities__entity_group__get'
            ),
            'edit' => array(
                'name' => '_bck__entities__entity_group__edit'
            ),
            'delete' => array(
                'name' => '_bck__entities__entity_group__delete'
            ),
            'detail' => array(
                'name' => '_bck__entities__entity_group__detail'
            ),
        );
    ...
    /**
     * @Route("/bck/entities/entity-group",
     *     name="_bck__entities__entity_group__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/bck/entities/entity-group/detail/{id}",
     *     name="_bck__entities__entity_group__detail",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/entities/entity-group/get/{id}",
     *     name="_bck__entities__entity_group__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/entities/entity-group/edit/{id}",
     *     name="_bck__entities__entity_group__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/entities/entity-group/delete/{id}",
     *     name="_bck__entities__entity_group__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/entities/entity-group/detail-tabs",
     *     name="_bck__entities__entity_group__detail_tabs")
     *
