...
use Bck\EntitiesBundle\Entity\EntityPhone;
...
class EntityPhoneController extends BaseEntityChildController
{
    ...
    public function init(Request $request, $parents = null)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__entities__entity_phone__get'
            ),
            'choices' => array(
                'name' => '_bck__entities__entity_phone__choices'
            ),
            'edit' => array(
                'name' => '_bck__entities__entity_phone__edit',
            ),
            'delete' => array(
                'name' => '_bck__entities__entity_phone__delete',
            )
        );
    ...
    /**
     * @Route("/bck/entities/entity-phone/get/{entity}/{id}",
     *     name="_bck__entities__entity_phone__get",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/entities/entity-phone/choices/{entity}",
     *     name="_bck__entities__entity_phone__choices"
     * )
     *
     * Overrides parent method
    ...
    /**
     * @Route("/bck/entities/entity-phone/edit/{entity}/{id}",
     *     name="_bck__entities__entity_phone__edit",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/entities/entity-phone/delete/{entity}/{id}",
     *     name="_bck__entities__entity_phone__delete",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/entities/entity-phone/data/{entity}",
     *     name="_bck__entities__entity_phone__data"
     * )
     *
     * Overrides parent method
     * @param Request $request
    ...
    /**
     * @Route("/bck/entities/entity-phone/conf/{entity}/{id}",
     *     name="_bck__entities__entity_phone__conf",
     *     defaults={"id" = null}
     * )
     *
     * Overrides parent method
