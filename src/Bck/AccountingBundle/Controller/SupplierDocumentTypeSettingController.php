...
class SupplierDocumentTypeSettingController extends BaseEntityController
{
    ...
    public function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__accounting__supplier_document_type_setting__get'
            ),
            'edit' => array(
                'name' => '_bck__accounting__supplier_document_type_setting__edit',
            ),
            'delete' => array(
                'name' => '_bck__accounting__supplier_document_type_setting__delete',
            )
        );
    ...
    /**
     * @Route("/bck/accounting/supplier-document-type-setting/get/{id}",
     *     name="_bck__accounting__supplier_document_type_setting__get",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/accounting/supplier-document-type-setting/edit/{id}",
     *     name="_bck__accounting__supplier_document_type_setting__edit",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/accounting/supplier-document-type-setting/delete/{id}",
     *     name="_bck__accounting__supplier_document_type_setting__delete",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/accounting/supplier-document-type-setting/data",
     *     name="_bck__accounting__supplier_document_type_setting__data"
     * )
     *
     * Overrides parent method
     * @param Request $request
    ...
    protected function preSaveObject(&$object, $data) {
        ...
        $results = $this->getRepositoryService("SupplierDocument", 'AccountingBundle', 'Bck')
            ->execute(
                'queryBuilder',
                array(
                    array(
