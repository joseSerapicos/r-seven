...
class ClientDocumentTypeController extends BaseEntityController
{
    ...
    public function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__accounting__client_document_type__get'
            ),
            'edit' => array(
                'name' => '_bck__accounting__client_document_type__edit'
            ),
            'delete' => array(
                'name' => '_bck__accounting__client_document_type__delete'
            )
        );
        ...
        // Templates
        $this->localConf['templates']['edit'] = 'BckAccountingBundle:DocumentTypes:edit.html.twig';
    ...
    /**
     * @Route("/bck/accounting/client-document-type",
     *     name="_bck__accounting__client_document_type__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/bck/accounting/client-document-type/get/{id}",
     *     name="_bck__accounting__client_document_type__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/accounting/client-document-type/edit/{id}",
     *     name="_bck__accounting__client_document_type__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/accounting/client-document-type/delete/{id}",
     *     name="_bck__accounting__client_document_type__delete",
     *     defaults={"id" = null},
     * )
     *
