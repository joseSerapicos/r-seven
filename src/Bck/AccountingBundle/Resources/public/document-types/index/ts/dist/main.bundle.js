...
/***/ "../../../../../src/Bck/AccountingBundle/Resources/public/client-document-type/index/ts/src/edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var EditComponent = (function (_super) {
    ...
    function EditComponent(elementRef, renderer, provider, formService, dataService) {
        var _this = _super.call(this) || this;
        _this._userRole = (_app.userRole || null); // Used in view
    ...
    EditComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: '#js_edit',
            template: __webpack_require__("../../../../../src/Bck/AccountingBundle/Resources/public/client-document-type/index/ts/templates/edit.component.html")
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* Inject */])('Provider')),
...
/***/ "../../../../../src/Bck/AccountingBundle/Resources/public/client-document-type/index/ts/src/edit.ext-module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("../../../forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__edit_component__ = __webpack_require__("../../../../../src/Bck/AccountingBundle/Resources/public/client-document-type/index/ts/src/edit.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "../../../../../src/Bck/AccountingBundle/Resources/public/client-document-type/index/ts/templates/edit.component.html":
/***/ (function(module, exports) {

module.exports = "    \n    <form name=\"form\" method=\"post\" (ngSubmit)=\"saveAction($event)\" [formGroup]=\"_formService.getForm()\" class=\"form-horizontal\">\n<div class=\"modal-header\">\n    <div class=\"row align-items-center\">\n        <h3 class=\"col-auto mr-auto modal-title\">Form&nbsp;{{getProviderAttr('label')}}<small>&nbsp;({{(_formService && _formService.getObject() && _formService.getObject().id) ? 'edit' : 'add'}})</small></h3>\n        <div class=\"col-auto text-right actions\"><a\n                class=\"-round fa fa-times\"\n                (click)=\"closeAction($event)\"></a></div>\n    </div>\n</div>\n<div class=\"modal-body\">\n    <div class=\"row\">\n        <div class=\"col-12\">        \n                                        \n\n                <div class=\"row form-group\" *ngIf=\"_formService.getObject().id\">\n\n                        <label class=\"col-sm-2 control-label required\" for=\"form_id\">Id</label>\n    \n            <div class=\"col-sm-10\">\n                                        <p id=\"form_id\"\n               class=\"form-control-static\"\n               [innerHTML]=\"_formService.getViewObject().id\"></p>\n                        <label class=\"error\" *ngFor=\"let error of _formService.getErrors().id\">{{error}}</label>\n            </div>\n        </div>\n                                                    \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label required\" for=\"form_name\">Name</label>\n    \n            <div class=\"col-sm-10\">\n                                            <input type=\"text\" id=\"form_name\" name=\"form[name]\" required=\"required\" maxlength=\"128\" [(ngModel)]=\"_formService.getObject().name\" formControlName=\"name\" [class.error]=\"_formService.getErrors().name &amp;&amp; _formService.getErrors().name.length &gt; 0\" class=\"form-control\" />\n                <label class=\"error\" *ngFor=\"let error of _formService.getErrors().name\">{{error}}</label>\n            </div>\n        </div>\n                                                    \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label required\" for=\"form_prefix\">Prefix</label>\n    \n            <div class=\"col-sm-10\">\n                                            <input type=\"text\" id=\"form_prefix\" name=\"form[prefix]\" required=\"required\" maxlength=\"8\" [(ngModel)]=\"_formService.getObject().prefix\" formControlName=\"prefix\" [class.error]=\"_formService.getErrors().prefix &amp;&amp; _formService.getErrors().prefix.length &gt; 0\" class=\"form-control\" />\n                <label class=\"error\" *ngFor=\"let error of _formService.getErrors().prefix\">{{error}}</label>\n            </div>\n        </div>\n                                                    \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label required\" for=\"form_type\">Type</label>\n    \n            <div class=\"col-sm-10\">\n                                                                    \n        <select id=\"form_type\" name=\"form[type]\" [(ngModel)]=\"_formService.getObject().type\" formControlName=\"type\" [class.error]=\"_formService.getErrors().type &amp;&amp; _formService.getErrors().type.length &gt; 0\" class=\"form-control\"><option value=\"INVOICE\">Invoice</option><option value=\"RECTIFICATION\">Rectification</option><option value=\"RECEIPT\">Receipt</option><option value=\"PAYMENT\">Payment</option><option value=\"SETTLEMENT\">Settlement</option></select>\n    <input [(ngModel)]=\"_formService.getObject().type\"\n           formControlName = type\n           required=\"required\"           type=\"hidden\">\n\n                            <label class=\"error\" *ngFor=\"let error of _formService.getErrors().type\">{{error}}</label>\n            </div>\n        </div>\n                                                    \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label required\" for=\"form_operation\">Operation</label>\n    \n            <div class=\"col-sm-10\">\n                                                                    \n        <select id=\"form_operation\" name=\"form[operation]\" [(ngModel)]=\"_formService.getObject().operation\" formControlName=\"operation\" [class.error]=\"_formService.getErrors().operation &amp;&amp; _formService.getErrors().operation.length &gt; 0\" class=\"form-control\"><option value=\"DEBIT\">Debit</option><option value=\"CREDIT\">Credit</option><option value=\"NONE\">None</option></select>\n    <input [(ngModel)]=\"_formService.getObject().operation\"\n           formControlName = operation\n           required=\"required\"           type=\"hidden\">\n\n                            <label class=\"error\" *ngFor=\"let error of _formService.getErrors().operation\">{{error}}</label>\n            </div>\n        </div>\n                                                    \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label required\" for=\"form_acl\">Access Control List</label>\n    \n            <div class=\"col-sm-10\">\n                                                                    \n        <select id=\"form_acl\" name=\"form[acl]\" [(ngModel)]=\"_formService.getObject().acl\" formControlName=\"acl\" [class.error]=\"_formService.getErrors().acl &amp;&amp; _formService.getErrors().acl.length &gt; 0\" class=\"form-control\"><option value=\"1\">Read</option><option value=\"2\">Edit</option><option value=\"4\">Cancel</option><option value=\"7\">All</option></select>\n    <input [(ngModel)]=\"_formService.getObject().acl\"\n           formControlName = acl\n           required=\"required\"           type=\"hidden\">\n\n                            <label class=\"error\" *ngFor=\"let error of _formService.getErrors().acl\">{{error}}</label>\n            </div>\n        </div>\n                                                    \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label required\" for=\"form_aclTargetDocs\">ACL For Docs.</label>\n    \n            <div class=\"col-sm-10\">\n                                                                    \n        <select id=\"form_aclTargetDocs\" name=\"form[aclTargetDocs]\" [(ngModel)]=\"_formService.getObject().aclTargetDocs\" formControlName=\"aclTargetDocs\" [class.error]=\"_formService.getErrors().aclTargetDocs &amp;&amp; _formService.getErrors().aclTargetDocs.length &gt; 0\" class=\"form-control\"><option value=\"CREATED\">Created</option><option value=\"NOT_ACCESSED\">Not Accessed</option></select>\n    <input [(ngModel)]=\"_formService.getObject().aclTargetDocs\"\n           formControlName = aclTargetDocs\n           required=\"required\"           type=\"hidden\">\n\n                            <label class=\"error\" *ngFor=\"let error of _formService.getErrors().aclTargetDocs\">{{error}}</label>\n            </div>\n        </div>\n                                                    <ng-template [ngIf]=\"_userRole == 'ROLE_SYSADMIN'\">\n                    \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label\" [innerHTML]=\"getLang('Requires Sysadmin Role')\"></label>\n    \n            <div class=\"col-sm-10\">\n                                            <div class=\"checkbox\">                                        <label for=\"form_requiresSysadminRole\"><input type=\"checkbox\" id=\"form_requiresSysadminRole\" name=\"form[requiresSysadminRole]\" [(ngModel)]=\"_formService.getObject().requiresSysadminRole\" formControlName=\"requiresSysadminRole\" [class.error]=\"_formService.getErrors().requiresSysadminRole &amp;&amp; _formService.getErrors().requiresSysadminRole.length &gt; 0\" value=\"1\" /> Requires sysadmin role</label>\n    </div>\n                <label class=\"error\" *ngFor=\"let error of _formService.getErrors().requiresSysadminRole\">{{error}}</label>\n            </div>\n        </div>\n                    </ng-template>\n                                                \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label\" [innerHTML]=\"getLang('Enabled')\"></label>\n    \n            <div class=\"col-sm-10\">\n                                            <div class=\"checkbox\">                                        <label for=\"form_isEnabled\"><input type=\"checkbox\" id=\"form_isEnabled\" name=\"form[isEnabled]\" [(ngModel)]=\"_formService.getObject().isEnabled\" formControlName=\"isEnabled\" [class.error]=\"_formService.getErrors().isEnabled &amp;&amp; _formService.getErrors().isEnabled.length &gt; 0\" value=\"1\" checked=\"checked\" /> Is enabled</label>\n    </div>\n                <label class=\"error\" *ngFor=\"let error of _formService.getErrors().isEnabled\">{{error}}</label>\n            </div>\n        </div>\n                            </div>\n    </div>\n</div>\n<div class=\"modal-footer hide-on-empty\">\n        \n                    <div class=\"row\">\n            <div class=\"col-auto ml-auto\">\n                                            <button                                     class=\"btn btn-light\"\n                                    (click)=\"cancelAction($event)\"\n                                        id=\"form_cancel\"\n            name=\"form[cancel]\"\n            type=\"button\"><i class=\"fa fa-times\"></i>&nbsp;Cancel</button>\n                                                <button                                     class=\"btn btn-light\"\n                                    (click)=\"resetAction($event)\"\n                                        id=\"form_reset\"\n            name=\"form[reset]\"\n            type=\"button\"><i class=\"fa fa-ban\"></i>&nbsp;Reset</button>\n                                                <button                                     class=\"btn btn-primary\"\n                                    (click)=\"saveAction($event)\"\n                                        id=\"form_save\"\n            name=\"form[save]\"\n            type=\"button\"><i class=\"fa fa-check\"></i>&nbsp;Save</button>\n                                                <button                                     class=\"btn btn-primary\"\n                                    (click)=\"saveAndCloseAction($event)\"\n                                        id=\"form_saveAndClose\"\n            name=\"form[saveAndClose]\"\n            type=\"button\"><i class=\"fa fa-times\"></i>&nbsp;Save and Close</button>\n                                </div>\n        </div>\n    </div>    \n    <input type=\"hidden\" id=\"form__token\" name=\"form[_token]\" value=\"cEuu0f4SXmjfjYDFXIJO4B5Hkp8dRrRxqs-vEEkwqNE\" /></form>\n"

/***/ }),

/***/ "../../../../../src/Bck/AccountingBundle/Resources/public/document-types/index/ts/$$_lazy_route_resource lazy recursive":
/***/ (function(module, exports) {
...
webpackEmptyAsyncContext.id = "../../../../../src/Bck/AccountingBundle/Resources/public/document-types/index/ts/$$_lazy_route_resource lazy recursive";

/***/ }),

/***/ "../../../../../src/Bck/AccountingBundle/Resources/public/document-types/index/ts/src/main.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__client_document_type_index_ts_src_edit_ext_module__ = __webpack_require__("../../../../../src/Bck/AccountingBundle/Resources/public/client-document-type/index/ts/src/edit.ext-module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__supplier_document_type_index_ts_src_edit_ext_module__ = __webpack_require__("../../../../../src/Bck/AccountingBundle/Resources/public/supplier-document-type/index/ts/src/edit.ext-module.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var MainComponent = (function (_super) {
        ...
        switch (index) {
            case 0:
                providers.push({ provide: 'Popups', useValue: {
                        module: __WEBPACK_IMPORTED_MODULE_8__client_document_type_index_ts_src_edit_ext_module__["a" /* EditExtModule */],
            ...
            case 1:
                providers.push({ provide: 'Popups', useValue: {
                        module: __WEBPACK_IMPORTED_MODULE_9__supplier_document_type_index_ts_src_edit_ext_module__["a" /* EditExtModule */],
                        component: 'EditComponent',
                        providers: [{ provide: 'Provider', useValue: this._helperService.getFormProvider(data) }]
                    } });
                break;
    ...
    MainComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: '.js_app',
            template: __webpack_require__("../../../../../src/Bck/AccountingBundle/Resources/public/document-types/index/ts/templates/main.component.html")
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* Inject */])('Provider')),
        __param(3, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* Inject */])('HelperService')),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["r" /* ElementRef */],
...
/***/ "../../../../../src/Bck/AccountingBundle/Resources/public/document-types/index/ts/src/main.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__AppBundle_Resources_public_app_basics_default_ts_src_main_ext_module__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/app-basics/default/ts/src/main.ext-module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__AppBundle_Resources_public_app_basics_default_ts_src_main_component__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/app-basics/default/ts/src/main.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__AppBundle_Resources_public_ts_search_search_module__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/ts/search/search.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__main_component__ = __webpack_require__("../../../../../src/Bck/AccountingBundle/Resources/public/document-types/index/ts/src/main.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    MainModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormsModule */],
                __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* ReactiveFormsModule */],
                __WEBPACK_IMPORTED_MODULE_11__AppBundle_Resources_public_app_basics_default_ts_src_main_ext_module__["a" /* MainExtModule */],
                __WEBPACK_IMPORTED_MODULE_13__AppBundle_Resources_public_ts_search_search_module__["a" /* SearchModule */],
            ...
            providers: [
                ...
                { provide: 'Provider', useValue: __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_ts_helper__["a" /* Helper */].getBoxProvider(_app.conf) },
            ],
            bootstrap: [__WEBPACK_IMPORTED_MODULE_12__AppBundle_Resources_public_app_basics_default_ts_src_main_component__["a" /* MainComponent */], __WEBPACK_IMPORTED_MODULE_14__main_component__["a" /* MainComponent */]]
        })
    ], MainModule);
    return MainModule;
}());
...
/***/ "../../../../../src/Bck/AccountingBundle/Resources/public/document-types/index/ts/src/main.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__main_module__ = __webpack_require__("../../../../../src/Bck/AccountingBundle/Resources/public/document-types/index/ts/src/main.module.ts");
...
/***/ "../../../../../src/Bck/AccountingBundle/Resources/public/document-types/index/ts/templates/main.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/Bck/AccountingBundle/Resources/public/supplier-document-type/index/ts/src/edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var EditComponent = (function (_super) {
    ...
    EditComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: '#js_edit',
            template: __webpack_require__("../../../../../src/Bck/AccountingBundle/Resources/public/supplier-document-type/index/ts/templates/edit.component.html")
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* Inject */])('Provider')),
        __param(4, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* Inject */])('DataService')),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["r" /* ElementRef */],
...
/***/ "../../../../../src/Bck/AccountingBundle/Resources/public/supplier-document-type/index/ts/src/edit.ext-module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("../../../forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__edit_component__ = __webpack_require__("../../../../../src/Bck/AccountingBundle/Resources/public/supplier-document-type/index/ts/src/edit.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "../../../../../src/Bck/AccountingBundle/Resources/public/supplier-document-type/index/ts/templates/edit.component.html":
/***/ (function(module, exports) {
...
module.exports = __webpack_require__("../../../../../src/Bck/AccountingBundle/Resources/public/document-types/index/ts/src/main.ts");
