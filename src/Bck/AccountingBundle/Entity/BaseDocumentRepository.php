...
abstract class BaseDocumentRepository extends BaseEntityRepository
{
    ...
    static function getMetadata()
    {
        ...
        return self::processMetadata(array(
            ...
            'remainSettlement' => array('label' => 'Pendent Value', 'type' => 'monetary', 'acl' => 'read', 'form' => array('type' => 'none')),
    ...
    public function getForSettlement($options = array(), $targetDocumentObj = null)
    {
        ...
        $qb->leftJoin('Bck\AccountingBundle\Entity\\' . $entityContextUC . 'DocumentReceiptSettlement',
    ...
    public function getDocumentsIdByBooking($bookingId, $repositoryService)
    {
        ...
        // INVOICE
        $invoiceDocuments = $repositoryService->setEntityRepository('BckAccountingBundle:'.$entityContextUC."DocumentInvoiceDetail")
        ...
        if (count($invoiceDocuments) > 0) {
            // RECEIPT SETTLEMENT
            $receiptDocuments = $repositoryService->setEntityRepository('BckAccountingBundle:'.$entityContextUC."DocumentReceiptSettlement")
    ...
    public function getRectificationDocuments($documentObj)
    {
        ...
        $qb->innerJoin('Bck\AccountingBundle\Entity\\'.$entityContextUC.'DocumentInvoiceDetail',
        ...
        $qb->innerJoin('Bck\AccountingBundle\Entity\\'.$entityContextUC.'DocumentInvoiceRectification',
