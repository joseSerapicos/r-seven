        ...
        $localMetadata = self::$metadata = self::processMetadata(array(
            ...
            'clientDocumentInvoiceDetailObj' => array('label' => '', 'type' => 'object',
                'acl' => 'read', 'typeDetail' => array(
                    'table' => 'clientDocumentInvoiceDetail', 'field' => 'id', 'bundlePrefix' => 'bck', 'bundle' => 'accounting', 'type' => 'none',
            ...
            'rectificationClientDocumentObj' => array('table' => 'rectificationClientDocumentInvoiceDetail', 'field' => 'clientDocumentObj',
                ...
                'typeDetail' => array(
                    'table' => 'clientDocument', 'tableAlias' => 'rectificationClientDocument', 'bundlePrefix' => 'bck', 'bundle' => 'accounting', 'type' => 'none'),
