...
/**
 * @ORM\MappedSuperclass(repositoryClass="Bck\AccountingBundle\Entity\BaseDocumentInvoiceDetailRepository")
...
abstract class BaseDocumentInvoiceDetail extends BaseEntity
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Bck\BookingBundle\Entity\BookingServicePrice")
     ...
     * @param \Bck\BookingBundle\Entity\BookingServicePrice $bookingServicePriceObj
     * @return $this
     */
    public function setBookingServicePriceObj(\Bck\BookingBundle\Entity\BookingServicePrice $bookingServicePriceObj = null)
    {
