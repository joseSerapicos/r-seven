...
class PlaceController extends BaseEntityController
{
    ...
    public function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__common__place__get'
            ),
            'edit' => array(
                'name' => '_bck__common__place__edit'
            ),
            'delete' => array(
                'name' => '_bck__common__place__delete'
            ),
            'choices' => array(
                'name' => '_bck__common__place__choices'
            )
        );
    ...
    /**
     * @Route("/bck/common/place",
     *     name="_bck__common__place__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/bck/common/place/edit/{id}",
     *     name="_bck__common__place__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/common/place/delete/{id}",
     *     name="_bck__common__place__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/common/place/conf/{id}",
     *     name="_bck__common__place__conf",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/common/place/choices",
     *     name="_bck__common__place__choices"
     * )
     *
