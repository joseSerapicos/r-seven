...
use AppBundle\Entity\BaseCostWithVatRepository;
use AppBundle\Service\HelperService;

/**
 * ServiceFixedCostRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class ServiceFixedCostRepository extends BaseCostWithVatRepository
{
     ...
     * @return mixed
     */
    public function getByDate($serviceObj, $date, $options = array())
    {
