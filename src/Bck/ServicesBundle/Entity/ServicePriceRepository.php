...
use AppBundle\Entity\BasePriceRepository;
 ...
 */
class ServicePriceRepository extends BasePriceRepository
{
     ...
     * @return mixed
     */
    public function getCurrentPriceByDate($serviceObj, $date, $options = array(), $priceTargetServiceObj = null)
    {
