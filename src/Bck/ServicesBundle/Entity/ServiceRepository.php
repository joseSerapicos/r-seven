...
class ServiceRepository extends BaseEntityRepository
{
    ...
    static function getMetadata()
    {
        ...
        return self::$metadata = self::processMetadata(array(
            ...
            'thumbnail' => array('label' => 'Thumbnail', 'type' => 'img', 'acl' => 'read', 'isDefault' => true),
            ...
            'icon' => array('table' => 'app_icon', 'field' => 'icon', 'label' => 'Name', 'type' => 'icon',
                'acl' => 'read', 'dependency' => 'appIconObj', 'isDefault' => true,
                'typeDetail' => array('fieldInView' => 'name'),
            ...
            'isEnabledAvailability' => array('label' => 'Enable Availability', 'type' => 'boolean', 'acl' => 'edit', 'isDefault' => true),
            'isEnabledAllot' => array('label' => 'Enable Allot', 'type' => 'boolean', 'acl' => 'edit', 'isDefault' => true),
            'isEnabledPrice' => array('label' => 'Enable Price', 'type' => 'boolean', 'acl' => 'edit', 'isDefault' => true),
    ...
    public function getChoicesForBookingService($hasExecute = true, $executeMethod = 'getResult', $options = array())
    {
        ...
        $qb->innerJoin('Bck\ServicesBundle\Entity\RegularService',
            'regularService',
            'WITH',
    ...
    public function getChoicesForServicePrice($hasExecute = true, $executeMethod = 'getResult', $options = array())
    {
        ...
        // Filer by regular services
        $qb->innerJoin('Bck\ServicesBundle\Entity\PackageService',
            'packageService',
            'WITH',
