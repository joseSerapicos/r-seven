 ...
 * @package BckServicesBundle\Controller
 */
abstract class BaseServiceController extends BaseEntityController
{
    ...
    public function getVatCodePercentageAction(Request $request, $id)
    {
        ...
        $serviceObj = $this->getRepositoryService('Service', 'ServicesBundle', 'Bck')
    ...
    protected function initForBookingService(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => ('_bck__services__'.$this->getServiceContext().'_service__get_for_booking_service')
            )
        );
