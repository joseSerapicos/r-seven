...
class ServiceFileController extends BaseEntityChildController
{
    ...
    public function init(Request $request, $parents = null)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__services__service_file__get'
            ),
            'edit' => array(
                'name' => '_bck__services__service_file__edit',
            ),
            'delete' => array(
                'name' => '_bck__services__service_file__delete',
            )
        );
        ...
        $this->localConf['formTypeClass'] = ('BckServicesBundle\Form\ServiceFileSubmitFormType');
    ...
    /**
     * @Route("/bck/services/service-file/get/{service}/{id}",
     *     name="_bck__services__service_file__get",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/services/service-file/edit/{service}/{id}",
     *     name="_bck__services__service_file__edit",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/services/service-file/edit-flat-form/{service}",
     *     name="_bck__services__service_file__edit_flat_form"
     * )
     *
    ...
    public function editFlatFormAction(Request $request, $service)
    {
        ...
        // Set form attributes
        $this->localConf['formTypeClass'] = ('BckServicesBundle\Form\ServiceFileSubmitFlatFormType');
    ...
    /**
     * @Route("/bck/services/service-file/delete/{service}/{id}",
     *     name="_bck__services__service_file__delete",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/services/service-file/data/{service}",
     *     name="_bck__services__service_file__data"
     * )
     *
     * Overrides parent method
     * @param Request $request
