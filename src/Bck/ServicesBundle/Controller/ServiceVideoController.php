...
class ServiceVideoController extends BaseEntityChildController
{
    ...
    public function init(Request $request, $parents = null)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__services__service_video__get'
            ),
            'add' => array(
                'name' => '_bck__services__service_video__add',
            ),
            'delete' => array(
                'name' => '_bck__services__service_video__delete',
            )
        );
    ...
    /**
     * @Route("/bck/services/service-video/get/{service}/{id}",
     *     name="_bck__services__service_video__get",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/services/service-video/add/{service}/{source}",
     *     name="_bck__services__service_video__add",
     *     defaults={
     *         "source" = null
     *     }
    ...
    public function addLocalChildAction(Request $request, $service, $source)
    {
        ...
        if ($source != 'file') {
            ...
            if(empty($_FILES)) {
                $this->localConf['formTypeClass'] = 'Bck\ServicesBundle\Form\ServiceVideoRenderFileSourceFormType';
            } else {
                $this->localConf['formTypeClass'] = 'Bck\ServicesBundle\Form\ServiceVideoSubmitFileSourceFormType';
            }
        }
    ...
    /**
     * @Route("/bck/services/service-video/delete/{service}/{id}",
     *     name="_bck__services__service_video__delete",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/services/service-video/data/{service}",
     *     name="_bck__services__service_video__data"
     * )
     *
     * Overrides parent method
     * @param Request $request
