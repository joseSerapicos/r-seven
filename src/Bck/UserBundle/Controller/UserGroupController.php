...
class UserGroupController extends BaseEntityController
{
    ...
    public function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__user__user_group__get'
            ),
            'edit' => array(
                'name' => '_bck__user__user_group__edit'
            ),
            'delete' => array(
                'name' => '_bck__user__user_group__delete'
            ),
            'detail' => array(
                'name' => '_bck__user__user_group__detail'
            ),
        );
    ...
    /**
     * @Route("/bck/user/user-group",
     *     name="_bck__user__user_group__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/bck/user/user-group/detail/{id}",
     *     name="_bck__user__user_group__detail",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/user/user-group/get/{id}",
     *     name="_bck__user__user_group__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/user/user-group/edit/{id}",
     *     name="_bck__user__user_group__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/user/user-group/delete/{id}",
     *     name="_bck__user__user_group__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/user/user-group/detail-tabs",
     *     name="_bck__user__user_group__detail_tabs")
     *
    ...
    protected function newObject()
    {
        ...
        $userObj = $this->getRepositoryService('User', 'AdminBundle', 'Bck')
            ->execute(
                'findOneById',
                array(
                    $loggedUserId
