 ...
 */
class UserGroupUserRepository extends BaseEntityRepository
{
    ...
    static function getMetadata()
    {
        ...
        return self::$metadata = self::processMetadata(array(
            ...
            'userGroupObj' => array('label' => 'User Group', 'type' => 'object', 'acl' => 'read',
                'typeDetail' => array('table' => 'userGroup', 'bundlePrefix' => 'bck', 'bundle' => 'user', 'type' => 'none')),
            'userObj' => array('label' => 'User', 'type' => 'object', 'acl' => 'edit',
                'typeDetail' => array('table' => 'user', 'bundlePrefix' => '', 'bundle' => 'login', 'type' => 'number', 'fieldInView' => 'name'),
