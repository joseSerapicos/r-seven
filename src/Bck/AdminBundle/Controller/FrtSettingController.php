...
class FrtSettingController extends BaseEntityController
{
    /**
    ...
    public function init(Request $request)
    {
        ...
        $this->templateConf['label'] = 'Front-Office';
        $this->templateConf['selectedMenu']['route'] = '_bck__admin__settings__index';

        // Route
        $this->templateConf['route'] = array(
            'edit' => array(
                'name' => '_bck__admin__frt_setting__edit',
            )
        );
    ...
    /**
     * @Route("/bck/admin/frt-setting/edit/{id}",
     *     name="_bck__admin__frt_setting__edit",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/admin/frt-setting/conf/{id}",
     *     name="_bck__admin__frt_setting__conf",
     *     defaults={"id" = null}
     * )
     *
     * Overrides parent method
