...
use Bck\AdminBundle\Entity\Entity;
...
class UserGroupAclUserController extends BaseEntityChildController
{
    ...
    public function init(Request $request, $parents = null)
    {
        ...
        $this->parentConf = array(
            'userGroupAcl' => array('route' => '_bck__admin__user_group_acl__index')
        );

        // Route
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__admin__user_group_acl_bck__user__get'
            ),
            'edit' => array(
                'name' => '_bck__admin__user_group_acl_bck__user__edit',
            ),
            'delete' => array(
                'name' => '_bck__admin__user_group_acl_bck__user__delete',
            )
        );
        ...
        // Variables
        $this->localConf['templates']['edit'] = 'BckAdminBundle:UserGroupAclUser:form.html.twig';
    ...
    /**
     * @Route("/bck/admin/user-group-acl-user/get/{userGroupAcl}/{id}",
     *     name="_bck__admin__user_group_acl_bck__user__get",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/admin/user-group-acl-user/edit/{userGroupAcl}/{id}",
     *     name="_bck__admin__user_group_acl_bck__user__edit",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/admin/user-group-acl-user/delete/{userGroupAcl}/{id}",
     *     name="_bck__admin__user_group_acl_bck__user__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/admin/user-group-acl-user/data/{userGroupAcl}",
     *     name="_bck__admin__user_group_acl_bck__user__data"
     * )
     *
     * Overrides parent method
     * @param Request $request
    ...
    /**
     * @Route("/bck/admin/user-group-acl-user/conf/{userGroupAcl}/{id}",
     *     name="_bck__admin__user_group_acl_bck__user__conf",
     *     defaults={"id" = null}
     * )
     *
     * Overrides parent method
     ...
     * @return mixed
     */
    public function confLocalChildAction(Request $request, $userGroupAcl, $id = null)
    {
        return parent::confChildAction($request, array($userGroupAcl), $id);
    }
