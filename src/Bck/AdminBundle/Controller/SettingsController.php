...
class SettingsController extends BaseController
{
    ...
    /**
     * @Route("/bck/admin/settings/index",
     *     name="_bck__admin__settings__index"
     * )
     *
     * Index action.
     * @param Request $request
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('BckAdminBundle:Settings:index.html.twig', $this->getResponse());
    }

    /**
     * @Route("/bck/admin/settings/main-menus",
     *     name="_bck__admin__settings__main_menus"
     * )
     *
    ...
    /**
     * @Route("/bck/admin/settings/entities-menus",
     *     name="_bck__admin__settings__entities_menus"
     * )
     *
    ...
    /**
     * @Route("/bck/admin/settings/document-types-menus",
     *     name="_bck__admin__settings__document_types_menus"
     * )
     *
     * Action to get the menus of entities
     * @return mixed
