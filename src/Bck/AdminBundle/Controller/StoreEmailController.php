...
use Bck\AdminBundle\Entity\StoreEmail;
...
class StoreEmailController extends BaseEntityChildController
{
    ...
    public function init(Request $request, $parents = null)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__admin__store_email__get'
            ),
            'edit' => array(
                'name' => '_bck__admin__store_email__edit',
            ),
            'delete' => array(
                'name' => '_bck__admin__store_email__delete',
            )
        );
    ...
    /**
     * @Route("/bck/admin/store-email/get/{store}/{id}",
     *     name="_bck__admin__store_email__get",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/admin/store-email/edit/{store}/{id}",
     *     name="_bck__admin__store_email__edit",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/admin/store-email/delete/{store}/{id}",
     *     name="_bck__admin__store_email__delete",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/admin/store-email/data/{store}"
     * )
     *
     * Overrides parent method
     * @param Request $request
    ...
    /**
     * @Route("/bck/admin/store-email/conf/{store}/{id}",
     *     name="_bck__admin__store_email__conf",
     *     defaults={"id" = null}
     * )
     *
     * Overrides parent method
