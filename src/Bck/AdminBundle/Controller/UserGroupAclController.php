...
class UserGroupAclController extends BaseEntityController
{
    ...
    public function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__admin__user_group_acl__get'
            ),
            'edit' => array(
                'name' => '_bck__admin__user_group_acl__edit'
            ),
            'delete' => array(
                'name' => '_bck__admin__user_group_acl__delete'
            ),
            'detail' => array(
                'name' => '_bck__admin__user_group_acl__detail'
            ),
        );
    ...
    /**
     * @Route("/bck/admin/user-group-acl",
     *     name="_bck__admin__user_group_acl__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/bck/admin/user-group-acl/detail/{id}",
     *     name="_bck__admin__user_group_acl__detail",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/admin/user-group-acl/get/{id}",
     *     name="_bck__admin__user_group_acl__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/admin/user-group-acl/edit/{id}",
     *     name="_bck__admin__user_group_acl__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/admin/user-group-acl/delete/{id}",
     *     name="_bck__admin__user_group_acl__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/admin/user-group-acl/detail-tabs",
     *     name="_bck__admin__user_group_acl__detail_tabs")
     *
    ...
    protected function getObjectsBySearch($options = null) {
        ...
        $objects = $this->get('bck.admin.service.repository')
            ->setEntityRepository('BckAdminBundle:UserGroupAcl')
            ->execute(
    ...
    protected function saveObject(&$object, $hasFlush = true, $addToResponse = false)
    {
        ...
        if (!$isAdmin) {
            ...
            $session = $this->get('session');
            $loggedUserId = $session->get('_app.user')['id'];
            $userObj = $this->get('bck.admin.service.repository')
                ->setEntityRepository('BckAdminBundle:User')
                ->execute(
                    'findOneById',
                    array(
                        $loggedUserId
