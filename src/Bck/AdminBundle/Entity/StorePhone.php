...
/**
 * @ORM\Entity(repositoryClass="Bck\AdminBundle\Entity\StorePhoneRepository")
...
class StorePhone extends BasePhone {
    ...
    /**
     * @ORM\Column(name="forDocuments", type="boolean", nullable=true, unique=false, options={"default":0, "comment":"Determines if the phone is added to documents"})
     */
