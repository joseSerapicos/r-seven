<?php
// src/BckAdminBundle/Entity/Module.php
...
/**
 * @ORM\Entity(repositoryClass="Bck\AdminBundle\Entity\ModuleRepository")
 * @ORM\Table(name="module")
 */
class Module extends BaseEntity {
    /**
     * @ORM\ManyToOne(targetEntity="Bck\SysadminBundle\Entity\Module")
