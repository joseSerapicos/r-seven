...
/**
 * @ORM\Entity(repositoryClass="Bck\AdminBundle\Entity\StoreLinkRepository")
...
class StoreLink extends BaseLink {
    ...
    /**
     * @ORM\Column(name="forFrontOffice", type="boolean", nullable=true, unique=false, options={"default":0, "comment":"Determines if the phone is added to front-office"})
     */
