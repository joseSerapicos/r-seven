...
class LanguageController extends BaseEntityController
{
    ...
    public function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__sysadmin__language__get'
            ),
            'edit' => array(
                'name' => '_bck__sysadmin__language__edit'
            ),
            'delete' => array(
                'name' => '_bck__sysadmin__language__delete'
            ),
            'choices' => array(
                'name' => '_bck__sysadmin__language__choices'
            )
        );
    ...
    /**
     * @Route("/bck/sysadmin/language",
     *     name="_bck__sysadmin__language__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/bck/sysadmin/language/get/{id}",
     *     name="_bck__sysadmin__language__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/language/edit/{id}",
     *     name="_bck__sysadmin__language__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/language/delete/{id}",
     *     name="_bck__sysadmin__language__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/language/conf/{id}",
     *     name="_bck__sysadmin__language__conf",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/language/choices",
     *     name="_bck__sysadmin__language__choices"
     * )
     *
