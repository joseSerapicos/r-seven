...
class ProvinceController extends BaseEntityController
{
    /**
    ...
    public function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__sysadmin__province__get'
            ),
            'edit' => array(
                'name' => '_bck__sysadmin__province__edit'
            ),
            'delete' => array(
                'name' => '_bck__sysadmin__province__delete'
            ),
            'choices' => array(
                'name' => '_bck__sysadmin__province__choices'
            )
        );
    ...
    /**
     * @Route("/bck/sysadmin/province",
     *     name="_bck__sysadmin__province__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/bck/sysadmin/province/get/{id}",
     *     name="_bck__sysadmin__province__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/province/edit/{id}",
     *     name="_bck__sysadmin__province__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/province/delete/{id}",
     *     name="_bck__sysadmin__province__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/province/conf/{id}",
     *     name="_bck__sysadmin__province__conf",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/province/choices",
     *     name="_bck__sysadmin__province__choices"
     * )
     *
