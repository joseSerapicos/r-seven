...
class CountryController extends BaseEntityController
{
    ...
    public function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__sysadmin__country__get'
            ),
            'edit' => array(
                'name' => '_bck__sysadmin__country__edit'
            ),
            'delete' => array(
                'name' => '_bck__sysadmin__country__delete'
            ),
            'choices' => array(
                'name' => '_bck__sysadmin__country__choices'
            )
        );
    ...
    /**
     * @Route("/bck/sysadmin/country",
     *     name="_bck__sysadmin__country__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/bck/sysadmin/country/get/{id}",
     *     name="_bck__sysadmin__country__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/country/edit/{id}",
     *     name="_bck__sysadmin__country__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/country/delete/{id}",
     *     name="_bck__sysadmin__country__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/country/conf/{id}",
     *     name="_bck__sysadmin__country__conf",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/country/choices",
     *     name="_bck__sysadmin__country__choices"
     * )
     *
