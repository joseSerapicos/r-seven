...
class CurrencyController extends BaseEntityController
{
    /**
    ...
    public function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_bck__sysadmin__currency__get'
            ),
            'edit' => array(
                'name' => '_bck__sysadmin__currency__edit'
            ),
            'delete' => array(
                'name' => '_bck__sysadmin__currency__delete'
            ),
            'choices' => array(
                'name' => '_bck__sysadmin__currency__choices'
            )
        );
    ...
    /**
     * @Route("/bck/sysadmin/currency",
     *     name="_bck__sysadmin__currency__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/bck/sysadmin/currency/get/{id}",
     *     name="_bck__sysadmin__currency__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/currency/edit/{id}",
     *     name="_bck__sysadmin__currency__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/currency/delete/{id}",
     *     name="_bck__sysadmin__currency__delete",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/currency/conf/{id}",
     *     name="_bck__sysadmin__currency__conf",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/bck/sysadmin/currency/choices",
     *     name="_bck__sysadmin__currency__choices"
     * )
     *
