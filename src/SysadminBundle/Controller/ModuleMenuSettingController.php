...
{
    /**
     * @Route("/sysadmin/module-menu-setting",
     *     name="_sysadmin__module_menu_setting__index"
     * )
     *
    ...
    public function indexAction(Request $request) {
        ...
        if($form->isSubmitted()) {
            if($this->save($obj, $form)) {
                return $this->render('SysadminBundle:Default:module_menu.html.twig', array('status' => "success", 'form' => $form->createView()));
            }
            else {
                return $this->render('SysadminBundle:Default:module_menu.html.twig', array('status' => "error", 'form' => $form->createView()));
            }
        }

        return $this->render('SysadminBundle:Default:module_menu.html.twig', array('status' => "create", 'form' => $form->createView()));
    }
