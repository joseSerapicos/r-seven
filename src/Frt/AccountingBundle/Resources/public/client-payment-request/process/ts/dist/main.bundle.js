...
/***/ "../../../../../src/AppBundle/Resources/public/entity-detail/ts/src/entity-detail-preview.ext-module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EntityDetailPreviewExtModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("../../../forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ts_expander_expander_module__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/ts/expander/expander.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__entity_detail_preview_component__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/entity-detail/ts/src/entity-detail-preview.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EntityDetailPreviewExtModule = (function () {
    function EntityDetailPreviewExtModule() {
    }
    EntityDetailPreviewExtModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["H" /* NgModule */])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_common__["a" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_3__ts_expander_expander_module__["a" /* ExpanderModule */]],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__entity_detail_preview_component__["a" /* EntityDetailPreviewComponent */]
            ],
            exports: [__WEBPACK_IMPORTED_MODULE_4__entity_detail_preview_component__["a" /* EntityDetailPreviewComponent */]]
        })
    ], EntityDetailPreviewExtModule);
    return EntityDetailPreviewExtModule;
}());
...
/***/ "../../../../../src/AppBundle/Resources/public/entity-detail/ts/src/entity-detail.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ts_base_base_extension_component__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/ts/base/base.extension-component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ts_actions_actions_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/ts/actions/actions.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__tasks_loader_manager_ts_tasks_loader_manager_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/tasks-loader-manager/ts/tasks-loader-manager.service.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
...
var EntityDetailComponent = (function (_super) {
    __extends(EntityDetailComponent, _super);
    function EntityDetailComponent(_viewContainerRef, renderer, provider, _popup, _dataService, _tasksLoaderManagerService, _actionsService, _modalService, _helperService, // Used in template
        _injector) {
        var _this = _super.call(this) || this;
        _this._viewContainerRef = _viewContainerRef;
        _this._popup = _popup;
        _this._dataService = _dataService;
        _this._tasksLoaderManagerService = _tasksLoaderManagerService;
        _this._actionsService = _actionsService;
        _this._modalService = _modalService;
        _this._helperService = _helperService;
        _this._injector = _injector;
        _this.hasInsertInfo = true;
        _this.initBaseExtensionComponent(_viewContainerRef.element, renderer, provider);
        _this._modalService.init(_this._viewContainerRef);
        // Get fields from DataService
        _this._fields = (_this._dataService.getProviderAttr('fields') || {});
        _this._onObjectChangeSubscription = _this._dataService.getOnObjectChangeEmitter()
            .subscribe(function (object) { return _this.refresh(); });
        if (_this._provider['hasInsertInfo'] !== undefined) {
            _this.hasInsertInfo = _this._provider['hasInsertInfo'];
        }
        _this.refresh();
        return _this;
    }
     ...
     * @param action (can be provided by $event or directly in the call)
     */
    EntityDetailComponent.prototype.triggerAction = function ($event, action) {
        if (action === void 0) { action = null; }
        if ($event) {
            $event.preventDefault();
        }
     ...
     * @param $event
     */
    EntityDetailComponent.prototype.editAction = function ($event) {
        if ($event === void 0) { $event = null; }
        if ($event) {
            $event.preventDefault();
        }
        ...
        // Open popup
        this._modalService.popup(this._popup, this._injector).then(function (data) { return; }, function (errors) { console.log(errors); return; });
    };
    /**
     * Refresh
     */
    EntityDetailComponent.prototype.refresh = function () {
    ...
    EntityDetailComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            template: __webpack_require__("../../../../../src/AppBundle/Resources/public/entity-detail/ts/templates/entity-detail.component.html")
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('EntityDetailProvider')),
        __param(3, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('Popup')),
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewContainerRef */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Renderer */], Object, Object, Object, __WEBPACK_IMPORTED_MODULE_4__tasks_loader_manager_ts_tasks_loader_manager_service__["a" /* TasksLoaderManagerService */],
            __WEBPACK_IMPORTED_MODULE_3__ts_actions_actions_service__["a" /* ActionsService */],
            __WEBPACK_IMPORTED_MODULE_1__modal_ts_modal_service__["b" /* ModalService */], Object, __WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injector */]])
    ], EntityDetailComponent);
    return EntityDetailComponent;
}(__WEBPACK_IMPORTED_MODULE_2__ts_base_base_extension_component__["a" /* BaseExtensionComponent */]));



/***/ }),

/***/ "../../../../../src/AppBundle/Resources/public/entity-detail/ts/src/entity-detail.ext-module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EntityDetailExtModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("../../../forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ts_expander_expander_module__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/ts/expander/expander.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__entity_detail_component__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/entity-detail/ts/src/entity-detail.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EntityDetailExtModule = (function () {
    function EntityDetailExtModule() {
    }
    EntityDetailExtModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["H" /* NgModule */])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_common__["a" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_3__ts_expander_expander_module__["a" /* ExpanderModule */]],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__entity_detail_component__["a" /* EntityDetailComponent */]
            ],
            exports: [__WEBPACK_IMPORTED_MODULE_4__entity_detail_component__["a" /* EntityDetailComponent */]]
        })
    ], EntityDetailExtModule);
    return EntityDetailExtModule;
}());
...
/***/ "../../../../../src/AppBundle/Resources/public/wizard/ts/src/wizard-popup.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WizardPopupComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wizard_manager_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/wizard/ts/src/wizard-manager.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wizard_popup_ext_component__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/wizard/ts/src/wizard-popup.ext-component.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var WizardPopupComponent = (function (_super) {
    ...
    function WizardPopupComponent(elementRef, renderer, provider, wizardManagerService) {
        var _this = _super.call(this) || this;
    ...
    WizardPopupComponent = __decorate([
        ...
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('Provider')),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Renderer */], Object, __WEBPACK_IMPORTED_MODULE_1__wizard_manager_service__["a" /* WizardManagerService */]])
    ], WizardPopupComponent);
    return WizardPopupComponent;
}(__WEBPACK_IMPORTED_MODULE_2__wizard_popup_ext_component__["a" /* WizardPopupExtComponent */]));
...
/***/ "../../../../../src/Bck/EntitiesBundle/Resources/public/entity-contacts/index/ts/src/edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var EditComponent = (function (_super) {
     ...
     * @param value
     */
    EditComponent.prototype.onEntityAddressChange = function (value) {
        console.log(value);
    };
    /**
     ...
     * @param value
     */
    EditComponent.prototype.onEntityPhoneChange = function (value) {
        console.log(value);
    };
    /**
     * On entity address change event
     * @param value
     */
    EditComponent.prototype.onEntityEmailChange = function (value) {
        console.log(value);
    };
    EditComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: '#js_edit',
            template: __webpack_require__("../../../../../src/Bck/EntitiesBundle/Resources/public/entity-contacts/index/ts/templates/edit.component.html")
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('Provider')),
        __param(4, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('DataService')),
        __param(5, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('HelperService')),
...
/***/ "../../../../../src/Bck/EntitiesBundle/Resources/public/entity-contacts/index/ts/src/edit.ext-module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__edit_component__ = __webpack_require__("../../../../../src/Bck/EntitiesBundle/Resources/public/entity-contacts/index/ts/src/edit.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "../../../../../src/Bck/EntitiesBundle/Resources/public/entity-contacts/index/ts/templates/edit.component.html":
/***/ (function(module, exports) {

module.exports = "\n\n\n    <form name=\"form\" method=\"post\" (ngSubmit)=\"saveAction($event)\" [formGroup]=\"_formService.getForm()\" class=\"form-horizontal\">\n\n    \n            \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label required\" for=\"form_entityAddressObj\">Address</label>\n    \n            <div class=\"col-sm-10\">\n                                            <input [(ngModel)]=\"_formService.getObject().entityAddressObj\"\n           formControlName = entityAddressObj\n           name=\"form[entityAddressObj]\"\n           required=\"required\"           type=\"hidden\">\n    <js_autoComplete [field]=\"'entityAddressObj'\"\n                     [hasSelfReference]=\"_dataService.getFieldChoicesAttr('entityAddressObj', 'hasSelfReference')\"\n                                              (onChange)=\"'onEntityAddressChange($event)'\"[placeholder]=\"'Address'\"                         ></js_autoComplete>\n                    <label class=\"error\" *ngFor=\"let error of _formService.getErrors().entityAddressObj\">{{error}}</label>\n            </div>\n        </div>\n                \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label required\" for=\"form_entityPhoneObj\">Phone</label>\n    \n            <div class=\"col-sm-10\">\n                                            <input [(ngModel)]=\"_formService.getObject().entityPhoneObj\"\n           formControlName = entityPhoneObj\n           name=\"form[entityPhoneObj]\"\n           required=\"required\"           type=\"hidden\">\n    <js_autoComplete [field]=\"'entityPhoneObj'\"\n                     [hasSelfReference]=\"_dataService.getFieldChoicesAttr('entityPhoneObj', 'hasSelfReference')\"\n                                              (onChange)=\"'onEntityPhoneChange($event)'\"[placeholder]=\"'Phone'\"                         ></js_autoComplete>\n                    <label class=\"error\" *ngFor=\"let error of _formService.getErrors().entityPhoneObj\">{{error}}</label>\n            </div>\n        </div>\n                \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label required\" for=\"form_entityEmailObj\">Email</label>\n    \n            <div class=\"col-sm-10\">\n                                            <input [(ngModel)]=\"_formService.getObject().entityEmailObj\"\n           formControlName = entityEmailObj\n           name=\"form[entityEmailObj]\"\n           required=\"required\"           type=\"hidden\">\n    <js_autoComplete [field]=\"'entityEmailObj'\"\n                     [hasSelfReference]=\"_dataService.getFieldChoicesAttr('entityEmailObj', 'hasSelfReference')\"\n                                              (onChange)=\"'onEntityEmailChange($event)'\"[placeholder]=\"'Email'\"                         ></js_autoComplete>\n                    <label class=\"error\" *ngFor=\"let error of _formService.getErrors().entityEmailObj\">{{error}}</label>\n            </div>\n        </div>\n        \n\n    \n\n    <input type=\"hidden\" id=\"form__token\" name=\"form[_token]\" value=\"_yE5tsEMUvpURfWTW8W85WZk33Z7lJCsksOmBZnQ86Y\" /></form>\n\n"
...
/***/ "../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/$$_lazy_route_resource lazy recursive":
/***/ (function(module, exports) {
...
webpackEmptyAsyncContext.id = "../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/$$_lazy_route_resource lazy recursive";

/***/ }),

/***/ "../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/src/main.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AppBundle_Resources_public_wizard_ts_src_wizard_popup_component__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/wizard/ts/src/wizard-popup.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_wizard_ts_src_wizard_manager_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/wizard/ts/src/wizard-manager.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__AppBundle_Resources_public_form_ts_form_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/form/ts/form.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Bck_EntitiesBundle_Resources_public_entity_contacts_index_ts_src_edit_ext_module__ = __webpack_require__("../../../../../src/Bck/EntitiesBundle/Resources/public/entity-contacts/index/ts/src/edit.ext-module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Bck_EntitiesBundle_Resources_public_entity_detail_ts_src_entity_address_edit_ext_module__ = __webpack_require__("../../../../../src/Bck/EntitiesBundle/Resources/public/entity/detail/ts/src/entity-address-edit.ext-module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Bck_EntitiesBundle_Resources_public_entity_detail_ts_src_entity_phone_edit_ext_module__ = __webpack_require__("../../../../../src/Bck/EntitiesBundle/Resources/public/entity/detail/ts/src/entity-phone-edit.ext-module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Bck_EntitiesBundle_Resources_public_entity_detail_ts_src_entity_email_edit_ext_module__ = __webpack_require__("../../../../../src/Bck/EntitiesBundle/Resources/public/entity/detail/ts/src/entity-email-edit.ext-module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__step2_ext_module__ = __webpack_require__("../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/src/step2.ext-module.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var MainComponent = (function (_super) {
    ...
    function MainComponent(elementRef, renderer, provider, wizardManagerService, _postService, _dataService, _injector, _dynamicComponentLoaderService, _helperService) {
        var _this = 
        // Call parent
     ...
     * @returns {Promise<boolean>}
     */
    MainComponent.prototype.submitNav = function (index) {
    ...
    MainComponent.prototype.getNavData = function (index) {
        switch (index) {
            case 0:
                return {
                    module: __WEBPACK_IMPORTED_MODULE_7__Bck_EntitiesBundle_Resources_public_entity_contacts_index_ts_src_edit_ext_module__["a" /* EditExtModule */],
                    component: 'EditComponent',
                    dataProvider: _app.dependencies['entityContacts']
                };
            case 1:
                return {
                    module: __WEBPACK_IMPORTED_MODULE_11__step2_ext_module__["a" /* Step2ExtModule */],
    ...
    MainComponent.prototype.getNavProviders = function (index, data) {
        ...
        switch (index) {
            case 0:
                var that = this, entityId = this._dataService.getObject()['entityObj'], autoCompleteProviders = {
                    entityAddressObj: {
                        urlConf: (this._helperService.getAppVar('route') + 'entities/entity-address/conf/' + entityId),
                        control: 'edit',
                        popups: {
                            module: __WEBPACK_IMPORTED_MODULE_8__Bck_EntitiesBundle_Resources_public_entity_detail_ts_src_entity_address_edit_ext_module__["a" /* EntityAddressEditExtModule */],
                            component: 'EntityAddressEditComponent',
                            providers: [
                                { provide: 'Provider', useValue: this._helperService.getFormProvider({ label: 'Address' }) },
                                __WEBPACK_IMPORTED_MODULE_6__AppBundle_Resources_public_form_ts_form_service__["a" /* FormService */]
                            ]
                        }
                    },
                    entityPhoneObj: {
                        ...
                        control: 'edit',
                        popups: {
                            module: __WEBPACK_IMPORTED_MODULE_9__Bck_EntitiesBundle_Resources_public_entity_detail_ts_src_entity_phone_edit_ext_module__["a" /* EntityPhoneEditExtModule */],
                    ...
                    entityEmailObj: {
                        ...
                        control: 'edit',
                        popups: {
                            module: __WEBPACK_IMPORTED_MODULE_10__Bck_EntitiesBundle_Resources_public_entity_detail_ts_src_entity_email_edit_ext_module__["a" /* EntityEmailEditExtModule */],
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* ViewChild */])('js_entityContactsForm', { read: __WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewContainerRef */] }),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewContainerRef */])
    ], MainComponent.prototype, "entityContactsFormViewContainerRef", void 0);
    MainComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: '#js_main',
            template: __webpack_require__("../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/templates/main.component.html")
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('Provider')),
        __param(5, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('DataService')),
        __param(8, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('HelperService')),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Renderer */], Object, __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_wizard_ts_src_wizard_manager_service__["a" /* WizardManagerService */],
            __WEBPACK_IMPORTED_MODULE_5__AppBundle_Resources_public_ts_post_service__["a" /* PostService */], Object, __WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injector */],
            __WEBPACK_IMPORTED_MODULE_2__AppBundle_Resources_public_ts_dynamic_component_loader_service__["a" /* DynamicComponentLoaderService */], Object])
    ], MainComponent);
    return MainComponent;
}(__WEBPACK_IMPORTED_MODULE_3__AppBundle_Resources_public_wizard_ts_src_wizard_popup_component__["a" /* WizardPopupComponent */]));



/***/ }),

/***/ "../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/src/main.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__AppBundle_Resources_public_form_ts_form_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/form/ts/form.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__AppBundle_Resources_public_wizard_ts_src_wizard_manager_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/wizard/ts/src/wizard-manager.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__AppBundle_Resources_public_ts_flash_message_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/ts/flash-message.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__AppBundle_Resources_public_app_basics_default_ts_src_main_ext_module__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/app-basics/default/ts/src/main.ext-module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__AppBundle_Resources_public_app_basics_default_ts_src_main_component__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/app-basics/default/ts/src/main.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__main_component__ = __webpack_require__("../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/src/main.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__AppBundle_Resources_public_entity_detail_ts_src_entity_detail_ext_module__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/entity-detail/ts/src/entity-detail.ext-module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__AppBundle_Resources_public_entity_detail_ts_src_entity_detail_component__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/entity-detail/ts/src/entity-detail.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__Frt_EntitiesBundle_Resources_public_client_index_ts_src_edit_ext_module__ = __webpack_require__("../../../../../src/Frt/EntitiesBundle/Resources/public/client/index/ts/src/edit.ext-module.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var dependencies = _app.dependencies, entityDetailProvider = __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_ts_helper__["a" /* Helper */].getEntityDetailProvider(dependencies['client']);
    ...
    MainModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["H" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_15__AppBundle_Resources_public_app_basics_default_ts_src_main_ext_module__["a" /* MainExtModule */],
                __WEBPACK_IMPORTED_MODULE_18__AppBundle_Resources_public_entity_detail_ts_src_entity_detail_ext_module__["a" /* EntityDetailExtModule */]
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_17__main_component__["a" /* MainComponent */]
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_6__AppBundle_Resources_public_ts_post_service__["a" /* PostService */],
                __WEBPACK_IMPORTED_MODULE_7__AppBundle_Resources_public_modal_ts_modal_service__["b" /* ModalService */],
                __WEBPACK_IMPORTED_MODULE_9__AppBundle_Resources_public_ts_nav_manager_nav_manager_service__["a" /* NavManagerService */],
                __WEBPACK_IMPORTED_MODULE_10__AppBundle_Resources_public_wizard_ts_src_wizard_manager_service__["a" /* WizardManagerService */],
                __WEBPACK_IMPORTED_MODULE_11__AppBundle_Resources_public_ts_flash_message_service__["a" /* FlashMessageService */],
                ...
                { provide: 'DataServiceProvider', useValue: __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_ts_helper__["a" /* Helper */].getDataServiceProvider(dependencies['client']) },
                { provide: 'EntityDetailProvider', useValue: entityDetailProvider },
                { provide: 'Provider', useValue: __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_ts_helper__["a" /* Helper */].getWizardPopupProvider(_app.conf) },
                { provide: 'ActionsServiceProvider', useValue: __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_ts_helper__["a" /* Helper */].getActionsServiceProvider(dependencies['client']) },
                { provide: 'Popup', useValue: {
                        module: __WEBPACK_IMPORTED_MODULE_20__Frt_EntitiesBundle_Resources_public_client_index_ts_src_edit_ext_module__["a" /* EditExtModule */],
                        component: 'EditComponent',
                        providers: [
                            { provide: 'Provider', useValue: __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_ts_helper__["a" /* Helper */].getFormProvider(dependencies['client']) },
                            { provide: 'FormServiceProvider', useValue: { fields: ['code', 'avatar', 'title', 'name', 'surname',
                                        'legalName', 'birthDate', 'taxNumber'] } },
                            __WEBPACK_IMPORTED_MODULE_8__AppBundle_Resources_public_form_ts_form_service__["a" /* FormService */]
                        ]
                    } }
            ],
            bootstrap: [__WEBPACK_IMPORTED_MODULE_16__AppBundle_Resources_public_app_basics_default_ts_src_main_component__["a" /* MainComponent */], __WEBPACK_IMPORTED_MODULE_19__AppBundle_Resources_public_entity_detail_ts_src_entity_detail_component__["a" /* EntityDetailComponent */], __WEBPACK_IMPORTED_MODULE_17__main_component__["a" /* MainComponent */]]
        })
    ], MainModule);
    return MainModule;
}());
...
/***/ "../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/src/main.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__main_module__ = __webpack_require__("../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/src/main.module.ts");
...
/***/ "../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/src/step2.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__AppBundle_Resources_public_form_ts_form_extension_component__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/form/ts/form.extension-component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__AppBundle_Resources_public_ts_dynamic_component_loader_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/ts/dynamic-component-loader.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AppBundle_Resources_public_ts_data_service_data_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/ts/data-service/data.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__AppBundle_Resources_public_entity_detail_ts_src_entity_detail_preview_ext_module__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/entity-detail/ts/src/entity-detail-preview.ext-module.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var client = __webpack_require__("../../../../braintree-web/client/index.js");
var paypalCheckout = __webpack_require__("../../../../braintree-web/paypal-checkout/index.js");
/* Import dependencies */

/* /Import dependencies */
var Step2Component = (function (_super) {
    __extends(Step2Component, _super);
    function Step2Component(elementRef, renderer, provider, formService, dataService, _helperService, _injector, _dynamicComponentLoaderService) {
        var _this = _super.call(this) || this;
        _this._helperService = _helperService;
        _this._injector = _injector;
        _this._dynamicComponentLoaderService = _dynamicComponentLoaderService;
        _this._paypalConf = null;
        _this._fieldChoices = null;
        _this.appPaymentMethod_name = null; // Model to control display of payment method buttons
        _super.prototype.initFormExtensionComponent.call(_this, elementRef, renderer, provider, formService, dataService);
        _this._fieldChoices = _this._dataService.getFieldChoices('paymentMethodObj');
        return _this;
    }
    /**
     ...
     * @param value
     */
    Step2Component.prototype.onPaymentMethodChange = function (value) {
        if (value === undefined) {
            return; // Possible wrong element of the click event
        }
        var that = this, fieldChoiceIndex = this._helperService.arraySearchObj(value, 'id', this._fieldChoices);
        ...
        if (!this._paypalConf) {
            this._dataService.runAction(this._helperService.getAppVar('route')
                + 'accounting/client-payment-request/get-paypal-client-token/' + this._formService.getObject()['id']).then(function (data) {
                if (data['localData'] &&
                    data['localData']['data'] &&
     ...
     */
    Step2Component.prototype.renderPaypalButton = function () {
        var that = this, paypalConfPayment = this._paypalConf['payment'] || null, isSandbox = (that._paypalConf['environment'] == 'SANDBOX');
        ...
        paypal.Button.render({
            ...
            payment: function (data, actions) {
                var paymentArr = {
                    flow: 'checkout',
                    amount: paypalConfPayment['amount'],
                    currency: that._paypalConf['currency'],
                };
                if (paypalConfPayment['shippingAddress']) {
                    var paypalConfShippingAddress = paypalConfPayment['shippingAddress'];
                    paymentArr = that._helperService.mergeObjects(paymentArr, {
            ...
            onAuthorize: function (payload, actions) {
                ...
                that._dataService.runAction(that._helperService.getAppVar('route')
                    + 'accounting/client-payment-request/set-paypal-transaction/' + that._formService.getObject()['id'], { 'paymentMethodNonce': payload['nonce'] }).then(function (data) {
    ...
    Step2Component.prototype.ngAfterViewInit = function () {
        ...
        _app.conf['dependencies'] = ((_app.conf['localData']
            ...
            null);
        // Load dependencies
        var that = this, dependencyData = _app.conf, entityDetailPreviewProvider = this._helperService.getEntityDetailPreviewProvider(dependencyData), providers = [
            { provide: 'DataService', useClass: __WEBPACK_IMPORTED_MODULE_3__AppBundle_Resources_public_ts_data_service_data_service__["a" /* DataService */] },
        ...
        this._dynamicComponentLoaderService.load(__WEBPACK_IMPORTED_MODULE_5__AppBundle_Resources_public_entity_detail_ts_src_entity_detail_preview_ext_module__["a" /* EntityDetailPreviewExtModule */], 'EntityDetailPreviewComponent', that.entityDetailPreviewViewContainerRef, injector).then(function (componentRef) { return true; }, function (errors) { console.log(errors); return null; });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* ViewChild */])('js_entityDetailPreview', { read: __WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewContainerRef */] }),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewContainerRef */])
    ], Step2Component.prototype, "entityDetailPreviewViewContainerRef", void 0);
    Step2Component = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: '#js_step2',
            template: __webpack_require__("../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/templates/step2.component.html")
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('Provider')),
        __param(4, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('DataService')),
        __param(5, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('HelperService')),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["U" /* Renderer */], Object, __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_form_ts_form_service__["a" /* FormService */], Object, Object, __WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injector */],
...
/***/ "../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/src/step2.ext-module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ng_bootstrap_ng_bootstrap__ = __webpack_require__("../../../../@ng-bootstrap/ng-bootstrap/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_form_ts_field_types_field_types_extension_module__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/form/ts/field-types/field-types.extension-module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__step2_component__ = __webpack_require__("../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/src/step2.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/templates/main.component.html":
/***/ (function(module, exports) {

module.exports = "\n            <ul class=\"row mb-3 no-gutters wizard-nav\">\n                            <li class=\"col-auto wizard-step\"\n                    [class.step-active]=\"0 == _wizardManagerService.getIndex()\">\n                    <span class=\"step-number\">1</span>\n                    <span class=\"step-text\" [innerHTML]=\"getLang('Customer Info')\"></span>\n                </li>\n                            <li class=\"col-auto wizard-step\"\n                    [class.step-active]=\"1 == _wizardManagerService.getIndex()\">\n                    <span class=\"step-number\">2</span>\n                    <span class=\"step-text\" [innerHTML]=\"getLang('Payment')\"></span>\n                </li>\n                    </ul>\n\n        \n            <div class=\"p-3 my-3 border border-secondary rounded-md \">\n                    <section [hidden]=\"_wizardManagerService.getIndex() != 0\"\n         class=\"js_lazyLoadContainer_0\">\n    <ng-template #js_lazyLoadContainer></ng-template>\n</section>                <section [hidden]=\"_wizardManagerService.getIndex() != 1\"\n         class=\"js_lazyLoadContainer_1\">\n    <ng-template #js_lazyLoadContainer></ng-template>\n</section>        </div>\n\n        \n    \n\n    <div class=\"row justify-content-center\">\n    <div class=\"col-auto\">\n                    <button type=\"button\" class=\"btn-primary btn\" (click)=\"_wizardManagerService.prevAction($event)\"\n                    *ngIf=\"0 < _wizardManagerService.getIndex()\">Prev</button>\n            <button type=\"button\" class=\"btn-primary btn\" (click)=\"_wizardManagerService.nextAction($event)\"\n                    *ngIf=\"1 > _wizardManagerService.getIndex()\">Next</button>\n            <button type=\"button\" class=\"btn-primary btn\" (click)=\"_wizardManagerService.finishAction($event)\"\n                    *ngIf=\"1 == _wizardManagerService.getIndex()\">Finish</button>\n            </div>\n</div>"

/***/ }),

/***/ "../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/templates/step2.component.html":
/***/ (function(module, exports) {

module.exports = "    <div class=\"row form-group\">\n        <label class=\"col-sm-2 control-label\">Payment Info</label>\n        <div class=\"col-sm-10\">\n            <div class=\"form-control-box\"><ng-template #js_entityDetailPreview></ng-template></div>\n        </div>\n    </div>\n\n\n\n    <form name=\"form\" method=\"post\" (ngSubmit)=\"saveAction($event)\" [formGroup]=\"_formService.getForm()\" class=\"form-horizontal\">\n\n    \n            \n\n                <div class=\"row form-group\" >\n\n                        <label class=\"col-sm-2 control-label\">Payment Method</label>\n    \n            <div class=\"col-sm-10\">\n                                                                                <div class=\"form-control-box\"\n         [ngClass]=\"{'error': _formService.getErrors().paymentMethodObj && (_formService.getErrors().paymentMethodObj.length > 0)}\"\n                                                                                                            (click)=\"_formService.setFormFieldValue('paymentMethodObj', $event.target.value); onPaymentMethodChange($event.target.value)\">\n                <div class=\"radio\"\n             *ngFor=\"let choice of _dataService.getFieldChoices('paymentMethodObj')\">\n            <label ><input\n                type=\"radio\"\n                value=\"{{choice['id']}}\"\n                [checked]=\"_formService.getObject().paymentMethodObj == choice['id']\">&nbsp;<span [innerHTML]=\"choice['label']\"></span></label>\n            <div class=\"tip-box\"\n                 *ngIf=\"(_formService.getObject().paymentMethodObj == choice['id']) && (choice['description'])\"><small class=\"pre-wrap\">{{choice['description']}}</small></div>\n        </div>\n        <input [(ngModel)]=\"_formService.getObject().paymentMethodObj\"\n               formControlName=\"paymentMethodObj\"\n               name=\"form[paymentMethodObj]\"\n                              type=\"hidden\">\n    </div>\n                                <label class=\"error\" *ngFor=\"let error of _formService.getErrors().paymentMethodObj\">{{error}}</label>\n            </div>\n        </div>\n            <div [hidden]=\"appPaymentMethod_name != 'Paypal'\" class=\"row\">\n        <div id=\"paypal-button\"\n             class=\"offset-sm-2 col-sm-8\"></div>\n    </div>\n\n\n    \n\n    <input type=\"hidden\" id=\"form__token\" name=\"form[_token]\" value=\"6uki2s58s5KOFHGDrWSs3NQLpa58zy_94hkDzqPSXNc\" /></form>\n\n"

/***/ }),

/***/ "../../../../../src/Frt/EntitiesBundle/Resources/public/client/index/ts/src/edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var EditComponent = (function (_super) {
    ...
    EditComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: '.js_edit',
            template: __webpack_require__("../../../../../src/Frt/EntitiesBundle/Resources/public/client/index/ts/templates/edit.component.html")
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('Provider')),
        __param(4, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('DataService')),
        __param(5, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('HelperService')),
...
/***/ "../../../../../src/Frt/EntitiesBundle/Resources/public/client/index/ts/src/edit.ext-module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ng_bootstrap_ng_bootstrap__ = __webpack_require__("../../../../@ng-bootstrap/ng-bootstrap/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__AppBundle_Resources_public_form_ts_field_types_field_types_extension_module__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/form/ts/field-types/field-types.extension-module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__edit_component__ = __webpack_require__("../../../../../src/Frt/EntitiesBundle/Resources/public/client/index/ts/src/edit.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
module.exports = __webpack_require__("../../../../../src/Frt/AccountingBundle/Resources/public/client-payment-request/process/ts/src/main.ts");
