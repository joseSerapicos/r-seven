...
export class Step1Component extends WizardFormPopupComponent implements IWizard
{
    ...
    protected _clientIsPaxValue: any = null; // To check when the field change to refresh the pax list
                ...
                case 1:
                    ...
                    return that._packageBookingService_formService.save(route).then(
                        data => {
                            ...
                            let step2ComponentRef = that._wizardManagerService.getComponentRef(2),
                                clientIsPaxValue = that._formService.getObject()['bookingPaxObj'];
