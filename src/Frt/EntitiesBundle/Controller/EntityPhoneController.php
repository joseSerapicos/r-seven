...
use Bck\EntitiesBundle\Controller\EntityPhoneController as BckEntityPhoneController;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use Symfony\Component\HttpFoundation\Request;


class EntityPhoneController extends BckEntityPhoneController
{
    /**
    ...
    public function init(Request $request, $parents = null)
    {
        ...
        $this->templateConf['route'] = array(
            ...
            'choices' => array(
                'name' => '_entities__entity_phone__choices'
            ),
            'edit' => array(
    ...
    /**
     * @Route("/entities/entity-phone/choices/{entity}",
     *     name="_entities__entity_phone__choices"
     * )
     *
     * Overrides parent method
    ...
    /**
     * @Route("/entities/entity-phone/conf/{entity}/{id}",
