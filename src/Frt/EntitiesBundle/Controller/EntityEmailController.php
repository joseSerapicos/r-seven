...
use Bck\EntitiesBundle\Controller\EntityEmailController as BckEntityEmailController;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use Symfony\Component\HttpFoundation\Request;


class EntityEmailController extends BckEntityEmailController
{
    /**
    ...
    public function init(Request $request, $parents = null)
    {
        ...
        $this->templateConf['route'] = array(
            ...
            'choices' => array(
                'name' => '_entities__entity_email__choices'
            ),
            'edit' => array(
    ...
    /**
     * @Route("/entities/entity-email/choices/{entity}",
     *     name="_entities__entity_email__choices"
     * )
     *
     * Overrides parent method
    ...
    /**
     * @Route("/entities/entity-email/conf/{entity}/{id}",
