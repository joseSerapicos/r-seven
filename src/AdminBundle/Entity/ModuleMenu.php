<?php
// src/AdminBundle/Entity/ModuleMenu.php
...
/**
 * @ORM\Entity(repositoryClass="AdminBundle\Entity\ModuleMenuRepository")
...
class ModuleMenu extends BaseEntity {
    /**
     * @ORM\ManyToOne(targetEntity="\SysadminBundle\Entity\ModuleMenu")
