...
class ModuleMenuRepository extends BaseEntityRepository
{
    ...
    static function getMetadata()
    {
        ...
        return self::$metadata = self::processMetadata(array(
            ...
            'moduleObj' => array('label' => 'Module', 'type' => 'object', 'acl' => 'read', 'typeDetail' => array(
                'table' => 'module', 'bundle' => 'admin', 'type' => 'none')),
    ...
    public function getAllJoinWithUserGroupAclMenu($isAdmin, $userGroupAcl_id, $loggedUserId, $loggedUserStore)
    {
        ...
        if (!$isAdmin)
        {
            ...
            $qb->innerJoin('AdminBundle\Entity\UserGroupAclMenu',
        ...
        $qb->leftJoin('AdminBundle\Entity\UserGroupAclMenu',
            'userGroupAclMenu',
            'WITH',
        ...
        $qb->innerJoin('SysadminBundle\Entity\ModuleMenu',
            'app_moduleMenu',
            'WITH',
        ...
        $qb->innerJoin('SysadminBundle\Entity\Module',
            'app_module',
            'WITH',
