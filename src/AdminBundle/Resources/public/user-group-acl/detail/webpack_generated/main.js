...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var data_service_1 = __webpack_require__(51);
	var tree_view_data_service_1 = __webpack_require__(55);
	var actions_service_1 = __webpack_require__(41);
	var helper_1 = __webpack_require__(53);
	var modal_service_1 = __webpack_require__(43);
	var nav_manager_service_1 = __webpack_require__(52);
	...
	// UserGroupAclMenu
	helper_1.Helper.setRuntimeVar('templateUrl', _app.dependency['userGroupAclMenu']['route']['edit']['url']);
	var tree_view_form_acl_extension_module_1 = __webpack_require__(59);
	// UserGroupAclUser
	helper_1.Helper.setRuntimeVar('templateUrl', _app.dependency['userGroupAclUser']['route']['edit']['url']);
	var main_extension_module_1 = __webpack_require__(67);
	...
	var MainComponent = (function (_super) {
	    ...
	    MainComponent.prototype.getNavData = function (index) {
	        switch (index) {
	            case 0:
	                return {
	                    module: tree_view_form_acl_extension_module_1.TreeViewFormAclExtensionModule,
	...
	MainComponent = __decorate([
	    core_1.Component({
	        selector: '#js_main',
	        templateUrl: helper_1.Helper.getGlobalVar('route') + 'admin/user-group-acl/detail-tabs'
	    }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var search_module_1 = __webpack_require__(34);
	var expander_module_1 = __webpack_require__(35);
	var tree_view_form_component_1 = __webpack_require__(60);
	var tree_view_node_component_1 = __webpack_require__(65);
	var tree_view_control_form_type_acl_component_1 = __webpack_require__(66);
	var TreeViewFormAclExtensionModule = (function () {
	    function TreeViewFormAclExtensionModule() {
	    }
	    return TreeViewFormAclExtensionModule;
	}());
	TreeViewFormAclExtensionModule = __decorate([
	    core_1.NgModule({
	        imports: [
	        ...
	        declarations: [
	            ...
	            tree_view_control_form_type_acl_component_1.TreeViewControlFormTypeAclComponent
	        ],
	        exports: [tree_view_form_component_1.TreeViewFormComponent]
	    })
	], TreeViewFormAclExtensionModule);
	exports.TreeViewFormAclExtensionModule = TreeViewFormAclExtensionModule;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions_service_1 = __webpack_require__(41);
	var modal_service_1 = __webpack_require__(43);
	var tree_view_component_1 = __webpack_require__(61);
	var helper_ts_1 = __webpack_require__(53);
	var TreeViewFormComponent = (function (_super) {
	    __extends(TreeViewFormComponent, _super);
	    function TreeViewFormComponent(viewContainerRef, renderer, provider, dataService, actionsService, modalService, popups, injector, _helperService) {
	        var _this = 
	        // Call parent
	     ...
	     * @returns {Promise}
	     */
	    TreeViewFormComponent.prototype.save = function () {
	        var that = this;
	        return new Promise(function (resolve, reject) {
	            // Current form object has changes from user?
	            if (!helper_ts_1.Helper.isEqualObject(that._nodes, that._dataService.getProviderAttr('objects'))) {
	                // Get form data
	     ...
	     * @param closePopup
	     */
	    TreeViewFormComponent.prototype.saveAction = function ($event, closePopup) {
	        if ($event === void 0) { $event = null; }
	     ...
	     * @returns {Promise<T>}
	     */
	    TreeViewFormComponent.prototype.reset = function () {
	        var that = this;
	        return new Promise(function (resolve, reject) {
	            // Current form object has changes from user?
	     ...
	     * @param $event
	     */
	    TreeViewFormComponent.prototype.resetAction = function ($event) {
	        if ($event === void 0) { $event = null; }
	        if ($event) {
	            $event.preventDefault();
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(43);
	var helper_ts_1 = __webpack_require__(53);
	var tree_view_ext_component_1 = __webpack_require__(62);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var data_box_extension_component_1 = __webpack_require__(63);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var data_service_1 = __webpack_require__(51);
	var box_extension_component_1 = __webpack_require__(64);
	// Popup Types
	exports.PopupTypes = {
	    edit: 'edit',
	    add: 'add'
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TreeViewControlFormTypeAclComponent = TreeViewControlFormTypeAclComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var search_module_1 = __webpack_require__(34);
	var expander_module_1 = __webpack_require__(35);
	var main_component_1 = __webpack_require__(75);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var password_component_1 = __webpack_require__(71);
	var field_type_multi_checkbox_directive_1 = __webpack_require__(72);
	var field_type_html_select_directive_1 = __webpack_require__(73);
	var field_type_date_picker_directive_1 = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var post_service_1 = __webpack_require__(42);
	var form_service_1 = __webpack_require__(56);
	var data_box_component_1 = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	MainComponent = __decorate([
	    core_1.Component({
	        selector: '.js_main',
	        templateUrl: helper_1.Helper.getGlobalVar('route') + 'admin/user-group-acl-user/edit/0'
	    }),
	    __param(2, core_1.Inject('Provider')),
	    __param(3, core_1.Inject('DataService')),
	    __param(6, core_1.Inject('Popups')),
