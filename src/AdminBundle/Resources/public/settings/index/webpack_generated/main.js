...
/***/ function(module, exports, __webpack_require__) {
	...
	var SupplierSettingFormPopupModule = (function () {
	    ...
	    return SupplierSettingFormPopupModule;
	}());
	SupplierSettingFormPopupModule = __decorate([
	    core_1.NgModule({
	        imports: [common_1.CommonModule, forms_1.FormsModule, forms_1.ReactiveFormsModule,
	            field_types_extension_module_1.FieldTypesExtensionModule,
	            ng_bootstrap_1.NgbModule
	        ...
	        declarations: [
	            supplier_setting_form_popup_component_1.SupplierSettingFormPopupComponent
	        ],
	        exports: [supplier_setting_form_popup_component_1.SupplierSettingFormPopupComponent]
	    })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BookingSettingFormPopupComponent = (function (_super) {
	    ...
	    function BookingSettingFormPopupComponent(elementRef, renderer, provider, formService, dataService) {
	        var _this = _super.call(this) || this;
	        _super.prototype.initFormPopupExtensionComponent.call(_this, elementRef, renderer, provider, formService, dataService);
	        return _this;
	    }
	    return BookingSettingFormPopupComponent;
	}(form_popup_extension_component_1.FormPopupExtensionComponent));
	BookingSettingFormPopupComponent = __decorate([
	    core_1.Component({
