...
class ModuleController extends BaseEntityController
{
    ...
    protected function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            ...
            'delete' => array(
                'name' => '_admin__module__delete'
            ),
            'detail' => array(
                'name' => '_admin__module__detail'
            )
        );
        ...
        $this->templateConf['extraData']['service'] = array(
            'appDependencyRouteGetUrl' => $this->generateUrl('_sysadmin__module__get'),
    ...
    protected function getFieldChoicesFromDb($field)
    {
        ...
        $systemRepositoryService = $this->get('sysadmin.service.repository')
            ->setEntityRepository('SysadminBundle:Module');
