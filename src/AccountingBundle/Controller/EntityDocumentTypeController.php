...
class EntityDocumentTypeController extends BaseEntityController
{
    /**
    ...
    protected function init(Request $request)
    {
        ...
        $this->templateConf['label'] = 'Entity Document Types';
        $this->templateConf['selectedMenu']['route'] = '_accounting__document_types__index';

        // Route
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_accounting__entity_document_type__get'
            ),
            'edit' => array(
                'name' => '_accounting__entity_document_type__edit'
            ),
            'delete' => array(
                'name' => '_accounting__entity_document_type__delete'
            )
        );
    ...
    /**
     * @Route("/accounting/entity-document-type",
     *     name="_accounting__entity_document_type__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/accounting/entity-document-type/get/{id}",
     *     name="_accounting__entity_document_type__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/accounting/entity-document-type/edit/{id}",
     *     name="_accounting__entity_document_type__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/accounting/entity-document-type/delete/{id}",
     *     name="_accounting__entity_document_type__delete",
     *     defaults={"id" = null},
     * )
     *
