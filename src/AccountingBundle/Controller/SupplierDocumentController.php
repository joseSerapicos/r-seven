...
class SupplierDocumentController extends BaseDocumentController
{
    ...
    protected function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'new' => array(
                'name' => '_accounting__supplier_document__new'
            ),
            'get' => array(
                'name' => '_accounting__supplier_document__get'
            ),
            'getByBooking' => array(
                'name' => '_accounting__supplier_document__get_by_booking'
            ),
            'addStep1' => array(
                'name' => '_accounting__supplier_document__add_step1',
            ),
            'addStep2' => array(
                'name' => '_accounting__supplier_document__add_step2',
            ),
            'addStep3Invoice' => array(
                'name' => '_accounting__supplier_document__add_step3_invoice',
            ),
            'addStep3Receipt' => array(
                'name' => '_accounting__supplier_document__add_step3_receipt',
            ),
            'addStep3Payment' => array(
                'name' => '_accounting__supplier_document__add_step3_payment',
            ),
            'addStep3Settlement' => array(
                'name' => '_accounting__supplier_document__add_step3_settlement',
            ),
            'edit-invoice' => array(
                'name' => '_accounting__supplier_document__edit_invoice',
            ),
            'edit-receipt' => array(
                'name' => '_accounting__supplier_document__edit_receipt',
            ),
            'edit-payment' => array(
                'name' => '_accounting__supplier_document__edit_payment',
            ),
            'edit-settlement' => array(
                'name' => '_accounting__supplier_document__edit_settlement',
            ),
            'edit-entity-address' => array(
                'name' => '_accounting__supplier_document__edit_entity_address',
            ),
            'delete' => array(
                'name' => '_accounting__supplier_document__delete',
            ),
            'cancel' => array(
                'name' => '_accounting__supplier_document__cancel',
            ),
            'choices' => array(
    ...
    /**
     * @Route("/accounting/supplier-document",
     *     name="_accounting__supplier_document__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/accounting/supplier-document/new",
     *     name="_accounting__supplier_document__new"
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/get/{id}",
     *     name="_accounting__supplier_document__get",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/choices/{entity}/{operation}/{booking}",
     *     name="_accounting__supplier_document__choices",
    ...
    /**
     * @Route("/accounting/supplier-document/add-step1/{id}",
     *     name="_accounting__supplier_document__add_step1",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/add-step2/{id}",
     *     name="_accounting__supplier_document__add_step2",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/add-step3-invoice/{id}",
     *     name="_accounting__supplier_document__add_step3_invoice",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/add-step3-receipt/{id}",
     *     name="_accounting__supplier_document__add_step3_receipt",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/add-step3-payment/{id}",
     *     name="_accounting__supplier_document__add_step3_payment",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/add-step3-settlement/{id}",
     *     name="_accounting__supplier_document__add_step3_settlement",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/edit-invoice/{id}",
     *     name="_accounting__supplier_document__edit_invoice",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/edit-receipt/{id}",
     *     name="_accounting__supplier_document__edit_receipt",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/edit-payment/{id}",
     *     name="_accounting__supplier_document__edit_payment",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/edit-settlement/{id}",
     *     name="_accounting__supplier_document__edit_settlement",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/edit-entity-address/{id}",
     *     name="_accounting__supplier_document__edit_entity_address",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/delete/{id}",
     *     name="_accounting__supplier_document__delete",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/cancel/{id}",
     *     name="_accounting__supplier_document__cancel",
     *     defaults={"id" = null}
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document/conf",
     *     name="_accounting__supplier_document__conf"
     * )
     *
     * Overrides parent method
     * @param Request $request
    ...
    /**
     * @Route("/accounting/supplier-document/get-by-booking/{booking}/{id}",
     *     name="_accounting__supplier_document__get_by_booking",
    ...
    /**
     * @Route("/accounting/supplier-document/data-by-booking/{booking}",
     *     name="_accounting__supplier_document__data_by_booking"
     * )
     *
     * Overrides parent method
     * @param Request $request
    ...
    /**
     * @Route("/accounting/supplier-document/get-for-settlement/{targetDocument}/{booking}",
     *     name="_accounting__supplier_document__get_for_settlement",
    ...
    /**
     * @Route("/accounting/supplier-document/data-for-settlement/{targetDocument}/{booking}",
     *     name="_accounting__supplier_document__data_for_settlement",
     *     defaults={"targetDocument" = null, "booking" = null}
     * )
     *
     * Overrides parent method
