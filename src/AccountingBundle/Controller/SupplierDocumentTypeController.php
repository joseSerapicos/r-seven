...
class SupplierDocumentTypeController extends BaseEntityController
{
    ...
    protected function init(Request $request)
    {
        ...
        $this->templateConf['route'] = array(
            'get' => array(
                'name' => '_accounting__supplier_document_type__get'
            ),
            'edit' => array(
                'name' => '_accounting__supplier_document_type__edit'
            ),
            'delete' => array(
                'name' => '_accounting__supplier_document_type__delete'
            )
        );
    ...
    /**
     * @Route("/accounting/supplier-document-type",
     *     name="_accounting__supplier_document_type__index"
     * )
     *
     * Index action
     * @param Request $request
    ...
    /**
     * @Route("/accounting/supplier-document-type/get/{id}",
     *     name="_accounting__supplier_document_type__get",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document-type/edit/{id}",
     *     name="_accounting__supplier_document_type__edit",
     *     defaults={"id" = null},
     * )
     *
    ...
    /**
     * @Route("/accounting/supplier-document-type/delete/{id}",
     *     name="_accounting__supplier_document_type__delete",
     *     defaults={"id" = null},
     * )
     *
