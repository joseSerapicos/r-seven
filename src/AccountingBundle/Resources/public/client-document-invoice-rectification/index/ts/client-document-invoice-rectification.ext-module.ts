...
import {ClientDocumentInvoiceRectificationComponent} from './client-document-invoice-rectification.component';
...
@NgModule({
    ...
    exports: [ClientDocumentInvoiceRectificationComponent]
})
export class ClientDocumentInvoiceRectificationExtModule {}