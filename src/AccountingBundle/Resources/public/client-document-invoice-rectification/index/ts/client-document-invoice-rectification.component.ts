...
@Component({
    ...
    templateUrl: Helper.getGlobalVar('route') + 'template/index/base-document-invoice-rectification/accounting'
})
export class ClientDocumentInvoiceRectificationComponent extends DataBoxExtensionComponent
{
    constructor(
