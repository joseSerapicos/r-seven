...
import {BaseClientCurrentAccountFormPopupExtComponent} from '../../ts/base-client-current-account-form-popup.ext-component';
...
export class ClientCurrentAccountAddDetailFormPopupComponent extends BaseClientCurrentAccountFormPopupExtComponent
{
    constructor(
        ...
        super();
        super.initBaseClientCurrentAccountFormPopupExtComponent(
            elementRef,
            renderer,
            provider,
            formService,
