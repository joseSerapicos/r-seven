...
import {ClientCurrentAccountAddFormPopupComponent} from './client-current-account-add-form-popup.component';
...
@NgModule({
    ...
    exports: [ClientCurrentAccountAddFormPopupComponent]
})
export class ClientCurrentAccountAddFormPopupExtModule {}