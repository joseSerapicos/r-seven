...
import {ClientDocumentReceiptSettlementComponent} from './client-document-receipt-settlement.component';
...
@NgModule({
    ...
    exports: [ClientDocumentReceiptSettlementComponent]
})
export class ClientDocumentReceiptSettlementExtModule {}