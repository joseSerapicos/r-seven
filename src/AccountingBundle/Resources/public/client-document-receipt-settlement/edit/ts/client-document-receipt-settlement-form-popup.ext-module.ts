...
import {ClientDocumentReceiptSettlementFormPopupComponent} from './client-document-receipt-settlement-form-popup.component';
...
@NgModule({
    ...
    exports: [ClientDocumentReceiptSettlementFormPopupComponent]
})
export class ClientDocumentReceiptSettlementFormPopupExtModule {}