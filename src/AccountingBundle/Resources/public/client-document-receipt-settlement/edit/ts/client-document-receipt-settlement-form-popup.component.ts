...
export class ClientDocumentReceiptSettlementFormPopupComponent extends FormPopupExtensionComponent
{
     ...
     */
    protected setTotals(): ClientDocumentReceiptSettlementFormPopupComponent {
