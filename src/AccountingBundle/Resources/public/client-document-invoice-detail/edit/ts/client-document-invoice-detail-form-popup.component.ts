...
export class ClientDocumentInvoiceDetailFormPopupComponent extends FormPopupExtensionComponent
{
     ...
     */
    protected setTotals(): ClientDocumentInvoiceDetailFormPopupComponent {
