...
import {ClientDocumentInvoiceDetailComponent} from './client-document-invoice-detail.component';
...
@NgModule({
    ...
    exports: [ClientDocumentInvoiceDetailComponent]
})
export class ClientDocumentInvoiceDetailExtModule {}