        ...
        switch (index) {
            case 0:
                return {
                    ...
                    urlProvider: (this._helperService.getAppVar('route') + 'accounting/client-document/data-for-settlement/' + this._parentFormService.getObject()['id'] + (bookingContext ? ('/' + bookingId) : ''))
                };
            case 1:
                return {
