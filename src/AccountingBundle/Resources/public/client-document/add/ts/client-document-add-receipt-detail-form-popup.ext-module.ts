...
import {ClientDocumentAddReceiptDetailFormPopupComponent} from './client-document-add-receipt-detail-form-popup.component';
...
@NgModule({
    ...
    exports: [ClientDocumentAddReceiptDetailFormPopupComponent]
})
export class ClientDocumentAddReceiptDetailFormPopupExtModule {}