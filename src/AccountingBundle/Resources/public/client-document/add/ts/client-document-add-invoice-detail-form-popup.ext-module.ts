...
import {ClientDocumentAddInvoiceDetailFormPopupComponent} from './client-document-add-invoice-detail-form-popup.component';
...
@NgModule({
    ...
    exports: [ClientDocumentAddInvoiceDetailFormPopupComponent]
})
export class ClientDocumentAddInvoiceDetailFormPopupExtModule {}