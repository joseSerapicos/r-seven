...
import {ClientDocumentEditReceiptFormPopupComponent} from './client-document-edit-receipt-form-popup.component';
...
@NgModule({
    ...
    exports: [ClientDocumentEditReceiptFormPopupComponent]
})
export class ClientDocumentEditReceiptFormPopupExtModule {}