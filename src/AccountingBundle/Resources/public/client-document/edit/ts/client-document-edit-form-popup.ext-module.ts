...
import {ClientDocumentEditFormPopupComponent} from './client-document-edit-form-popup.component';
...
@NgModule({
    ...
    exports: [ClientDocumentEditFormPopupComponent]
})
export class ClientDocumentEditFormPopupExtModule {}