...
import {BaseClientInvoiceRectificationDocumentFormPopupExtComponent} from '../../ts/base-client-invoice-rectification-document-form-popup.ext-component';
...
export class ClientDocumentEditInvoiceRectificationFormPopupComponent extends BaseClientInvoiceRectificationDocumentFormPopupExtComponent
{
    constructor(
        ...
        super();
        super.initBaseClientInvoiceRectificationDocumentFormPopupExtComponent(
            elementRef,
            renderer,
            provider,
            formService,
