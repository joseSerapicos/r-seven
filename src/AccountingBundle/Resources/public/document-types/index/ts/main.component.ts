...
/* Import dependencies */
// Entity
Helper.setRuntimeVar('templateUrl', Helper.getGlobalVar('route') + 'accounting/client-document-type/edit');
import {ClientDocumentTypeFormPopupExtModule} from '../../../client-document-type/ts/client-document-type-form-popup.ext-module';

// Client
Helper.setRuntimeVar('templateUrl', Helper.getGlobalVar('route') + 'accounting/supplier-document-type/edit');
import {SupplierDocumentTypeFormPopupExtModule} from '../../../supplier-document-type/ts/supplier-document-type-form-popup.ext-module';

// Supplier
Helper.setRuntimeVar('templateUrl', Helper.getGlobalVar('route') + 'accounting/entity-document-type/edit');
import {EntityDocumentTypeFormPopupExtModule} from '../../../entity-document-type/ts/entity-document-type-form-popup.ext-module';
/* /Import dependencies */


@Component({
    selector: '#js_main',
    templateUrl: Helper.getGlobalVar('route') + 'accounting/document-types/main-menus'
})
        ...
        switch (index) {
            case 0:
                providers.push({provide: 'Popups', useValue: {
                    module: ClientDocumentTypeFormPopupExtModule,
            ...
            case 1:
                providers.push({provide: 'Popups', useValue: {
                    module: SupplierDocumentTypeFormPopupExtModule,
            ...
            case 2:
                providers.push({provide: 'Popups', useValue: {
                    module: EntityDocumentTypeFormPopupExtModule,
