...
export class ClientCurrentAccountDetailFormPopupComponent extends FormPopupExtensionComponent
{
     ...
     */
    protected setTotals(): ClientCurrentAccountDetailFormPopupComponent {
