...
import {ClientCurrentAccountDetailComponent} from './client-current-account-detail.component';
...
@NgModule({
    ...
    exports: [ClientCurrentAccountDetailComponent]
})
export class ClientCurrentAccountDetailExtModule {}