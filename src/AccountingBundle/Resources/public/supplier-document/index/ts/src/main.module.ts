...
// Form Popups
// Add
import {FormPopupExtModule as SupplierDocumentAddFormPopupExtModule} from '../../../add/ts/src/form-popup.ext-module';
// Edit
import {FormPopupExtModule as SupplierDocumentEditFormPopupExtModule} from '../../../edit/ts/src/form-popup.ext-module';
...
@NgModule({
    ...
    providers: [
        ...
        {provide: 'Popups', useValue: {
            ...
            edit: {
                module: SupplierDocumentEditFormPopupExtModule,
                component: 'FormPopupComponent',
