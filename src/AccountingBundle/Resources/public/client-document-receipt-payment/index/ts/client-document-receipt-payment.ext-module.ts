...
import {ClientDocumentReceiptPaymentComponent} from './client-document-receipt-payment.component';
...
@NgModule({
    ...
    exports: [ClientDocumentReceiptPaymentComponent]
})
export class ClientDocumentReceiptPaymentExtModule {}