...
export class ClientDocumentReceiptPaymentFormPopupComponent extends FormPopupExtensionComponent
{
     ...
     */
    protected setTotals(): ClientDocumentReceiptPaymentFormPopupComponent {
