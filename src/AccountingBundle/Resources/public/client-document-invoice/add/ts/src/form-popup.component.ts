        ...
        switch (index) {
            case 0:
                return {
                    ...
                    urlProvider: (this._helperService.getAppVar('route') + 'booking/booking-service-price/data-for-invoice-client/' + this._parentFormService.getObject()['clientObj'] + (bookingContext ? ('/' + bookingId) : ''))
                };
            case 1:
                return {
