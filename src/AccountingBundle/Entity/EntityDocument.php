...
/**
 * @ORM\Entity(repositoryClass="AccountingBundle\Entity\EntityDocumentRepository")
 * @ORM\Table(name="entityDocument",
 *     uniqueConstraints={
 *         @ORM\UniqueConstraint(name="unq_entityDocument_code", columns={"fk_entityDocumentType", "codePrefix", "codeNumber"})
 *     }
 * )
 */
class EntityDocument extends BaseDocument {
    /**
