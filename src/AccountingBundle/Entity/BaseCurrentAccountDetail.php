...
/**
 * @ORM\MappedSuperclass(repositoryClass="AccountingBundle\Entity\BasePriceRepository")
 * @ORM\HasLifecycleCallbacks()
 */
class BaseCurrentAccountDetail extends BaseEntity
{
    /**
     ...
     * 2 Decimals are used, this value is for sell/client.
     * By default inherit from "BookingServicePrice" (if applicable).
     */
    protected $value;
