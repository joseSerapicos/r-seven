...
<?php // ?>
										<div class="news-item-detail">
										  <a class="news-item-title" onclick='javascript: callScript("<?=PATH_ROOT?>home/layout/view_news.php", "selector", "#load_main_menu", false);'><?=htmlentities($news_inside->title)?></a> (<a class="news-item-title" onclick='javascript: callScript("<?=PATH_ROOT?>home/layout/view_news.php", "selector", "#load_main_menu", false);'>about: <?=$knews?></a>)
