...
<script src="<?= PATH_ROOT ?>lib/bootbox.min.js"></script>
...
if(is_array($headerButtons) && is_array($headerButtons['conf']) && $headerButtons['conf']['addScripts']) {
    ...
    $(document).ready(function() { 
		...
		<?php if( is_array($headerButtons['add']) && ($headerButtons['add']['enabled'] || $headerButtons['add']['addEditSingleHeader'] || $headerButtons['add']['addMultiAddHeader']) && ($masterPermission['edit'] || $masterPermission['add'])  ) { ?>
		// Variaveis
		...
		<?php if(is_array($headerButtons['add']) && $headerButtons['add']['enabled'] && $masterPermission['add']) { ?>
		/* Botao "addHeader" */
		...
		<?php if(is_array($headerButtons['deleteAll']) && $headerButtons['deleteAll']['enabled'] && $masterPermission['add']) { ?>
