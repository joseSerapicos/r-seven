    ...
    <div class="panel panel-default">
        ...
        <div id="collapse<?= $user->get_id() ?>" class="panel-collapse collapse">
            <div class="panel-body">
				...
				// Stores
				$stores = array();
				$stores = $usersPermissionsMasterObj->getUserStores($masterSystemDb, $masterUserObj->get_id());
						...
						foreach($stores as $store) { ?>
                            <div class="tab-pane fade<?= ($first?' active in':'') ?>" id="storesTabUser<?= $user->get_id() ?>Store<?= $store->get_id() ?>">
									...
									<form id="frmUser<?= $user->get_id() ?>Store<?= $store->get_id() ?>">
										...
										// Modulos
										$modules = array();
										$modules = $usersPermissionsMasterObj->getUserStoreModules($masterSystemDb, $masterUserObj->get_id(), $store->get_id());
										if(is_array($modules))
										foreach($modules as $module)
										{
											// Menus
                                			$menus = $usersPermissionsMasterObj->getUserStoreModuleMenus($masterSystemDb, $masterUserObj->get_id(), $store->get_id(), $module->get_id());
											?>
