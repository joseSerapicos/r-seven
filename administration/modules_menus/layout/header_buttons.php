...
$headerButtons['add']['scriptGetForm'] = (PATH_ROOT."administration/modules_menus/layout/get_form_modules.php"); // Script com o form a ser carregado
$headerButtons['add']['scriptPostForm'] = (PATH_ROOT."administration/modules_menus/scripts/save_form_modules.php"); // Script para onde deve ser enviado o post do form
