                ...
                foreach($module_menus as $module_menu) { ?>
                    ...
                    <tr>
                        ...
                        <td class="alignRight">
                        	...
                        	<button class="btn btn-default optionButton icon-remove deleteSingleHeader" data-myId="<?= $module_menu->get_id() ?>" data-myScriptPostForm="<?= (PATH_ROOT."administration/modules_menus/scripts/delete_form_menus.php") ?>" />
                        </td>
                    </tr>
