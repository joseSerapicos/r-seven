...
class module_menu {
	...
	// Retorna filepath_top //
	public function get_filepath_top($var_db) {
		$sql = ("SELECT  
	...
	// Retorna filepath_content //
	public function get_filepath_content($var_db) {
		$sql = ("SELECT  
	...
	// Retorna filepath_bottom //
	public function get_filepath_bottom($var_db) {
		$sql = ("SELECT  
