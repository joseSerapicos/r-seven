    ...
    foreach($stores as $store) { ?>
        ...
        <tr>
            ...
            <td class="alignRight">
                ...
                <button class="btn btn-default optionButton icon-remove deleteSingleHeader" data-myId="<?= $store->get_id() ?>" data-myScriptPostForm="<?= (PATH_ROOT."administration/stores/scripts/delete_form_stores.php") ?>"></button>
                <?php } ?>
            </td>
        </tr>
