...
$headerButtons['add']['scriptGetForm'] = (PATH_ROOT."administration/stores/layout/get_form_stores.php"); // Script com o form a ser carregado
$headerButtons['add']['scriptPostForm'] = (PATH_ROOT."administration/stores/scripts/save_form_stores.php"); // Script para onde deve ser enviado o post do form
