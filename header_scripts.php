...
if(is_array($headerButtons) && is_array($headerButtons['conf']) && $headerButtons['conf']['addScripts']) {
    ...
    $(document).ready(function() { 
        ...
        <?php if($headerButtons['add']['addMultiAddHeader'] && $masterPermission['add']) { ?>
        ...
        <?php if(is_array($headerButtons['deleteAll']) && $headerButtons['deleteAll']['addDeleteSingleHeader'] && $masterPermission['add']) { ?>
