...
define('FILES_ROOT', '/mygest/myfiles/public/'.$_SESSION['masterSystem'].'/fileman/');
define('SESSION_PATH_KEY', '');
define('THUMBS_VIEW_WIDTH', '140');
define('THUMBS_VIEW_HEIGHT', '120');
define('PREVIEW_THUMB_WIDTH', '300');
define('PREVIEW_THUMB_HEIGHT', '200');
define('MAX_IMAGE_WIDTH', '0');
define('MAX_IMAGE_HEIGHT', '0');
define('INTEGRATION', 'ckeditor');
define('DIRLIST', 'php/dirtree.php');
define('CREATEDIR', 'php/createdir.php');
define('DELETEDIR', 'php/deletedir.php');
define('MOVEDIR', 'php/movedir.php');
define('COPYDIR', 'php/copydir.php');
define('RENAMEDIR', 'php/renamedir.php');
define('FILESLIST', 'php/fileslist.php');
define('UPLOAD', 'php/upload.php');
define('DOWNLOAD', 'php/download.php');
define('DOWNLOADDIR', 'php/downloaddir.php');
define('DELETEFILE', 'php/deletefile.php');
define('MOVEFILE', 'php/movefile.php');
define('COPYFILE', 'php/copyfile.php');
define('RENAMEFILE', 'php/renamefile.php');
define('GENERATETHUMB', 'php/thumb.php');
define('DEFAULTVIEW', 'list');
define('FORBIDDEN_UPLOADS', 'js jsp jsb mhtml mht xhtml xht php phtml php3 php4 php5 phps shtml jhtml pl sh py cgi exe scr dll msi vbs bat com pif cmd vxd cpl htpasswd htaccess');
define('ALLOWED_UPLOADS', '');
define('FILEPERMISSIONS', '0644');
define('DIRPERMISSIONS', '0755');
define('LANG', 'auto');
define('DATEFORMAT', 'dd/MM/yyyy HH:mm');
