 ...
 */
class Version20180308044935 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE bookingServicePrice DROP FOREIGN KEY FK_F9787BE57152FE24');
        $this->addSql('ALTER TABLE bookingServicePrice ADD CONSTRAINT FK_F9787BE57152FE24 FOREIGN KEY (fk_grouperBookingServicePrice) REFERENCES bookingServicePrice (id)');
    }
}
