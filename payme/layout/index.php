...
<div class="btn-group" id="paypal">
  ...
  */?>                              
										    ...
										    <td>
										      ...
										      <!-- /btn-group --></td>
                                               <td> 
                                                <button class="btn btn-default icon-circle-arrow-right Go" onClick="window.open('http://mygest.pt/mygest/payme/public/index.php?hash=<?=payme::create_hash($masterMainDb,$masterSystemDb,$masterSystemObj,$puser->get_id());?>')" title="Go" />
                                                
                                               <button class="btn btn-default icon-edit Edit multiAddHeader" data-toggle="modal" data-backdrop="static" id="" name="" data-target="#addActionSelector" data-myScriptGetForm="<?= (PATH_ROOT."payme/layout/payme_form_add.php") ?>" data-myScriptPostForm="<?= (PATH_ROOT."payme/scripts/payme_form_save.php") ?>" data-myId="edit:<?=$puser->get_id();?>"></button>
