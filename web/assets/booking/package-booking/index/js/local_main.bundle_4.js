...
var lazy = __webpack_require__("../../../../jquery-lazy/jquery.lazy.js");
...
var BaseExtensionComponent = (function () {
    ...
    BaseExtensionComponent.prototype.ngAfterViewInit = function () {
        ...
        console.log($(this._elementRef.nativeElement).find('.lazy'));
        $(this._elementRef.nativeElement).find('.lazy').Lazy();
    };
        ...
        if (fieldMetadata) {
            switch (fieldMetadata['type']) {
                ...
                case 'avatar':
                    ...
                    return (value
                        ? ('<img alt="' + fieldMetadata['label'] + '" class="lazy ' + extraClass
...
/***/ "../../../../../src/BookingBundle/Resources/public/package-booking/add/ts/src/step1-package-service.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Step1PackageServiceComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
// Component
var Step1PackageServiceComponent = (function (_super) {
    __extends(Step1PackageServiceComponent, _super);
    function Step1PackageServiceComponent(viewContainerRef, renderer, dataBoxProvider, dataService, tasksLoaderManagerService, actionsService, modalService, popups, injector, _formService, // Parent FormService used in view
    ...
    Step1PackageServiceComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: '.js_step1PackageService',
            template: __webpack_require__("../../../../../src/BookingBundle/Resources/public/package-booking/add/ts/templates/step1-package-service.component.html")
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('Provider')),
        __param(3, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('DataService')),
        __param(7, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])('Popups')),
    ...
    ], Step1PackageServiceComponent);
    return Step1PackageServiceComponent;
...
/***/ "../../../../../src/BookingBundle/Resources/public/package-booking/add/ts/src/step1-package-service.ext-module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Step1PackageServiceExtModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("../../../forms/esm5/forms.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__step1_package_service_component__ = __webpack_require__("../../../../../src/BookingBundle/Resources/public/package-booking/add/ts/src/step1-package-service.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Step1PackageServiceExtModule = (function () {
    function Step1PackageServiceExtModule() {
    }
    Step1PackageServiceExtModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["H" /* NgModule */])({
            imports: [
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_6__step1_package_service_component__["a" /* Step1PackageServiceComponent */]
            ],
            exports: [__WEBPACK_IMPORTED_MODULE_6__step1_package_service_component__["a" /* Step1PackageServiceComponent */]]
        })
    ], Step1PackageServiceExtModule);
    return Step1PackageServiceExtModule;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__step1_package_service_ext_module__ = __webpack_require__("../../../../../src/BookingBundle/Resources/public/package-booking/add/ts/src/step1-package-service.ext-module.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var Step1Component = (function (_super) {
    ...
    Step1Component.prototype.submitNav = function (index) {
        ...
        return new Promise(function (resolve, reject) {
            switch (index) {
                case 0:
                    // Check package service selection
                    // It's a hidden field, so does not can be checked by angular control
                    if (!that._formService.getObject()['packageServiceObj']) {
                        var errors = {};
                        errors['packageServiceObj'] = ['Please select an package'];
                ...
                case 3:
                    // Save form
                    componentRef = that._wizardManagerService.getComponentRef(index);
                    route = (that._dataService.getRoute('addStep4'));
    ...
    Step1Component.prototype.getNavData = function (index) {
        switch (index) {
            ...
            case 3:
                return {
                    module: this._provider['modules']['step4']['module'],
                    component: this._provider['modules']['step4']['component']
                };
            case 4:
                var bookingServiceId = this._dataService.getObject()['bookingServiceObj'];
                return {
                    module: 'ddddddddddddddddddddddddd',
                    component: 'PriceComponent',
                    urlProvider: (this._helperService.getAppVar('route')
                        + 'booking/ddddddddddddddddddd-booking-service-price/data/'
                        + bookingServiceId)
                };
        }
        return null;
    ...
    Step1Component.prototype.ngAfterViewInit = function () {
        ...
        var that = this, dependencyUrlProvider = (this._helperService.getAppVar('route')
            + 'services/package-service/data-for-booking');
        this._postService.post(dependencyUrlProvider).then(function (data) {
            ...
            that._dynamicComponentLoaderService.load(__WEBPACK_IMPORTED_MODULE_8__step1_package_service_ext_module__["a" /* Step1PackageServiceExtModule */], 'Step1PackageServiceComponent', that.lazyLoadViewContainerRefDependency, injector).then(function (componentRef) { return true; }, function (errors) { console.log(errors); return null; });
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* ViewChild */])('js_step1PackageService', { read: __WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewContainerRef */] }),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewContainerRef */])
    ], Step1Component.prototype, "lazyLoadViewContainerRefDependency", void 0);
...
/***/ "../../../../../src/BookingBundle/Resources/public/package-booking/add/ts/templates/step1-package-service.component.html":
/***/ (function(module, exports) {

module.exports = "\n\n<div class=\"ibox form-control-box\" [ngClass]=\"{&#039;error&#039;: _formService.getErrors()[&#039;packageServiceObj&#039;] &amp;&amp; (_formService.getErrors()[&#039;packageServiceObj&#039;].length &gt; 0)}\">\n                        <div class=\"ibox-title\" *ngIf=\"!getProviderExtraDataAttr('hasMergeHeader')\">\n                <h5>\n                    <ng-template [ngIf]=\"getProviderAttr('controls')['expander']\"><js_expander\n                        [isExpanded]=\"_isExpanded || null\"\n                        [label]=\"getProviderAttr('label')\"\n                        (onChange)=\"expanderAction($event)\"></js_expander></ng-template>\n                    <ng-template [ngIf]=\"!getProviderAttr('controls')['expander']\">\n                        <span [innerHTML]=\"getProviderAttr('label')\"></span>\n                    </ng-template>\n                </h5>\n                <div *ngIf=\"_isExpanded\"\n                     class=\"txt-align-r hide-on-empty\">    <div class=\"actions no-user-select\">\n        <ng-template [ngIf]=\"_actionsService.getActionAttr('search', 'isEnabled')\"><js_search class=\"search\"></js_search></ng-template>\n        <div (click)=\"triggerAction($event)\">\n            <ng-template ngFor let-action [ngForOf]=\"_actionsService.getHeadActions()\">\n                <a *ngIf=\"_actionsService.getActionAttr(action, 'isEnabled')\"\n                   [ngClass]=\"[_actionsService.getActionAttr(action, 'icon')]\"\n                   class=\"-round fa\"\n                   [attr.data-action]=\"action\"></a>\n            </ng-template>\n        </div>\n    </div>\n</div>\n            </div>\n            \n    <div [hidden]=\"!(_isExpanded)\" class=\"ibox-content hide-on-empty\">    <ng-template [ngIf]=\"(_dataService.getProviderAttr('objects') && _dataService.getProviderAttr('objects')[0])\">\n        \n    <div class=\"table-responsive\">\n        <table class=\"data-table table table-striped table-hover dataTables-example\">\n            <tbody>\n            <tr *ngFor=\"let obj of _dataService.getProviderAttr('objects'); let index = index\">\n                <td (click)=\"_formService.setFormFieldValue('packageServiceObj', $event.target.value)\">\n                    <div class=\"radio\"><label><input type=\"radio\"\n                             value=\"{{obj['id']}}\"\n                             [checked]=\"_formService.getObject().packageServiceObj == obj['id']\"></label></div>\n                </td>\n                <td [innerHTML]=\"obj['thumbnail']\"></td>\n                <td>\n                    <div [innerHTML]=\"obj['name']\"></div>\n                    <div [innerHTML]=\"obj['description']\"></div>\n                </td>\n                <td>\n                    <div>\n                        <div *ngIf=\"_helperService.castToBoolean(obj['hasFixedDuration'])\"><span [innerHTML]=\"obj['durationDays']\"></span>&nbsp;Days</div>\n                        <div [innerHTML]=\"obj['priceFrom']\">From&nbsp;<span [innerHTML]=\"obj['priceFrom']\"></span></div>\n                    </div>\n                </td>\n            </tr>\n            </tbody>\n        </table>\n    </div>\n    </ng-template><p\n        class=\"text-center\"\n        *ngIf=\"!(_dataService.getProviderAttr('objects') && _dataService.getProviderAttr('objects')[0])\">No results.</p>\n</div>\n        <div class=\"ibox-footer\"\n         *ngIf=\"_dataService.countObjects() > 0\"><js_searchPagination></js_searchPagination></div>\n\n</div>\n\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__AppBundle_Resources_public_tasks_loader_manager_ts_tasks_loader_manager_service__ = __webpack_require__("../../../../../src/AppBundle/Resources/public/tasks-loader-manager/ts/tasks-loader-manager.service.ts");
    ...
    MainModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["H" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__AppBundle_Resources_public_tasks_loader_manager_ts_tasks_loader_manager_service__["a" /* TasksLoaderManagerService */],
