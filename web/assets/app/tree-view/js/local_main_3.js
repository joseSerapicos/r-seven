...
/***/ function(module, exports, __webpack_require__) {
	...
	var tree_view_module_1 = __webpack_require__(30);
	platform_browser_dynamic_1.platformBrowserDynamic().bootstrapModule(tree_view_module_1.TreeViewModule);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tree_view_node_component_1 = __webpack_require__(63);
	var tree_view_component_1 = __webpack_require__(64);
	// Define templateUrl to component at runtime
	helper_1.Helper.setRuntimeVar('templateUrl', _app.local.route['edit']['url']);
	var form_popup_module_1 = __webpack_require__(68);
	    ...
	    TreeViewModule = __decorate([
	        core_1.NgModule({
	            ...
	            providers: [
	                ...
	                { provide: 'TreeViewProvider', useValue: helper_1.Helper.getTreeViewProvider(_app.local) },
	                { provide: 'DataBoxActions', useValue: helper_1.Helper.getDataBoxActions(_app.local) },
	                { provide: 'Popups', useValue: {
	                        module: form_popup_module_1.FormPopupModule,
	                        component: 'FormPopupComponent',
	                        providers: [{ provide: 'FormProvider', useValue: helper_1.Helper.getFormProvider(_app.local) }]
	                    } }
	            ],
	            bootstrap: [tree_view_component_1.TreeViewComponent]
	        }), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataService = (function () {
	     ...
	     * @returns {any}
	     */
	    DataService.prototype.getObjects = function () {
	        return this._dataServiceProvider.objects;
	    };
	    /**
	     * Get field choice
	     * @param field
	    ...
	    DataService.prototype.post = function (url, data) {
	        ...
	        return this._postService.post(url, data).then(function (data) {
	            ...
	            if (data['search'] && (typeof data['search']['hasMore'] != 'undefined')) {
	                that._dataServiceProvider.search.hasMore =
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DynamicLoaderService = (function () {
	     ...
	     *
	     * Handling with return:
	     * DynamicLoaderService.loadModule([parameters]).then(
	     *     componentRef => {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var data_service_1 = __webpack_require__(51);
	var data_box_component_1 = __webpack_require__(65);
	var modal_service_1 = __webpack_require__(58);
	var helper_ts_1 = __webpack_require__(57);
	// Component
	var TreeViewComponent = (function (_super) {
	    __extends(TreeViewComponent, _super);
	    function TreeViewComponent(viewContainerRef, renderer, _treeViewProvider, dataService, modalService, actions, popups, injector) {
	        // Call parent
	        _super.call(this, viewContainerRef, renderer, _treeViewProvider, dataService, modalService, actions, popups, injector);
	    ...
	    TreeViewComponent.prototype.getNodes = function (index) {
	        ...
	        if (index === null) {
	            return this._dataService.getObjects();
	        }
	        return (this._dataService.getObjects()[index] || null);
	    };
	    /**
	     * Toggle expanded
	     * @param index
	    ...
	    TreeViewComponent = __decorate([
	        ...
	        __param(2, core_1.Inject('TreeViewProvider')),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var data_service_1 = __webpack_require__(51);
	var helper_1 = __webpack_require__(57);
	var box_component_1 = __webpack_require__(66);
	// Popup Types
	exports.PopupTypes = {
	    add: 'add',
	    edit: 'edit'
	...
	var DataBoxComponent = (function (_super) {
	    ...
	    DataBoxComponent = __decorate([
	        ...
	        __param(2, core_1.Inject('DataBoxProvider')),
	        __param(5, core_1.Inject('DataBoxActions')),
	        __param(6, core_1.Inject('Popups')), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var base_component_1 = __webpack_require__(67);
	var helper_1 = __webpack_require__(57);
	/**
	 * Box (simple base box)
	 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseComponent = (function () {
	    function BaseComponent(_elementRef, _renderer, _provider // This provider can become any provider defined by your children
	        ) {
	        this._elementRef = _elementRef;
	        this._renderer = _renderer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var auto_complete_component_1 = __webpack_require__(69);
	var password_component_1 = __webpack_require__(70);
	var form_popup_component_1 = __webpack_require__(71);
	var FormPopupModule = (function () {
	    function FormPopupModule() {
	    }
	    FormPopupModule = __decorate([
	        core_1.NgModule({
	    ...
	    return FormPopupModule;
	}());
	exports.FormPopupModule = FormPopupModule;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoCompleteComponent = (function () {
	    function AutoCompleteComponent(_postService, _modalService, _dataService, _injector, _autoCompleteProviders, _helperService) {
	        this._postService = _postService;
	        this._modalService = _modalService;
	        this._dataService = _dataService;
	        this._injector = _injector;
	    ...
	    AutoCompleteComponent.prototype.getChoices = function (forceSubmit) {
	        ...
	        if (((((this._search.term.length > 0) && (this._search.term.length % 3 === 0)) || forceSubmit)
	            ...
	            this._postService.post(this._childDataService.getRoute('choices'), data).then(function (data) {
	    ...
	    AutoCompleteComponent.prototype.openPopup = function ($event, popupType) {
	        ...
	        var popup = this._autoCompleteProvider.popups[popupType] || this._autoCompleteProvider.popups;
	        var unresolvedProviders = [core_1.provide('ParentInjector', { useValue: this._childInjector })];
	        if (popup.provider) {
	            // Get provider value
	            if (!popup.provider.value && this._helperService['get' + popup.provider.name]) {
	                popup.provider.value = this._helperService['get' + popup.provider.name](this._childConf);
	            }
	            unresolvedProviders.push(core_1.provide(popup.provider.name, { useValue: popup.provider.value }));
	        }
	        var resolvedProviders = core_1.ReflectiveInjector.resolve(unresolvedProviders), childInjector = core_1.ReflectiveInjector.fromResolvedProviders(resolvedProviders, this._injector);
	        var that = this;
	        this._modalService.popup(popup.component, childInjector).then(function (data) {
	            // Inject object to edit
	            if (that.object.form[that.field]) {
	                // Simulate object
	                var object = { id: that.object.form[that.field] };
	                data.componentRef.instance._dataService.selectObject(object);
	            }
	            else {
	                // Create a new object
	                data.componentRef.instance._dataService.newObject();
	            }
	            // Reset choices
	    ...
	    AutoCompleteComponent.prototype.getChoiceName = function (choiceId) {
	        if (choiceId == this._lastSelectedChoice['id']) {
	            ...
	            return (choiceId
	                + ' - '
	                + this._dataService.getSelectedObject(true)[this._field]);
	        }
	        else {
	    ...
	    AutoCompleteComponent.prototype.ngOnInit = function () {
	        ...
	        this._field = (this._autoCompleteProvider['field'] || this.field);
	        var that = this;
	        that._postService.post(this._autoCompleteProvider.urlConf, null).then(function (data) {
	            ...
	            var resolvedProviders = core_1.ReflectiveInjector.resolve([
	                data_service_1.DataService,
	                core_1.provide('DataServiceProvider', { useValue: that._helperService.getDataServiceProvider(data) }),
	            ...
	            that._childDataService = that._childInjector.get(data_service_1.DataService);
	            that._childConf = data;
	        }, function (error) {
	            console.log(error);
	            return;
	        });
	    ...
	    AutoCompleteComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [post_service_1.PostService, modal_service_1.ModalService, data_service_1.DataService, core_1.Injector, Object, Object])
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FieldTypePasswordComponent = (function () {
	    function FieldTypePasswordComponent() {
	     ...
	     * @param $event
	     */
	    FieldTypePasswordComponent.prototype.validate = function ($event) {
	        var isValid = (this._fields.password == this._fields.confirm);
	        this.object.form[this.field] = (isValid ? this._fields.password : null);
	        this.errors[this.field] = (isValid ? null : ["Password confirmation does not match"]);
	    };
	    /**
	     * Reset
	     * @param $event
	     */
	    FieldTypePasswordComponent.prototype.reset = function ($event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(58);
	var helper_1 = __webpack_require__(57);
	var form_component_1 = __webpack_require__(72);
	// Component
	var FormPopupComponent = (function (_super) {
	    __extends(FormPopupComponent, _super);
	    function FormPopupComponent(elementRef, renderer, dataBoxFormProvider, helperService, modalService, formBuilder, dataService, parentInjector) {
	        _super.call(this, elementRef, renderer, dataBoxFormProvider, helperService, modalService, formBuilder, dataService, parentInjector);
	        this.dismissEmitter = new core_1.EventEmitter();
	    }
	    /**
	    ...
	    FormPopupComponent = __decorate([
	        ...
	        __param(2, core_1.Inject('FormProvider')),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormComponent = (function (_super) {
	    ...
	    function FormComponent(elementRef, renderer, _dataBoxFormProvider, _helperService, _modalService, formBuilder, dataService, // It's optional, because can be provided by "ParentInjector"
	        parentInjector // parentInjector to provide the correct injector to popups
	        ) {
	        var _this = this;
	        _super.call(this, elementRef, renderer, _dataBoxFormProvider);
	        this._dataBoxFormProvider = _dataBoxFormProvider;
	        this._helperService = _helperService;
	        this._modalService = _modalService;
	        ...
	        this.object = {
	            original: {},
	            form: {},
	            extraFields: this._dataService.getProviderExtraDataAttr('fields') // @TODO remove this
	        };
	        this.errors = {};
