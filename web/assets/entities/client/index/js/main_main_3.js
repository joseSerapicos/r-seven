...
/***/ function(module, exports, __webpack_require__) {
	...
	var form_popup_module_1 = __webpack_require__(71);
	// Entity dependency
	helper_1.Helper.setRuntimeVar('templateUrl', helper_1.Helper.getGlobalVar('route') + 'entities/entity/edit');
	var add_form_popup_module_1 = __webpack_require__(76);
	helper_1.Helper.setRuntimeVar('templateUrl', helper_1.Helper.getGlobalVar('route') + 'entities/entity/edit/0');
	var edit_form_popup_module_1 = __webpack_require__(98);
	var autoCompleteProviders = {
	    entityObj: {
	        ...
	        field: _app.local.extraData.entityObj.field
	    }
	};
	        ...
	        core_1.NgModule({
	            ...
	            providers: [
	                ...
	                { provide: 'Popups', useValue: {
	                        ...
	                        providers: [
	                            { provide: 'Provider', useValue: helper_1.Helper.getFormProvider(_app.local) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var auto_complete_component_1 = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoCompleteComponent = (function () {
	    ...
	    AutoCompleteComponent.prototype.openPopup = function ($event, popupType) {
	        ...
	        if (this.object.form[this.field]) {
	            // Simulate object
	            var object = { id: this.object.form[this.field] };
	            this._childDataService.selectObject(object);
	        }
	        else {
	            // Create a new object in child DataService
	            this._childDataService.newObject();
	        }
	        popupType = (data_box_component_1.PopupTypes[popupType] || data_box_component_1.PopupTypes.edit);
	        var popup = (this._autoCompleteProvider.popups[popupType] || this._autoCompleteProvider.popups), unresolvedProviders = (popup.providers || []), resolvedProviders = core_1.ReflectiveInjector.resolve(unresolvedProviders), childInjector = core_1.ReflectiveInjector.fromResolvedProviders(resolvedProviders, this._childInjector), that = this;
	        this._modalService.popup(popup.module, popup.component, childInjector).then(function (data) {
	            /* You can refresh the objects putting this code in the
	             onSaveObjectEmitter subscription of DataService
	            // Reset choices
	            that._search.lastTerm = null;
	            that.getChoices();*/
	            return;
	        }, function (errors) { console.log(errors); return; });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var add_form_popup_component_1 = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(58);
	var helper_1 = __webpack_require__(57);
	var wizard_form_popup_component_1 = __webpack_require__(78);
	var wizard_manager_service_1 = __webpack_require__(65);
	var nav_manager_service_1 = __webpack_require__(64);
	/* Import dependencies */
	        ...
	        return new Promise(function (resolve, reject) {
	            switch (index) {
	                ...
	                case 3:
	                    ...
	                    return that._wizardManagerService.getComponentRef().instance.save().then(function (data) { return resolve(true); }, function (errors) { console.log(errors); return reject(false); });
	            }
	            // Nothing to do
	            return resolve(true);
	        });
	            ...
	            case 2:
	                return {
	                    ...
	                    urlProvider: (this._helperService.getGlobalVar('route')
	                        + 'entities/entity-note/conf/' + this.object.form['id'])
	                };
	            case 3:
	                return {
	                    ...
	                    urlProvider: (this._helperService.getGlobalVar('route')
	                        + 'entities/entity-entity-group/data/' + this.object.form['id'])
	                };
	        }
	        return null;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var entity_address_popup_component_1 = __webpack_require__(83);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var entity_phone_popup_component_1 = __webpack_require__(85);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var entity_email_popup_component_1 = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var entity_webpage_popup_component_1 = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var expander_module_1 = __webpack_require__(48);
	var search_pagination_module_1 = __webpack_require__(66);
	var note_component_1 = __webpack_require__(91);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var entity_note_popup_component_1 = __webpack_require__(93);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var search_module_1 = __webpack_require__(47);
	var expander_module_1 = __webpack_require__(48);
	var tree_view_form_component_1 = __webpack_require__(95);
	var tree_view_form_node_component_1 = __webpack_require__(97);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var data_box_component_1 = __webpack_require__(68);
	var modal_service_1 = __webpack_require__(58);
	var tree_view_component_1 = __webpack_require__(96);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var edit_form_popup_component_1 = __webpack_require__(99);
