...
/***/ function(module, exports, __webpack_require__) {
	...
	var data_box_form_popup_component_1 = __webpack_require__(390);
	// Entity dependency
	helper_1.Helper.setRuntimeVar('templateUrl', helper_1.Helper.getGlobalVar('route') + 'entities/entity/add');
	var add_form_popup_component_1 = __webpack_require__(393);
	helper_1.Helper.setRuntimeVar('templateUrl', helper_1.Helper.getGlobalVar('route') + 'entities/entity/edit');
	var edit_form_popup_component_1 = __webpack_require__(406);
	var autoCompleteProviders = {
	    entityObj: {
	        urlConf: (helper_1.Helper.getGlobalVar('route') + 'entities/entity/conf'),
	        popup: {
	            add: add_form_popup_component_1.AddFormPopupComponent,
	            edit: edit_form_popup_component_1.EditFormPopupComponent
	        },
	        fieldLabel: 'name'
	    }
	};
	...
	// Bootstrap
	platform_browser_dynamic_1.bootstrap(data_box_component_1.DataBoxComponent, [
	    ...
	    core_1.provide('DataBoxActions', { useValue: helper_1.Helper.getDataBoxActions(_app.local) }),
	    core_1.provide('Popup', { useValue: data_box_form_popup_component_1.DataBoxFormPopupComponent }),
	    core_1.provide('AutoCompleteProviders', { useValue: autoCompleteProviders }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Helper = (function () {
	     ...
	     * @returns {any}
	     */
	    Helper.copyObject = function (object, recursive) {
	     ...
	     * @param data
	     * @returns {{label: (any|string), fields: (any|*|null), fieldsChoices: (any|*|null), search: (any|(function(string): number)|(function(RegExp): number)|string|{criteria: *, fields: *, limit: number, offset: number, orderBy: *}|{fields: *, criteria: *, orderBy: *, limit: number, offset: number}), objects: (any|*|null), route: (any|*|null), extraData: (any|*|null)}}
	     */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(371);
	var data_box_service_1 = __webpack_require__(386);
	var search_pagination_component_1 = __webpack_require__(407);
	...
	var DataBoxComponent = (function () {
	    ...
	    DataBoxComponent.prototype.setActions = function (actions) {
	        this._actions = {
	            actions: actions,
	            head: {
	                available: ['deleteAll', 'add', 'checkAll'],
	                enabled: []
	            },
	            body: {
	        ...
	        for (var _i = 0, _a = this._actions.head.available; _i < _a.length; _i++) {
	            var action = _a[_i];
	            if (actions.getActionAttr(action, 'isEnabled')) {
	        ...
	        // Set default values
	        this._collapsed = actions.getActionAttr('collapse', 'isEnabled');
	        this.checkAll = false;
	        return this;
	    };
	    /**
	     ...
	     * @param $event
	     */
	    DataBoxComponent.prototype.collapseAction = function ($event) {
	        if ($event === void 0) { $event = null; }
	        if ($event) {
	            $event.preventDefault();
	        }
	        this._collapsed = !this._collapsed;
	        this._actions.actions.setActionAttr('collapse', 'icon', this._collapsed
	            ? this._actions.actions.getActionAttr('collapse', 'collapsedIcon')
	            : this._actions.actions.getActionAttr('collapse', 'notCollapsedIcon'));
	    };
	    /**
	     ...
	     * @returns {DataBoxComponent}
	     */
	    DataBoxComponent.prototype.refreshObjects = function ($event) {
	        $event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(371);
	var helper_1 = __webpack_require__(387);
	var data_box_form_component_1 = __webpack_require__(391);
	var auto_complete_component_1 = __webpack_require__(392);
	// Component
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataBoxFormComponent = (function () {
	    ...
	    DataBoxFormComponent.prototype.setObject = function (object) {
	        ...
	        this.object.form = helper_1.Helper.copyObject(this.object.original);
	        return this;
	    };
	    /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var post_service_1 = __webpack_require__(370);
	var helper_1 = __webpack_require__(387);
	var data_box_form_wizard_popup_component_1 = __webpack_require__(394);
	var data_box_compact_view_component_1 = __webpack_require__(395);
	var data_box_note_component_1 = __webpack_require__(396);
	// Dependencies
	var tmpTemplateUrl = helper_1.Helper.getRuntimeVar('templateUrl'); // Save last templateUrl
	// EntityAddress
	helper_1.Helper.setRuntimeVar('templateUrl', helper_1.Helper.getGlobalVar('route') + 'entities/entity-address/edit/0');
	var entity_address_popup_component_1 = __webpack_require__(397);
	// EntityPhone
	helper_1.Helper.setRuntimeVar('templateUrl', helper_1.Helper.getGlobalVar('route') + 'entities/entity-phone/edit/0');
	var entity_phone_popup_component_1 = __webpack_require__(398);
	// EntityEmail
	helper_1.Helper.setRuntimeVar('templateUrl', helper_1.Helper.getGlobalVar('route') + 'entities/entity-email/edit/0');
	var entity_email_popup_component_1 = __webpack_require__(399);
	// EntityWebpage
	helper_1.Helper.setRuntimeVar('templateUrl', helper_1.Helper.getGlobalVar('route') + 'entities/entity-webpage/edit/0');
	var entity_webpage_popup_component_1 = __webpack_require__(400);
	// EntityNote
	helper_1.Helper.setRuntimeVar('templateUrl', helper_1.Helper.getGlobalVar('route') + 'entities/entity-note/edit/0');
	var entity_note_popup_component_1 = __webpack_require__(401);
	// EntityEntityGroup
	helper_1.Helper.setRuntimeVar('templateUrl', helper_1.Helper.getGlobalVar('route') + 'entities/entity-entity-group/edit/0');
	var data_box_tree_view_form_component_1 = __webpack_require__(402);
	...
	var AddFormPopupComponent = (function (_super) {
	    ...
	    function AddFormPopupComponent(dataBoxService, modalService, formBuilder, elementRef, parentInjector, _postService, _dynamicComponentLoader) {
	        // Call parent
	        _super.call(this, dataBoxService, modalService, formBuilder, elementRef, parentInjector);
	        this._postService = _postService;
	        this._dynamicComponentLoader = _dynamicComponentLoader;
	     ...
	     *
	     * Handle response:
	     * this.changeStep.then(data => {
	     *     // Success
	     * }, error => {
	     *     // Fail
	     * });
	     */
	    AddFormPopupComponent.prototype.changeStep = function () {
	        var that = this;
	        this.errors = {};
	        return new Promise(function (resolve, reject) {
	            switch (that._step) {
	                case 0:
	                    that.save().then(function (data) {
	                        if (!helper_1.Helper.inArray(that._step, that._loadedSteps)) {
	                            // Load dependencies
	                            Promise.all([
	                                that.loadDependency(data_box_compact_view_component_1.DataBoxCompactViewComponent, entity_address_popup_component_1.EntityAddressPopupComponent, 'entities/entity-address', 'js_step1_0_viewContainerRef'),
	                                that.loadDependency(data_box_compact_view_component_1.DataBoxCompactViewComponent, entity_phone_popup_component_1.EntityPhonePopupComponent, 'entities/entity-phone', 'js_step1_1_viewContainerRef'),
	                                that.loadDependency(data_box_compact_view_component_1.DataBoxCompactViewComponent, entity_email_popup_component_1.EntityEmailPopupComponent, 'entities/entity-email', 'js_step1_2_viewContainerRef'),
	                                that.loadDependency(data_box_compact_view_component_1.DataBoxCompactViewComponent, entity_webpage_popup_component_1.EntityWebpagePopupComponent, 'entities/entity-webpage', 'js_step1_3_viewContainerRef')
	                            ]).then(function (data) {
	                                ...
	                                // Load with success
	                                that._loadedSteps.push(that._step);
	                                return resolve(true);
	                            }, function (error) {
	                                return reject(false);
	                            });
	                ...
	                case 1:
	                    if (!helper_1.Helper.inArray(that._step, that._loadedSteps)) {
	                        // Load dependency
	                        that.loadDependency(data_box_note_component_1.DataBoxNoteComponent, entity_note_popup_component_1.EntityNotePopupComponent, 'entities/entity-note').then(function (data) {
	                            if (data) {
	                                that._loadedSteps.push(that._step);
	                                return resolve(true);
	                            }
	                ...
	                case 2:
	                    if (!helper_1.Helper.inArray(that._step, that._loadedSteps)) {
	                        // Load dependency
	                        that.loadDependency(data_box_tree_view_form_component_1.DataBoxTreeViewFormComponent, null, 'entities/entity-entity-group').then(function (data) {
	                            if (data) {
	                                that._loadedSteps.push(that._step);
	                                return resolve(true);
	                            }
	     ...
	     */
	    AddFormPopupComponent.prototype.loadDependency = function (component, popupComponent, path, viewContainerRef_name) {
	        if (viewContainerRef_name === void 0) { viewContainerRef_name = null; }
	        viewContainerRef_name = viewContainerRef_name
	            ? viewContainerRef_name : ('js_step' + (this._step + 1) + '_viewContainerRef');
	        var that = this;
	        return that._postService.post(helper_1.Helper.getGlobalVar('route') + path + '/data/' + that.object.form['id'], null).then(function (data) {
	            // Inject dependencies
	            var injector = null;
	            switch (that._step) {
	                default:
	            ...
	            return that._dynamicComponentLoader.loadNextToLocation(component, that[viewContainerRef_name], // Load the next step (current +1)
	    ...
	    __decorate([
	        core_1.ViewChild('js_step1_0', { read: core_1.ViewContainerRef }), 
	        __metadata('design:type', core_1.ViewContainerRef)
	    ], AddFormPopupComponent.prototype, "js_step1_0_viewContainerRef", void 0);
	    __decorate([
	        core_1.ViewChild('js_step1_1', { read: core_1.ViewContainerRef }), 
	        __metadata('design:type', core_1.ViewContainerRef)
	    ], AddFormPopupComponent.prototype, "js_step1_1_viewContainerRef", void 0);
	    __decorate([
	        core_1.ViewChild('js_step1_2', { read: core_1.ViewContainerRef }), 
	        __metadata('design:type', core_1.ViewContainerRef)
	    ], AddFormPopupComponent.prototype, "js_step1_2_viewContainerRef", void 0);
	    __decorate([
	        core_1.ViewChild('js_step1_3', { read: core_1.ViewContainerRef }), 
	        __metadata('design:type', core_1.ViewContainerRef)
	    ], AddFormPopupComponent.prototype, "js_step1_3_viewContainerRef", void 0);
	    __decorate([
	        core_1.ViewChild('js_step2', { read: core_1.ViewContainerRef }), 
	        __metadata('design:type', core_1.ViewContainerRef)
	    ], AddFormPopupComponent.prototype, "js_step2_viewContainerRef", void 0);
	    __decorate([
	        core_1.ViewChild('js_step3', { read: core_1.ViewContainerRef }), 
	        __metadata('design:type', core_1.ViewContainerRef)
	    ], AddFormPopupComponent.prototype, "js_step3_viewContainerRef", void 0);
	    AddFormPopupComponent = __decorate([
	        ...
	        __param(4, core_1.Inject('ParentInjector')), 
	        __metadata('design:paramtypes', [data_box_service_1.DataBoxService, modal_service_1.ModalService, forms_1.FormBuilder, core_1.ElementRef, core_1.Injector, post_service_1.PostService, core_1.DynamicComponentLoader])
	    ], AddFormPopupComponent);
	    return AddFormPopupComponent;
	}(data_box_form_wizard_popup_component_1.DataBoxFormWizardPopupComponent));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(371);
	// Component
	var DataBoxFormWizardPopupComponent = (function (_super) {
	    __extends(DataBoxFormWizardPopupComponent, _super);
	    function DataBoxFormWizardPopupComponent(dataBoxService, modalService, formBuilder, elementRef, parentInjector) {
	        // Call parent
	        _super.call(this, dataBoxService, modalService, formBuilder, elementRef, parentInjector);
	        this._step = 0;
	    }
	     ...
	     * @param closePopup
	     */
	    DataBoxFormWizardPopupComponent.prototype.next = function ($event, closePopup) {
	        var _this = this;
	        if ($event === void 0) { $event = null; }
	        if (closePopup === void 0) { closePopup = false; }
	        if ($event) {
	     ...
	     * @param $event
	     */
	    DataBoxFormWizardPopupComponent.prototype.prev = function ($event) {
	        if ($event === void 0) { $event = null; }
	        if ($event) {
	            $event.preventDefault();
	        }
	     ...
	     * });
	     */
	    DataBoxFormWizardPopupComponent.prototype.changeStep = function () {
	        var that = this;
	        this.errors = {};
	        return new Promise(function (resolve, reject) {
	            switch (that._step) {
	    ...
	    DataBoxFormWizardPopupComponent = __decorate([
	        core_1.Component({
	            selector: 'js_dataBoxFormPopup',
	            templateUrl: helper_1.Helper.getRuntimeVar('templateUrl'),
	            directives: [forms_1.FORM_DIRECTIVES, forms_1.REACTIVE_FORM_DIRECTIVES, ng2_bs3_modal_1.MODAL_DIRECTIVES]
	        ...
	        __param(4, core_1.Inject('ParentInjector')), 
	        __metadata('design:paramtypes', [data_box_service_1.DataBoxService, modal_service_1.ModalService, forms_1.FormBuilder, core_1.ElementRef, core_1.Injector])
	    ], DataBoxFormWizardPopupComponent);
	    return DataBoxFormWizardPopupComponent;
	}(data_box_form_popup_component_1.DataBoxFormPopupComponent));
	exports.DataBoxFormWizardPopupComponent = DataBoxFormWizardPopupComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(371);
	// Component
	var DataBoxCompactViewComponent = (function (_super) {
	    __extends(DataBoxCompactViewComponent, _super);
	    function DataBoxCompactViewComponent(dataBoxService, modalService, actions, popup, viewContainerRef, injector) {
	        // Call parent
	        _super.call(this, dataBoxService, modalService, actions, popup, viewContainerRef, injector);
	    }
	    DataBoxCompactViewComponent = __decorate([
	        core_1.Component({
	            selector: '.js_dataBox',
	            //providers: [DataBoxService, ...] (injected at bootstrap to have one instance for all application)
	            template: "\n    <div class=\"ibox -compact-view float-e-margins\">\n        <div class=\"ibox-title no-user-select\">\n            <h5>{{_dataBoxService.getLabel()}}<a *ngIf=\"_actions.actions.getActionAttr('collapse', 'isEnabled')\"\n                [ngClass]=\"[_actions.actions.getActionAttr('collapse', 'class')]\"\n                (click)=\"triggerAction($event, 'collapse', null)\"><i [ngClass]=\"['fa', _actions.actions.getActionAttr('collapse', 'icon')]\"></i></a>\n            </h5>\n            <div *ngIf=\"!_collapsed\" class=\"ibox-tools\">\n                <a (click)=\"refreshObjects($event)\"><i class=\"fa fa-refresh\"></i></a>\n                <a class=\"dropdown-toggle\" data-toggle=\"dropdown\" href=\"#\">\n                    <i class=\"fa fa-wrench\"></i>\n                </a>\n                <ul class=\"dropdown-menu dropdown-user\">\n                    <li><a href=\"#\">Config option 1</a>\n                    </li>\n                    <li><a href=\"#\">Config option 2</a>\n                    </li>\n                </ul>\n                <a><i class=\"fa fa-download\"></i></a>\n                <a *ngFor=\"let action of _actions.head.enabled\"\n                   [ngClass]=\"[_actions.actions.getActionAttr(action, 'class')]\"\n                   (click)=\"triggerAction($event, action, null)\"><i [ngClass]=\"['fa', _actions.actions.getActionAttr(action, 'icon')]\"></i></a>\n            </div>\n        </div>\n        <div *ngIf=\"!_collapsed\" class=\"ibox-content\">\n            <div class=\"table-responsive\">\n                <form>\n                <table class=\"data-table table table-striped table-bordered table-hover dataTables-example\">\n                <thead>\n                    <tr>\n                        <th *ngFor=\"let searchField of _dataBoxService.getSearchFields()\">{{ _dataBoxService.getFields()[searchField].label }}</th>\n                        <th>&nbsp;</th>\n                    </tr>\n                </thead>\n                <tbody>\n                    <tr *ngFor=\"let obj of _dataBoxService.getObjects()\" (dblclick)=\"selectObject(obj)\">\n                        <td *ngFor=\"let searchField of _dataBoxService.getSearchFields()\" [innerHTML]=\"obj[searchField]\"></td>\n                        <td class=\"tools\">\n                            <div class=\"ibox-tools no-user-select\">\n                                <a *ngFor=\"let action of _actions.body.enabled\"\n                                   (click)=\"triggerAction($event, action, obj)\"><i [ngClass]=\"['fa', _actions.actions.getActionAttr(action, 'icon')]\"></i></a>\n                                <input type=\"checkbox\" name=\"id[]\" value=\"{{ obj['id'] }}\" [ngModel]=\"checkAll\"/>\n                            </div>\n                        </td>\n                    </tr>\n                </tbody>\n                <tfoot *ngIf=\"_dataBoxService.getConfAttr('search')['hasMore']\">\n                    <tr><th [attr.colspan]=\"_dataBoxService.getSearchFields().length +1\"\n                            (click)=\"getMoreObjects($event)\"\n                            class=\"search-has-more\"\n                            title=\"Load more results...\"><div><span>...</span></div></th></tr>\n                </tfoot>\n                </table>\n                </form>\n            </div>\n        </div>\n    </div>\n    "
	        }),
	        __param(2, core_1.Inject('DataBoxActions')),
	        __param(3, core_1.Inject('Popup')), 
	    ...
	    ], DataBoxCompactViewComponent);
	    return DataBoxCompactViewComponent;
	}(data_box_component_1.DataBoxComponent));
	exports.DataBoxCompactViewComponent = DataBoxCompactViewComponent;
	...
	var DataBoxNoteComponent = (function (_super) {
	    ...
	    DataBoxNoteComponent = __decorate([
	        core_1.Component({
	            ...
	            template: "\n    <div class=\"ibox -compact-view float-e-margins\">\n        <div class=\"ibox-title no-user-select\">\n            <h5>{{_dataBoxService.getLabel()}}<a *ngIf=\"_actions.actions.getActionAttr('collapse', 'isEnabled')\"\n                [ngClass]=\"[_actions.actions.getActionAttr('collapse', 'class')]\"\n                (click)=\"triggerAction($event, 'collapse', null)\"><i [ngClass]=\"['fa', _actions.actions.getActionAttr('collapse', 'icon')]\"></i></a>\n            </h5>\n            <div *ngIf=\"!_collapsed\" class=\"ibox-tools\">\n                <a (click)=\"refreshObjects($event)\"><i class=\"fa fa-refresh\"></i></a>\n                <a *ngFor=\"let action of _actions.head.enabled\"\n                   [ngClass]=\"[_actions.actions.getActionAttr(action, 'class')]\"\n                   (click)=\"triggerAction($event, action, null)\"><i [ngClass]=\"['fa', _actions.actions.getActionAttr(action, 'icon')]\"></i></a>\n            </div>\n        </div>\n        <div *ngIf=\"!_collapsed\" class=\"ibox-content\">\n            <div class=\"row\">\n                <ul class=\"notes\">\n                    <li class=\"col-sm-6 col-md-4\" *ngFor=\"let obj of _dataBoxService.getObjects()\">\n                        <div (dblclick)=\"selectObject(obj)\">\n                            <small>{{obj['insertTime']}}</small>\n                            <h4>{{obj['name']}}</h4>\n                            <p>{{obj['description']}}</p>\n                            <span class=\"ibox-tools no-user-select\"><a class=\"action badge\"\n                                *ngFor=\"let action of _actions.body.enabled\"\n                                (click)=\"triggerAction($event, action, obj)\"><i [ngClass]=\"['fa', _actions.actions.getActionAttr(action, 'icon')]\"></i></a>\n                            </span>\n                        </div>\n                    </li>\n                    <a class=\"col-sm-6 col-md-4 search-has-more -note\"\n                        *ngIf=\"_dataBoxService.getConfAttr('search')['hasMore']\"\n                        (click)=\"getMoreObjects($event)\"\n                        href=\"#\"\n                        title=\"Load more results...\"><div><span>...</span></div>\n                    </a>\n                </ul>\n            </div>\n        </div>\n    </div>\n    "
	        }),
	        __param(2, core_1.Inject('DataBoxActions')),
	        __param(3, core_1.Inject('Popup')), 
	        __metadata('design:paramtypes', [data_box_service_1.DataBoxService, modal_service_1.ModalService, data_box_component_1.DataBoxActions, Object, core_1.ViewContainerRef, core_1.Injector])
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(371);
	var helper_1 = __webpack_require__(387);
	var data_box_tree_view_component_1 = __webpack_require__(403);
	var data_box_tree_view_form_node_component_1 = __webpack_require__(405);
	// Component
	    ...
	    DataBoxTreeViewFormComponent.prototype.setNodes = function (objects) {
	        ...
	        for (var objsKey in objects) {
	            ...
	            for (var objKey in objects[objsKey]) {
	                this.nodes[objsKey].push(helper_1.Helper.copyObject(objects[objsKey][objKey]));
	            }
	        }
	        return this;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var data_box_component_1 = __webpack_require__(388);
	var modal_service_1 = __webpack_require__(371);
	var data_box_tree_view_node_component_1 = __webpack_require__(404);
	// Component
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditFormPopupComponent = (function (_super) {
	    ...
	    function EditFormPopupComponent(dataBoxService, modalService, formBuilder, elementRef, parentInjector) {
	        // Call parent
	        _super.call(this, dataBoxService, modalService, formBuilder, elementRef, parentInjector);
	    }
