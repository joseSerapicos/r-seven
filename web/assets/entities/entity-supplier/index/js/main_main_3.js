...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataBoxService = (function () {
	     ...
	     * @returns {DataBoxService}
	     */
	    DataBoxService.prototype.setObjects = function (objects) {
	    ...
	    DataBoxService.prototype.refresh = function () {
	        var that = this;
	        this._postService.post(this._dataBoxProvider.route['get']['url'], that.getRequestData()).then(function (data) {
	            // Update list of objects
	            that.setObjects(data.objects || null);
	            that.setFieldsChoices(data.fieldsChoices || null);
	        }, function (errors) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(371);
	var helper_1 = __webpack_require__(387);
	var data_box_form_component_1 = __webpack_require__(390);
	var auto_complete_component_1 = __webpack_require__(391);
	// Component
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoCompleteComponent = (function () {
	     ...
	     * @param $event
	     */
	    AutoCompleteComponent.prototype.getMore = function ($event) {
	        $event.preventDefault();
	        $event.stopPropagation();
	        this._search.offset++;
	        this.getChoices();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var post_service_1 = __webpack_require__(370);
	var helper_1 = __webpack_require__(387);
	var data_box_form_wizard_popup_component_1 = __webpack_require__(393);
	var data_box_compact_view_component_1 = __webpack_require__(394);
	var data_box_note_component_1 = __webpack_require__(395);
	// Dependencies
	...
	var AddFormPopupComponent = (function (_super) {
	    ...
	    AddFormPopupComponent.prototype.loadDependency = function (component, popupComponent, path, viewContainerRef_name) {
	        ...
	        var that = this;
	        return that._postService.post(helper_1.Helper.getGlobalVar('route') + path + '/conf/' + that.object.form['id'], null).then(function (data) {
	            // Inject dependencies
	            var injector = null;
	            switch (that._step) {
	                default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(371);
	var helper_1 = __webpack_require__(387);
	var data_box_tree_view_component_1 = __webpack_require__(402);
	var data_box_tree_view_form_node_component_1 = __webpack_require__(404);
	// Component
...
/***/ function(module, exports, __webpack_require__) {
	...
	var data_box_component_1 = __webpack_require__(388);
	var modal_service_1 = __webpack_require__(371);
	var data_box_tree_view_node_component_1 = __webpack_require__(403);
	// Component
