...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(50);
	var dynamic_loader_service_1 = __webpack_require__(51);
	var form_component_1 = __webpack_require__(58);
	var entity_detail_module_1 = __webpack_require__(59);
	// Component
	var MainComponent = (function (_super) {
	    __extends(MainComponent, _super);
	    function MainComponent(elementRef, renderer, provider, helperService, modalService, formBuilder, dataService, parentInjector, _dynamicLoaderService, viewContainerRef, _injector) {
	        _super.call(this, elementRef, renderer, provider, helperService, modalService, formBuilder, dataService, parentInjector);
	        this._dynamicLoaderService = _dynamicLoaderService;
	        this._injector = _injector;
	        this._entityDetailComponentRef = null;
	     ...
	     */
	    MainComponent.prototype.loadContent = function ($event) {
	        $event.preventDefault();
	        if (this._entityDetailComponentRef) {
	            this.setUser();
	        }
	        else {
	            var that_1 = this, data = this._helperService.getGlobalVar('dependency')['user']['data'], resolvedProviders = core_1.ReflectiveInjector.resolve([
	                data_service_1.DataService,
	                { provide: 'DataServiceProvider', useValue: this._helperService.getDataServiceProvider(data) },
	                { provide: 'BoxProvider', useValue: this._helperService.getBoxProvider(data) }
	            ]), childInjector = core_1.ReflectiveInjector.fromResolvedProviders(resolvedProviders, this._injector);
	            // Load component
	            this._dynamicLoaderService.load(entity_detail_module_1.EntityDetailModule, 'EntityDetailComponent', this.entityDetailView, childInjector).then(function (componentRef) {
	                that_1._entityDetailComponentRef = componentRef;
	                that_1.setUser();
	            }, function (errors) { console.log(errors); });
	        }
	    };
	     ...
	     */
	    MainComponent.prototype.setUser = function () {
	        var candidateSearch = this._entityDetailComponentRef.instance._dataService.getCandidateSearch();
	        candidateSearch['criteria'] = [{
	                field: 'id',
	                expr: 'eq',
	                value: this.object.form['userObj']
	            }];
	        this._entityDetailComponentRef.instance._dataService.search();
	        // Send user and user-acl at same time in order to avoid two connections
	        return this;
	    };
	    __decorate([
	        core_1.ViewChild('js_entityDetail', { read: core_1.ViewContainerRef }), 
	        __metadata('design:type', core_1.ViewContainerRef)
	    ], MainComponent.prototype, "entityDetailView", void 0);
	    MainComponent = __decorate([
	        core_1.Component({
	            selector: '#js_headForm',
	            templateUrl: helper_1.Helper.getGlobalVar('route') + 'admin/user-acl/edit'
	        }),
	        ...
	        __metadata('design:paramtypes', [core_1.ElementRef, core_1.Renderer, Object, Object, modal_service_1.ModalService, forms_1.FormBuilder, data_service_1.DataService, core_1.Injector, dynamic_loader_service_1.DynamicLoaderService, core_1.ViewContainerRef, core_1.Injector])
	    ], MainComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var data_service_1 = __webpack_require__(56);
	var box_component_1 = __webpack_require__(61);
	var helper_1 = __webpack_require__(47);
	// Component
	var EntityDetailComponent = (function (_super) {
	    __extends(EntityDetailComponent, _super);
	    function EntityDetailComponent(elementRef, renderer, boxProvider, _dataService, _helperService) {
	        var _this = this;
	        // Call parent
	        _super.call(this, elementRef, renderer, boxProvider);
	        ...
	        this._onObjectsChangeSubscription = this._dataService.getOnObjectsChangeEmitter()
	            .subscribe(function (objects) { return _this.refresh(); });
	        this.refresh();
	    }
	    /**
	     * Refresh
	     * @returns {EntityDetailComponent}
	     */
	     ...
	     * @returns {any|Array}
	     */
	    EntityDetailComponent.prototype.getFields = function () {
	        return (this._dataService.getProviderAttr('fields') || []);
	    };
	    /**
	     * Get object
	     * @returns {any|Array}
	     */
	    EntityDetailComponent.prototype.getObject = function () {
	        // @TODO use the select object instead!
	        var objects = (this._dataService.getProviderAttr('objects') || []);
	    ...
	    EntityDetailComponent = __decorate([
	        core_1.Component({
	            ...
	            template: helper_1.Helper.getGlobalVar('route') + 'admin/user-acl/entity-detail'
	        }),
	        __param(2, core_1.Inject('BoxProvider')),
	        __param(4, core_1.Inject('HelperService')), 
	        __metadata('design:paramtypes', [core_1.ElementRef, core_1.Renderer, Object, data_service_1.DataService, Object])
