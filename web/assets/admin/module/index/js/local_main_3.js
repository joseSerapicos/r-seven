...
/***/ function(module, exports, __webpack_require__) {
	...
	var nav_manager_service_1 = __webpack_require__(76);
	var wizard_manager_service_1 = __webpack_require__(75);
	var data_service_1 = __webpack_require__(56);
	var search_module_1 = __webpack_require__(57);
	var search_pagination_component_1 = __webpack_require__(64);
	...
	var form_popup_module_1 = __webpack_require__(67);
	helper_1.Helper.setRuntimeVar('templateUrl', _app.local.route['add']['url']);
	var add_form_popup_module_1 = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var expander_module_1 = __webpack_require__(58);
	var search_fields_component_1 = __webpack_require__(60);
	var search_order_by_component_1 = __webpack_require__(61);
	var search_criteria_component_1 = __webpack_require__(62);
	var search_component_1 = __webpack_require__(63);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var auto_complete_component_1 = __webpack_require__(68);
	var password_component_1 = __webpack_require__(69);
	var form_popup_component_1 = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoCompleteComponent = (function () {
	    ...
	    AutoCompleteComponent.prototype.openPopup = function ($event, popupType) {
	        ...
	        var popup = (this._autoCompleteProvider.popups[popupType] || this._autoCompleteProvider.popups), unresolvedProviders = (popup.providers || []), resolvedProviders = core_1.ReflectiveInjector.resolve(unresolvedProviders), childInjector = core_1.ReflectiveInjector.fromResolvedProviders(resolvedProviders, this._injector), that = this;
	        this._modalService.popup(popup.module, popup.component, childInjector).then(function (data) {
	    ...
	    AutoCompleteComponent.prototype.ngOnInit = function () {
	        ...
	        that._postService.post(this._autoCompleteProvider.urlConf, null).then(function (data) {
	            ...
	            var resolvedProviders = core_1.ReflectiveInjector.resolve([
	                ...
	                { provide: 'ParentInjector', useValue: null }
	            ]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var modal_service_1 = __webpack_require__(50);
	var helper_1 = __webpack_require__(47);
	var form_component_1 = __webpack_require__(71);
	// Component
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var add_form_popup_component_1 = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helper_1 = __webpack_require__(47);
	var post_service_1 = __webpack_require__(49);
	var wizard_form_popup_component_1 = __webpack_require__(74);
	var wizard_manager_service_1 = __webpack_require__(75);
	var modal_service_1 = __webpack_require__(50);
	var AddFormPopupComponent = (function (_super) {
	    __extends(AddFormPopupComponent, _super);
	    function AddFormPopupComponent(elementRef, renderer, provider, helperService, modalService, formBuilder, dataService, parentInjector, wizardManagerService, _postService) {
	        // Call parent
	        ...
	        return new Promise(function (resolve, reject) {
	            switch (index) {
	                case 0:
	                    ...
	                    if (that.form.controls[appDependencyFieldKey].valid) {
	                        return resolve(true);
	                    }
	                    else {
	                        that.errors[appDependencyFieldKey] = ['Please select an option'];
	                        return reject(false);
	                    }
	                case 1:
	                    return that.save().then(function (data) { return resolve(true); }, function (errors) { return reject(false); });
	            }
	            // Nothing to do
	            return resolve(true);
	        });
	    ...
	    /**
	     * Set form field value (overrides original function to save appDependency)
	     * @param field
	     * @param value
	     */
	    AddFormPopupComponent.prototype.setFormFieldValue = function (field, value) {
	        if (field != this._dataService.getProviderExtraDataAttr('appDependencyFieldKey')) {
	            // Default behavior
	            return _super.prototype.setFormFieldValue.call(this, field, value);
	        }
	        else {
	            // Specific behavior for "appDependency"
	            if (!value || (this.object.form[field] == value)) {
	                return;
	            }
	            var that_1 = this;
	            this.object.form[field] = value;
	            // Get original app dependency object
	            that_1._postService.post((that_1._dataService.getProviderExtraDataAttr('appDependencyRouteGetUrl') + '/' + value), null).then(function (data) {
	                data.object = data.object || null;
	                for (var _i = 0, _a = ['name', 'priority', 'isEnabled']; _i < _a.length; _i++) {
	                    var field_1 = _a[_i];
	                    if ((field_1 in that_1.object.form) && (field_1 in data.object)) {
	                        that_1.object.form[field_1] = data.object[field_1];
	                    }
	                }
	            }, function (errors) {
	                console.log(errors);
	    ...
	    AddFormPopupComponent = __decorate([
	        ...
	        __param(7, core_1.Optional()),
	        __param(7, core_1.Inject('ParentInjector')), 
	        __metadata('design:paramtypes', [core_1.ElementRef, core_1.Renderer, Object, Object, modal_service_1.ModalService, forms_1.FormBuilder, data_service_1.DataService, core_1.Injector, wizard_manager_service_1.WizardManagerService, post_service_1.PostService])
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavManagerService = (function () {
	     ...
	     * @returns {Promise<boolean>}
	     */
	    NavManagerService.prototype.navTo = function (index) {
	        var that = this;
	        return new Promise(function (resolve, reject) {
	            // Send current container to validation before load the other one
	            if (that._component['submitNav']) {
