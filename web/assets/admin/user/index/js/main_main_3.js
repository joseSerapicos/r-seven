...
/***/ function(module, exports, __webpack_require__) {
	...
	var edit_form_popup_module_1 = __webpack_require__(80);
	    ...
	    AddFormPopupComponent.prototype.submitNav = function (index) {
	        ...
	        return new Promise(function (resolve, reject) {
	            switch (index) {
	                ...
	                case 2:
	                    // Save form
	                    var componentRef = that._wizardManagerService.getComponentRef(index), $form = $(componentRef.instance._elementRef.nativeElement).find('form'), password_1 = ($form.find('.password').val() || null);
	                    // Save form
	                    if (password_1 != that._lastSavedPassword) {
	                        var data = $form.serialize(), id = componentRef.instance.object.form['id'], url = (that._helperService.getGlobalVar('route') + 'admin/user/edit-password/' + id);
	                        return componentRef.instance._dataService.save(data, id, url).then(function (data) {
	                            that._lastSavedPassword = password_1;
	                            return resolve(true);
	                        }, function (errors) { console.log(errors); return reject(false); });
	                    }
	                    else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var common_1 = __webpack_require__(23);
	var forms_1 = __webpack_require__(31);
	var field_type_password_module_1 = __webpack_require__(93);
	var add_form_password_component_1 = __webpack_require__(79);
	var AddFormPasswordModule = (function () {
	    function AddFormPasswordModule() {
	    }
	    AddFormPasswordModule = __decorate([
	        core_1.NgModule({
	            imports: [common_1.CommonModule, forms_1.FormsModule, forms_1.ReactiveFormsModule, field_type_password_module_1.FieldTypePasswordModule],
	            declarations: [
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddFormPasswordComponent = (function (_super) {
	    ...
	    function AddFormPasswordComponent(elementRef, renderer, provider, helperService, modalService, formBuilder, dataService, // It's optional, because can be provided by "ParentInjector"
	        parentInjector // parentInjector to provide the correct injector to popups
	        ) {
	        _super.call(this, elementRef, renderer, provider, helperService, modalService, formBuilder, dataService, parentInjector);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var field_type_password_module_1 = __webpack_require__(93);
	var edit_form_popup_component_1 = __webpack_require__(81);
	var EditFormPopupModule = (function () {
	    function EditFormPopupModule() {
	    }
	    EditFormPopupModule = __decorate([
	        core_1.NgModule({
	            imports: [common_1.CommonModule, forms_1.FormsModule, forms_1.ReactiveFormsModule, ng2_bs3_modal_1.Ng2Bs3ModalModule, field_type_password_module_1.FieldTypePasswordModule],
	            declarations: [
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var search_module_1 = __webpack_require__(47);
	var contacts_component_1 = __webpack_require__(83);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var helper_1 = __webpack_require__(57);
	var accordion_component_1 = __webpack_require__(84);
	var nav_manager_service_1 = __webpack_require__(64);
	var data_box_extension_module_1 = __webpack_require__(70);
	var data_service_1 = __webpack_require__(51);
	/* Import dependencies */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var entity_address_popup_component_1 = __webpack_require__(86);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var entity_phone_popup_component_1 = __webpack_require__(88);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var entity_email_popup_component_1 = __webpack_require__(90);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forms_1 = __webpack_require__(31);
	var ng2_bs3_modal_1 = __webpack_require__(35);
	var entity_webpage_popup_component_1 = __webpack_require__(92);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FieldTypePasswordModule = (function () {
	    function FieldTypePasswordModule() {
	    }
	    FieldTypePasswordModule = __decorate([
	        core_1.NgModule({
	            imports: [common_1.CommonModule, forms_1.FormsModule],
	            declarations: [
	                password_component_1.FieldTypePasswordComponent
	            ],
	            exports: [password_component_1.FieldTypePasswordComponent]
	        }), 
	        __metadata('design:paramtypes', [])
	    ], FieldTypePasswordModule);
	    return FieldTypePasswordModule;
	}());
	exports.FieldTypePasswordModule = FieldTypePasswordModule;
