            	...
            	<div class="widget stacked<?= ((is_array($headerButtons['conf']) && ($headerButtons['conf']['type']=='table'))?' widget-table':'') ?>">
					<div class="widget-header">
						...
						if(is_array($headerButtons)) { ?>
                            ...
                            <?php
							if(is_array($headerButtons['add']) && $headerButtons['add']['enabled'] && $permission['add']) { ?>
                            ...
                            <?php
							if(is_array($headerButtons['deleteAll']) && $headerButtons['deleteAll']['enabled'] && $permission['add']) { ?>
