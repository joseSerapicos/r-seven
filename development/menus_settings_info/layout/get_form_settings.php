...
<form role="form" class="form-horizontal col-md-7">
    ...
    <div class="form-group varOptions">
        <label class="col-md-4">Var options</label>
        <div class="col-md-8">
            <input type="text" id="var_options" value="<?= ($obj?$obj->get_var_options():'') ?>" name="var_options" class="form-control" title="enum ex:'option1;option2;option3'" />
        </div>
    </div> <!-- /.form-group -->
...
<script>
	jQuery(document).ready(function() {
		$("#var_type").change(function() {
			var var_type = ($("#var_type :selected").val());
