				...
				<li>
                	<span class="<?= $obj_file_system->get_type() ?>">
                        ...
                        <div style="float:right">
                        	<button class="btn btn-default optionButton icon-pencil editSingleHeader" data-myId="<?= $obj_file_system->get_id() ?>" data-toggle="modal" data-backdrop="static" data-target="#addActionSelector"></button>
                            <button class="btn btn-default optionButton icon-remove deleteSingleHeader" data-myId="<?= $obj_file_system->get_id() ?>" data-myScriptPostForm="<?= (PATH_ROOT."development/file_system/scripts/delete_form.php") ?>"></button>
