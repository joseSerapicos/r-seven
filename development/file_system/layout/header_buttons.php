...
$headerButtons['add']['scriptGetForm'] = (PATH_ROOT."development/file_system/layout/get_form.php");
$headerButtons['add']['scriptPostForm'] = (PATH_ROOT."development/file_system/scripts/save_form.php");
...
$headerButtons['deleteAll']['scriptPostForm'] = (PATH_ROOT."development/file_system/scripts/delete_form.php");
