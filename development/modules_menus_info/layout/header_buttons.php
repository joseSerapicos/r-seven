...
$headerButtons['add']['scriptGetForm'] = (PATH_ROOT."development/modules_menus_info/layout/get_form.php"); // Script com o form a ser carregado
$headerButtons['add']['scriptPostForm'] = (PATH_ROOT."development/modules_menus_info/scripts/save_form.php"); // Script para onde deve ser enviado o post do form
