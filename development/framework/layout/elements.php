				...
				<div class="widget stacked ">
					...
					<div class="widget-content">
						...
						<section id="progress-bars">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-tertiary"
							...
							<h4>
								Stacked Progress <small>w/ Color Variation</small>
							</h4>
						...
						<section id="modals">
							...
							<a class="btn btn-primary " data-toggle="modal" href="#bigModal">Launch
								Big Modal</a> &nbsp;&nbsp;&nbsp; <a class="btn btn-default"
								data-toggle="modal" href="#smallModal">Launch Small Modal</a>
						...
						<section id="dropdowns">
							...
							<div class="dropdown clearfix">
								<ul class="dropdown-menu"
									...
									<li><a tabindex="-1" href="javascript:;"><i class="icon-star"></i>
											Action</a></li>
									<li><a tabindex="-1" href="javascript:;"><i
											class="icon-asterisk"></i> Another action</a></li>
									<li><a tabindex="-1" href="javascript:;"><i
											class="icon-bookmark"></i> Something else here</a></li>
									<li class="divider"></li>
									<li class="dropdown-submenu"><a tabindex="-1"
										href="javascript:;">More options</a>
										<ul class="dropdown-menu">
						...
						<section id="popovers">
							...
							<button type="button" class="btn btn-default ui-popover"
								...
								title="" data-original-title="Popover Title">Popover on top</button>
							<button type="button" class="btn btn-default ui-popover"
								data-container="body" data-toggle="popover" data-trigger="hover"
								data-placement="bottom"
								data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
								title="" data-original-title="Popover Title">Popover on bottom</button>
							<button type="button" class="btn btn-default ui-popover"
								data-container="body" data-toggle="popover" data-trigger="hover"
								data-placement="left"
								data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
								title="" data-original-title="Popover Title">Popover on left</button>
							<button type="button" class="btn btn-default ui-popover"
								data-container="body" data-toggle="popover" data-trigger="hover"
								data-placement="right"
								data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
								title="" data-original-title="Popover Title">Popover on right</button>
						...
						<section id="navigations">
							...
							<ul class="nav nav-pills nav-stacked" style="max-width: 300px;">
								...
								<li><a href="javascript:;"> <span class="badge pull-right">3</span>
										Messages
								</a></li>
							</ul>
								...
								<ul id="myTab" class="nav nav-tabs">
									...
									<li class="dropdown"><a href="#" class="dropdown-toggle"
										...
										<ul class="dropdown-menu" role="menu">
											...
											<li class=""><a href="#dropdown2" tabindex="-1"
								...
								<ul class="nav nav-pills">
									...
									<li class="dropdown"><a href="#" class="dropdown-toggle"
										...
										<ul class="dropdown-menu" role="menu">
											...
											<li class=""><a href="#tab-4" tabindex="-1" data-toggle="tab">Tab
													#4</a></li>
										</ul></li>
								</ul>
								<div class="tab-content">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p>
					This <a href="javascript:;" role="button"
						class="btn btn-default ui-popover" title=""
				...
				<p>
					<a href="javascript:;" class="ui-tooltip" title=""
						data-original-title="Tooltip">This link</a> and <a
						href="javascript:;" class="ui-tooltip" title=""
