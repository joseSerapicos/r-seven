...
<link href="<?= PATH_LAYOUT ?>general/js/plugins/faq/faq.css" rel="stylesheet">
...
<script src="<?= PATH_LAYOUT ?>general/js/plugins/faq/faq.js"></script>
<script src="<?= PATH_LAYOUT ?>general/js/demo/faq.js"></script>