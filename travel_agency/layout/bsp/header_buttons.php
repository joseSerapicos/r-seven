...
$headerButtons['add']['scriptGetForm'] = (PATH_ROOT."travel_agency/layout/bsp/bsp_form_add.php");
$headerButtons['add']['scriptPostForm'] = (PATH_ROOT."travel_agency/scripts/bsp_form_save.php");
...
$headerButtons['deleteAll']['scriptPostForm'] = (PATH_ROOT."travel_agency/scripts/bsp_form_delete.php"); // Script para onde deve ser enviado o post do form
